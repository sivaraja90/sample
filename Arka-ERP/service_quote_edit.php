<?php
  require('includes/common.php');
	...
	{
	$ObjServiceOrder->ViewEdit($_GET['service_order_no']);
	}
	if(isset($_POST['hdAction']))
	{
	$ObjServiceOrder->EditServiceOrder($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
	 {
	 	  $objSmarty->assign('SuccessMessage', 'Service Order Updated Successfully');
	 } 

  $objSmarty->assign('IncludeTpl', 'service_quote_edit.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Sercive Order Edit');
