...
if(isset($_GET['s_no']))
{
	$ObjUserMgmt->ViewEdit($_GET['s_no']);
}
if(isset($_POST['hdAction']))
{
	$ObjUserMgmt->EditUser($_POST,$_FILES);
}
if(isset($_GET['succs_msg_for_insert']))
{
	$objSmarty->assign('SuccessMessage', 'User Updated Successfully');
}

	$objSmarty->assign('IncludeTpl', 'user_edit.tpl');
