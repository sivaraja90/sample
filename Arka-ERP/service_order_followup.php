...
if(isset($_POST['hdAction']))
	{
	$ObjServiceOrder->InsertServiceOrderFollowUp($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
         {
          $objSmarty->assign('SuccessMessage', 'New FollowUp Added Successfully');
         }  
		  $objSmarty->assign('IncludeTpl', 'service_order_followup.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Follow Ups');
