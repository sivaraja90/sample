<?php
  require('includes/common.php');
	...
	$objVendorMgmt	->ViewVendor2($objArray);
...
/*$objVendorReg->DateStamp();
  ...
  $objSmarty->assign('IncludeTpl', 'vendor_contact_detail.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- View Vendor Contact');
