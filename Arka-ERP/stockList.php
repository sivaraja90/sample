...
//  	include_once $config['SiteClassPath']."class.Customer.php";
	...
	$stock_management	= new stock_management();
	$stock_management->RolesLists();
	$stock_management->GetStockLists($objArray);
  
  $objSmarty->assign('IncludeTpl', 'stores/Aura/stockList.tpl');
...
// $objSmarty->assign('address','http://localhost/alf/');
  ...
  /*Display page*/
  $objSmarty->assign('HeaderTpl', 'stores/Aura/left.tpl');
  $objSmarty->assign('FooterTpl', 'stores/Aura/footer.tpl');
