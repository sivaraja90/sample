<?php
   require('includes/common.php');
    ...
    $ObjSupplierReg->GetSupplierView();

	if(isset($_GET['server_success']))
         {
          $objSmarty->assign('SuccessMessage', 'Supplier Details Updated Successfully');
		 // header('Location:' ."customerDetails.tpl cust_id=".$_GET['cust_id']);
         } 
	if(isset($_POST['hdAction']))
	{
  		$ObjSupplierReg->EditSupplier($_POST);
     }
  $objSmarty->assign('IncludeTpl', 'supplierEdit.tpl');
