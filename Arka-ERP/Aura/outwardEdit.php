<?php
  ...
  include_once $config['SiteClassPath']."class.split_page_results.php"; 
	...
	if(isset($_POST['hdAction']))
	{
	 ...
	 $objOutward->GetmaterialLists($objArray);	 
	 //$objOutward->GetmaterialLists($objArray);	

	//$objstockOutward->GetOutwardDetail($_GET);
	
	/*if(isset($_GET['server_response']))
         {
          $objSmarty->assign('SuccessMessage1', 'Outward Updated Successfully');
		 // header('Location:' ."customerDetails.tpl cust_id=".$_GET['cust_id']);
         }
  	...
  	$objOutward->EditOutward($_POST);
		...
		{
		$objOutward->delete_inward_details($_REQUEST);
		}
