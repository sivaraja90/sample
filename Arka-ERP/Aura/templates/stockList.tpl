...
-->						<th>Status</th>
	...
	<input type="hidden" id="mcode_{$j}" name="mcode_{$j}" value="{$Liststock.item_category_code}"> 
            ...
            <td align="left"><span id="sid_{$j}"><a href="./stockDetails.php?inward_entry_id={$Liststock.inward_entry_id}">{$Liststock.location}</a></span>
			<span id="hid_{$j}" style="display:none;">
								<select class="form-control" id="barcode_num_{$j}" name="barcode_num_{$j}" value="{$Liststock.location}">
							   	{if $Liststock.location eq 'PAT'}
								   <option value="{$Liststock.location}" selected="selected">{$Liststock.location}</option>
								   <option value="WAV">WAV</option>
								    <option value="TAD" >TAD</option>
								{elseif $Liststock.location eq 'WAV'}
								  <option value="{$Liststock.location}" selected="selected">{$Liststock.location}</option>
								  <option value="PAT" >PAT</option>  
							      <option value="TAD" >TAD</option>  
							   {elseif $Liststock.location eq 'TAD'}
								  <option value="{$Liststock.location}" selected="selected">{$Liststock.location}</option>
							      <option value="PAT" >PAT</option>
								   <option value="WAV">WAV</option>  
								{/if}
		...
		<td align="left"><span id="quantity_{$j}"><a href="./stockDetails.php?inward_entry_id={$Liststock.inward_entry_id}">{$Liststock.quantity}</a></span>
		<span id="hidden_{$j}" style="display:none;">
	    ...
	    <td><span id="bookcopyid_{$j}"><input type="button" name="add_copy" value="Edit" onClick="bookcopy({$j});" class="btn btn-success"></span>
		<span id="bookconfirmid_{$j}" style="display:none"><input type="button" name="add_confirm" value="Confirm" onClick="bookconfirm({$j});" class="btn btn-success"></span></td>
