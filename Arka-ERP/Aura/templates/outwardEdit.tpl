                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content"><body onLoad="doOnLoad();">
                            ...
                            {foreach from=$MatList item=ListDet}
							<div class="ibox-title">
                          <h5  style="padding-left:40%;">Material Info:</h5>
                               ...
                               <div class="col-md-4"  id="erroutwardEntryNo"> <input type="text" id="outwardEntryNo" name="outwardEntryNo" class="form-control" value="{$ListDet.outward_entry_no}"  autocomplete="off" readonly="true">						</div>
							   
							   <label class="col-sm-2 control-label" style="text-align:left; ">Date Of Entry:</label>
							   <div class="col-md-4" id="errdateofEntry"> <input type="text"  id="dateofEntry"  name="dateofEntry" class="form-control" maxlength="19" value="{$ListDet.date_of_entry}" autocomplete="off"></div>
							   </div>
							    <!--<div class="form-group">
							   <label class="col-sm-2 control-label" style="text-align:left;">DC No:</label>
                               <div class="col-md-4"  id="errdcNo"> <input type="text" id="dcNo" name="dcNo" class="form-control" value="{$ListDet.dc_no}" autocomplete="off">						</div>
							   
							   <label class="col-sm-2 control-label" style="text-align:left; ">DC Date:</label>
							   <div class="col-md-4" id="errdcDate"> <input type="text"  id="dcDate"  name="dcDate" class="form-control" maxlength="19" value="{$ListDet.dc_date}" autocomplete="off"></div>
							   </div>-->
							    <div class="form-group">
							   <label class="col-sm-2 control-label" style="text-align:left;">To Name:</label>
                               <div class="col-md-4"  id="errtoName"> <input type="text" id="toName" name="toName" class="form-control" value="{$ListDet.to_name}" autocomplete="off">						</div>
							   
							   <label class="col-sm-2 control-label" style="text-align:left; ">Purpose:</label>
							   <div class="col-md-4" id="errpurpose">
							   <select class="form-control" name="purpose" id="purpose" value="{$ListDet.purpose}" autocomplete="off">
							   {if $ListDet.purpose eq 'Sales'}
  								<option value="{$ListDet.purpose}" selected="selected" >{$ListDet.purpose}</option>
								<option value="Scrap">Used</option>
								<option value="Scrap">Scrap</option>
								<option value="Service">Service</option>
							   {elseif $ListDet.purpose eq 'Used'}
  								<option value="{$ListDet.purpose}" selected="selected" >{$ListDet.purpose}</option>
								<option value="Sales">Sales</option>
								<option value="Scrap">Scrap</option>
								<option value="Service">Service</option>
								{elseif $ListDet.purpose eq 'Scrap'}
								<option value="{$ListDet.purpose}" selected="selected">{$ListDet.purpose}</option>
								<option value="Sales">Sales</option>
								<option value="Used" >Used</option>
								<option value="Service">Service</option>
								{elseif $ListDet.purpose eq 'Service'}
								<option value="{$ListDet.purpose}" selected="selected">{$ListDet.purpose}</option><br>
								<option value="Sales">Sales</option>
								<option value="Used" >Used</option>
								<option value="Scrap">Scrap</option>
											  {/if} 
                               ...
                               <div class="col-md-4"  id="errtoAddress"> <input type="text" id="toAddress" name="toAddress" class="form-control" value="{$ListDet.to_address}" autocomplete="off">						</div>
							   
							   <label class="col-sm-2 control-label" style="text-align:left; ">Vehicle No:</label>
							   <div class="col-md-4" id="errvehicleNo"> <input type="text"  id="vehicleNo"  name="vehicleNo" class="form-control" maxlength="19"    value="{$ListDet.vehicle_no}" autocomplete="off"></div>
							   </div>
							   <div class="ibox-title">
                          <h5  style="padding-left:40%;">Material Detail:</h5>
							 ...
							 <label class="col-sm-2 control-label" style="text-align:left;">Location:</label>
                               ...
                               <div class="col-md-4" id="erritem_name"> <input type="text" id="item_name" name="item_name" size="29" value="{$smarty.post.item_name}" class="form-control" autocomplete="Off" readonly="true"></a>	</div>
							 ...
							 <div class="col-md-4" id="erritem_code"><select id="item_code" name="item_code" value="{$smarty.post.item_code}" class="form-control" maxlength="19" autocomplete="off" readonly="true" onChange="Fill_Name_of_Clr_mat_name(this.value);">
                               ...
                               <div class="col-md-4"  id="errquantity"> <input type="text" id="quantity" name="quantity" value="{$smarty.post.quantity}" class="form-control" autocomplete="off" onKeyUp="numericFilter(this);qty_check(this.value);">						</div>
 ...
 <table class="table table-bordered" >
    ...
    <tr><td>
       <table width="100%" border="1PX solid black" cellspacing=0 cellpadding=1 class="table table-bordered"  id="table" >
        ...
        {foreach from=$PageListMat item=ListCus}
            <tr >          
                <td align="center" title="">
                  <a href="#."  onClick="closeit('{$ListCus.material_name}','{$ListCus.material_code}','{$ListCus.item_category_code}','{$ListCus.material_category}','{$ListCus.quantity}','{$ListCus.unit_price}');">{$i++}</a></td>
                <td align="left"><a href="#."  onClick="closeit('{$ListCus.material_name}','{$ListCus.material_code}','{$ListCus.item_category_code}','{$ListCus.material_category}','{$ListCus.quantity}','{$ListCus.unit_price}');">{$ListCus.material_name}</a></td>
				<td align="left"><a href="#."  onClick="closeit('{$ListCus.material_name}','{$ListCus.material_code}','{$ListCus.item_category_code}','{$ListCus.material_category}','{$ListCus.quantity}','{$ListCus.unit_price}');">{$ListCus.material_code}</a></td>
				<td align="left"><a href="#."  onClick="closeit('{$ListCus.material_name}','{$ListCus.material_code}','{$ListCus.item_category_code}','{$ListCus.material_category}','{$ListCus.quantity}','{$ListCus.unit_price}');">{$ListCus.item_category_code}</a></td>
				<td align="left"><a href="#."  onClick="closeit('{$ListCus.material_name}','{$ListCus.material_code}','{$ListCus.item_category_code}','{$ListCus.material_category}','{$ListCus.quantity}','{$ListCus.unit_price}');">{$ListCus.material_category}</a></td>
				<td align="left"><a href="#."  onClick="closeit('{$ListCus.material_name}','{$ListCus.material_code}','{$ListCus.item_category_code}','{$ListCus.material_category}','{$ListCus.quantity}','{$ListCus.unit_price}');">{$ListCus.quantity}</a></td>
				<td align="left"><a href="#."  onClick="closeit('{$ListCus.material_name}','{$ListCus.material_code}','{$ListCus.item_category_code}','{$ListCus.material_category}','{$ListCus.quantity}','{$ListCus.unit_price}');">{$ListCus.unit_price}</a></td>
...
<!--	 <tr>
    ...
    <tr>
		...
		{assign var="i" value="1"}
		             {foreach from=$outward_details_list item=ListDet}        
                <tr>
				<!--<td>{$i++}</td>-->
                <td align="center">  <a title="Outward Entry No" >{$ListDet.outward_entry_no}</a></td>
				<td align="center">  <a title="Material Name" >{$ListDet.material_name}</a>&nbsp;</td>
				<td align="center">  <a title="Material Category">{$ListDet.material_category}</a></td>
                <td  align="center">  <a title="Material Code" >{$ListDet.material_code}</a></td>
                <td  align="center">  <a title="Quantity" >{$ListDet.quantity}</a></td>
				<td  align="center">  <a title="Price" >{$ListDet.material_price}</a></td>
				{assign var="total_price" value="`$ListDet.quantity*$ListDet.material_price`"}
				...
				<td class="nohover" align="center">	&nbsp;&nbsp; &nbsp;&nbsp;<a href="#" class="fa fa-trash" onClick="deleteCats('{$ListDet.outward_entry_no}','{$ListDet.sl_no}');"></a></td>
