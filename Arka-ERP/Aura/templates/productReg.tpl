...
<!--                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        ...
                        <div class="ibox-content"><body  onload="doOnLoad();">
							...
							<div class="form-group">
                              ...
                              <div class="col-md-4"  id="err_scada_Id"> <input type="text"  id="scada_Id"  name="scada_Id" class="form-control"  value="{$scada_Id}" onKeyUp="numericFilter(this)" autocomplete="Off" ></div>
							       <label class="col-sm-2 control-label" style="text-align:left;">Product ID:<span style="color:#FF0000"><sup>*</sup></span></label>
                               <div class="col-md-4"  id="err_product_Id"> <input type="text"  id="product_id"  name="product_id"class="form-control"   readonly="true" value="{$p_id}" autocomplete="Off"></div>
							   
							   </div>	
							   <div class="form-group">
							   <label class="col-sm-2 control-label" style="text-align:left; ">Production Batch:<span style="color:#FF0000"><sup>*</sup></span></label>
							   <div class="col-md-4" id="err_production_batch"><input type="text"  id="production_batch"  name="production_batch" class="form-control" value="{$production_batch}" autocomplete="Off"></div>
							    <label class="col-sm-2 control-label" style="text-align:left;"> Production date:<span style="color:#FF0000"><sup>*</sup></span></label>
                               <div class="col-md-4" id="err_production_date"><input type="text" id="production_date"  name="production_date" class="form-control" value="{$production_date}" readonly="true" autocomplete="Off">
                         ...
                         <div class="form-group">
							...
							<div class="col-md-4" id="err_tested_date"><input type="text"  required  id="tested_date"  name="tested_date" class="form-control" value="{$tested_date}" readonly="true" autocomplete="Off">
			                </div>
							<label class="col-sm-2 control-label" style="text-align:left;">Created date:<span style="color:#FF0000"><sup>*</sup></span></label>
                            <div class="col-md-4" id="err_created_date"><input type="text" id="created_date"  name="created_date" value="{$smarty.now|date_format:'%Y-%m-%d'}" class="form-control" readonly="true" autocomplete="Off">  
						    </div>
					     </div>	
                         <div class="form-group">
						    <label class="col-sm-2 control-label" style="text-align:left; ">Created time:<span style="color:#FF0000"><sup>*</sup></span></label>
							<div class="col-md-4" id="err_created_time"><input type="text"  id="created_time"  name="created_time" value="{$smarty.now|date_format:'%I:%M:%S %p'}" class="form-control" readonly="true" autocomplete="Off" >
							</div>
						    <label class="col-sm-2 control-label" style="text-align:left;">Created By:<span style="color:#FF0000"><sup>*</sup></span></label>
                            <div class="col-md-4"  id="err_created_by"><input type="text" id="created_by"  name="created_by" class="form-control" value="{$smarty.session.UserName}" readonly="true" autocomplete="Off">
							</div>
					     </div>	
					<br/>
					 ...
					 <div class="form-group">
						    <label class="col-sm-2 control-label" style="text-align:left; ">Model Name:<span style="color:#FF0000"><sup>*</sup></span></label>
					            <div class="col-md-4" id="errmodelName"><select id="modelName"  name="modelName" class="form-control" value="{$modelName}" autocomplete="Off">
