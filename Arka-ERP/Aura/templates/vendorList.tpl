...
<div class="wrapper wrapper-content animated fadeInRight">
 ...
 <tr>
		...
		<td bgcolor="#CCFFFF" align="center"><input type="text" id="supplier_name" onKeyUp="showList(this.value,this.id)" autocomplete="off" name="supplier_name" value="" size="5"></td>
			  ...
			  <td class="center">&nbsp;&nbsp;&nbsp;&nbsp;<a href="./outwardEdit.php?site_id={$ListDet.site_id}"><i class="fa fa-edit"></i></a></td>      
            ...
            <tr class="gradeX" id="{$i++}" >
				<td align="left" ><a href="./vendorDetails.php?panNo={$ListDet.pan_no}">{$i}</a></td>
                <!--<td align="left" ><a href="./vendorDetails.php?supplierCode={$ListDet.supplier_code}">{$ListDet.supplier_name}</a></td>-->
                <td align="left" ><a href="./vendorDetails.php?panNo={$ListDet.pan_no}">{$ListDet.supplier_code}</a></td>
	            <td align="left"><a href="./vendorDetails.php?panNo={$ListDet.pan_no}">{$ListDet.contact_person}</a></td>

	   <!--<td align="left"><a href="./vendorDetails.php?supplierName={$ListDet.supplier_name}">{$ListDet.address2}</a></td>-->
	              <td align="left"><a href="./vendorDetails.php?panNo={$ListDet.pan_no}">{$ListDet.designation}</a></td>
		           <td align="left"><a href="./vendorDetails.php?panNo={$ListDet.pan_no}">{$ListDet.mobile_no}</a></td>

		             <td align="left"><a href="./vendorDetails.php?panNo={$ListDet.pan_no}">{$ListDet.city}</a></td>
		            <td align="left"><a href="./vendorDetails.php?panNo={$ListDet.pan_no}">{$ListDet.state}</a></td>
			     <td align="left"><a href="./vendorDetails.php?panNo={$ListDet.pan_no}">{$ListDet.email}</a></td>
			     <td align="left"><a href="./vendorDetails.php?panNo={$ListDet.pan_no}">{$ListDet.pincode}</a></td>
			    <!--<td align="left"><a href="./vendorDetails.php?supplierName={$ListDet.supplier_name}">{$ListDet.created_date}</a></td>
			     <td align="left"><a href="./vendorDetails.php?supplierName={$ListDet.supplier_name}">{$ListDet.created_time}</a></td>
				 <td align="left"><a href="./vendorDetails.php?supplierName={$ListDet.supplier_name}">{$ListDet.created_by}</a></td>-->
			    <td class="center">&nbsp;&nbsp;&nbsp;&nbsp;<a href="./vendorEdit.php?panNo={$ListDet.pan_no}"><i class="fa fa-edit"></i></a>      
			   &nbsp;&nbsp; &nbsp;&nbsp;<a href="#" class="fa fa-trash" onClick="deleteCats('{$ListDet.pan_no}');"></a></td>
