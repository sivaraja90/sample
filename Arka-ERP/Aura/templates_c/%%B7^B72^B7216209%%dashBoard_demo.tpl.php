<?php /* Smarty version 2.6.25, created on 2016-04-05 17:16:59
         compiled from dashBoard_demo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'dashBoard_demo.tpl', 29, false),)), $this); ?>
   </div>
...
<?php $_from = $this->_tpl_vars['SCADAList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['ListSCADA']):
?>
			
                  <tr class="gradeX" id="<?php echo $this->_tpl_vars['i']++; ?>
">
					 <?php if ($this->_tpl_vars['ListSCADA']['VDATE'] == ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d'))): ?>
				<td > <?php if ($this->_tpl_vars['ListSCADA']['STATUS'] == 225 || $this->_tpl_vars['ListSCADA']['STATUS'] == 15 || $this->_tpl_vars['ListSCADA']['STATUS'] == 1): ?><a href="./dashBoard_demo.php?this=<?php echo $this->_tpl_vars['ListSCADA']['MACHINE_ID']; ?>
">
			 <img alt="image" class="img-circle m-t-xs img-responsive" src="images/green_16.gif"></a>
			 <?php elseif ($this->_tpl_vars['ListSCADA']['STATUS'] == 0): ?> 
				 <img alt="image" class="img-circle m-t-xs img-responsive" src="images/red-wind-turbine-16.gif">
				<?php endif; ?>	 </td> 
				<?php elseif ($this->_tpl_vars['ListSCADA']['VDATE'] != ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')) && $this->_tpl_vars['ListSCADA']['STATUS'] == 0): ?>
				<td> <a href="./dashBoard_demo.php?this=<?php echo $this->_tpl_vars['ListSCADA']['MACHINE_ID']; ?>
">
				 <img alt="image" class="img-circle m-t-xs img-responsive" src="images/grid2.png">
				</a> </td>
				<?php endif; ?></tr></table><?php endforeach; endif; unset($_from); ?>
