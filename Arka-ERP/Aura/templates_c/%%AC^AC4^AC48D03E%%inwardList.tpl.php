<?php /* Smarty version 2.6.25, created on 2017-11-07 14:40:08
         compiled from inwardList.tpl */ ?>
<head>
...
">
						<td><a href="./inwardDetails.php?inward_entry_id=<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
"><?php echo $this->_tpl_vars['i']; ?>
</a></td>	
						<td><a href="./inwardDetails.php?inward_entry_id=<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
"><?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
</a></td>			        
						<td><a href="./inwardDetails.php?inward_entry_id=<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
"><?php echo $this->_tpl_vars['ListInward']['supplier_name']; ?>
</a></td>	
						<td><a href="./inwardDetails.php?inward_entry_id=<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
"><?php echo $this->_tpl_vars['ListInward']['material_name']; ?>
</a></td>			        
						<td><a href="./inwardDetails.php?inward_entry_id=<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
"><?php echo $this->_tpl_vars['ListInward']['invoice_date']; ?>
</a></td>	          	
						<td><a href="./inwardDetails.php?inward_entry_id=<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
"><?php echo $this->_tpl_vars['ListInward']['invoice_amount']; ?>
</a></td>
<!--						<td><a href="./inwardDetails.php?inward_entry_id=<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
"><?php echo $this->_tpl_vars['ListInward']['tax']; ?>
</a></td>	
						<td><a href="./inwardDetails.php?inward_entry_id=<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
"><?php echo $this->_tpl_vars['ListInward']['total']; ?>
</a></td>			        
-->						
			   <td class="center"><a href="./inwardEdit.php?inward_entry_id=<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
"><i class="fa fa-edit"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="fa fa-trash" onClick="deleteCats('<?php echo $this->_tpl_vars['ListInward']['inward_entry_id']; ?>
');"></a></td> 
          ...
          <!--     
			  ...
			  <td class="center">&nbsp;&nbsp;&nbsp;&nbsp;<a href="./inwardEdit.php?site_id=<?php echo $this->_tpl_vars['ListDet']['site_id']; ?>
