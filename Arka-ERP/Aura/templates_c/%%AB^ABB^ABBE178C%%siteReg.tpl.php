<?php /* Smarty version 2.6.25, created on 2016-12-26 16:10:43
         compiled from siteReg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'siteReg.tpl', 187, false),)), $this); ?>
   </div>
                         ...
                         <div class="ibox-content">
                            ...
                            <input type="hidden"  id="hdAction"  name="hdAction" />
							   <div class="form-group">
										...
										<div class="col-md-4">
								<input type="text" id="customer_name" name="customer_name" size="29" placeholder="Search" value="<?php echo $this->_supers['post']['customer_name']; ?>
" class="form-control" autocomplete="Off"  data-toggle="modal" data-target="#myModal"readonly="true">						   
							<!--<select id="customer_name"  name="customer_name" class="form-control" value="<?php echo $this->_tpl_vars['ListCus']['customer_name']; ?>
" autocomplete="Off"   onchange="myFunction">
						        <option value="select" selected="selected">-select- </option>
								<?php $_from = $this->_tpl_vars['CusList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['ListCus']):
?>	
							    <option value="<?php echo $this->_tpl_vars['ListCus']['customer_name']; ?>
"><?php echo $this->_tpl_vars['ListCus']['customer_name']; ?>
 </option>
							    <?php endforeach; endif; unset($_from); ?>
						     </select>-->	
				
	 <input type="hidden" id="image" name="image" tabindex="12" value="<?php echo $this->_supers['post']['image']; ?>
" autocomplete="off">
									</div>	
									 </div>
									 <div id="errCustomerId">
										...
										<div class="col-md-4">
										<input type="text"  id="customer_id"  name="customer_id" class="form-control" value="<?php echo $this->_supers['post']['customer_id']; ?>
" autocomplete="Off" onDblClick="customer_validation();" readonly="true">
										</div>
									 </div>	
							 </div>
							 	<hr />
							 ...
							 <div id="errSiteId">
										...
										<div class="col-md-4"><input type="text"  id="siteId"  name="siteId" class="form-control" readonly="true" value="<?php echo $this->_tpl_vars['si_id']; ?>
" autocomplete="Off">
										</div>
										</div>	
							  <div id="errSiteName"> 
									    <label class="col-sm-2 control-label" style="text-align:left;">Site Name:</label>
									    <div class="col-md-4"><input type="text" id="siteName"  name="siteName" class="form-control" value="<?php echo $this->_tpl_vars['siteName']; ?>
" autocomplete="Off">
									    </div>
									    </div>			  
							   </div>
							   ...
							   <div id="errAddress"> 
										...
										<div class="col-md-4"><input type="text"  id="address1"  name="address1" class="form-control" value="<?php echo $this->_tpl_vars['address1']; ?>
"  autocomplete="Off">
										</div>
										</div>
							    <div id="errVillage">  <label class="col-sm-2 control-label" style="text-align:left;">Village:</label>
                               <div class="col-md-4"><input type="text" id="village"  name="village" class="form-control" value="<?php echo $this->_tpl_vars['village']; ?>
"  autocomplete="Off">
							   </div>
							   </div>
							   ...
							   <div id="errCity">
									...
									<div class="col-md-4"><input type="text" id="city" name="city" class="form-control" value="<?php echo $this->_tpl_vars['city']; ?>
"  autocomplete="Off">
							   </div>
							   </div>
							   <div id="errState">
							        <label class="col-sm-2 control-label" style="text-align:left;">State:</label>
									<div class="col-md-4"><input type="text" id="state" name="state" class="form-control" value="<?php echo $this->_tpl_vars['state']; ?>
"  autocomplete="Off">
							   </div>
							   </div>
							   ...
							   <div class="form-group">
							   	<div id="errPincode">
									...
									<div class="col-md-4"><input type="text" id="pincode" name="pincode" class="form-control"  onkeyup="numericFilter(this)"  onBlur="chk_exist_pincode(this);" maxlength="6" value="<?php echo $this->_tpl_vars['pincode']; ?>
"  autocomplete="Off">
							   </div>
							   </div>
							   <div id="errDistrict">
							        <label class="col-sm-2 control-label" style="text-align:left;">District:</label>
									<div class="col-md-4"><input type="text" id="district" name="district" class="form-control" value="<?php echo $this->_tpl_vars['district']; ?>
"  autocomplete="Off">
							   </div>
							   </div>
							   </div>
					        ...
					        <div class="form-group">
							  ...
							  <div id="errContactPerson"> 
							   <label class="col-sm-2 control-label" style="text-align:left;">Contact Person:</label>
										<div class="col-md-4"><input type="text"  id="contactPerson"  name="contactPerson"class="form-control" value="<?php echo $this->_tpl_vars['contactPerson']; ?>
"  autocomplete="Off">
										</div>
										</div>
							   <div id="errDesignation">  
							   <label class="col-sm-2 control-label" style="text-align:left;">Designation:</label>
							   <div class="col-md-4"><input type="text" id="designation"  name="designation"class="form-control" value="<?php echo $this->_tpl_vars['designation']; ?>
"  autocomplete="Off">
							   </div>
							   </div>
...
" maxlength="11" autocomplete="Off">
                               ...
                               <div class="col-md-4" id="errEmail"><input type="text" required id="email"  name="email" class="form-control" onblur="ValidateEmail(this)"maxlength="30" value="<?php echo $this->_tpl_vars['email']; ?>
"  autocomplete="Off">
							   </div>
							   </div>	
							   <div id="errRegion">
										<label class="col-sm-2 control-label" style="text-align:left;">Region:</label>
										<div class="col-md-4"><input type="text"  id="region"  name="region"class="form-control" value="<?php echo $this->_tpl_vars['region']; ?>
"  autocomplete="Off">
										</div>
										</div>						   
							   </div>
								 ...
								 <div id="errNoOfTurbines"><label class="col-sm-2 control-label" style="text-align:left;">No. Of Turbines:</label>
										<div class="col-md-4"><input type="text"  id="noOfTurbines"  name="noOfTurbines" class="form-control" value="<?php echo $this->_tpl_vars['noOfTurbines']; ?>
"  autocomplete="Off">
										</div>
										</div>	
...
?>
            <tr id="data" >          
                <td align="center" title="">
                  <a href="#."  onClick="closeit('<?php echo $this->_tpl_vars['ListCus']['customer_name']; ?>
','<?php echo $this->_tpl_vars['ListCus']['customer_id']; ?>
');"><?php echo $this->_tpl_vars['i']++; ?>
</a></td>
                <td align="left"><a  href="#." onClick="closeit('<?php echo $this->_tpl_vars['ListCus']['customer_name']; ?>
','<?php echo $this->_tpl_vars['ListCus']['customer_id']; ?>
');"><?php echo $this->_tpl_vars['ListCus']['customer_name']; ?>
</a></td>
				<td align="left"><a  href="#." onClick="closeit('<?php echo $this->_tpl_vars['ListCus']['customer_name']; ?>
