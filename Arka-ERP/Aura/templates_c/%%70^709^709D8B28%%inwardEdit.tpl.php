<?php /* Smarty version 2.6.25, created on 2017-10-25 11:04:16
         compiled from inwardEdit.tpl */ ?>
...
<div class="col-md-3"><input type="text" id="inward_entry_id"  name="inward_entry_id"class="form-control" readonly="true" value="<?php echo $this->_tpl_vars['ListDet']['inward_entry_id']; ?>
" autocomplete="Off"></div></div>
							   <div id="errdate_of_entry">  
							   <label class="col-sm-2 control-label" style="text-align:left; margin-left:15%">Date of Entry:</label>
							   <div class="col-md-3"><input type="text" id="date_of_entry" name="date_of_entry" class="form-control" value="<?php echo $this->_tpl_vars['ListDet']['date_of_entry']; ?>
"   autocomplete="Off" ></div>
							   </div>
							   </div>	
							   <!--<div class="form-group">
							   <div id="errdc_no"> <label class="col-sm-2 control-label" style="text-align:left;">DC No:</label>
                               <div class="col-md-3"><input type="text" id="dc_no"  name="dc_no" class="form-control" value="<?php echo $this->_tpl_vars['ListDet']['dc_no']; ?>
" onKeyUp="numericFilter(this)" maxlength="10" autocomplete="Off">
							   ...
							   <div id="errdc_date"> 
										...
										<div class="col-md-3"><input type="text"  id="dc_date"  name="dc_date"class="form-control" value="<?php echo $this->_tpl_vars['ListDet']['dc_date']; ?>
"  autocomplete="Off">
										</div>
										</div>
							   </div>-->	
							  ...
							  <label class="col-sm-2 control-label" style="text-align:left;">Invoice No:</label>
                               <div class="col-md-3"><input type="text" id="invoice_no"  name="invoice_no"class="form-control" value="<?php echo $this->_tpl_vars['ListDet']['invoice_no']; ?>
" onKeyUp="numericFilter(this)" maxlength="10" autocomplete="Off">
							   </div>
							   </div>
							   <div id="errinvoice_date"> 
								<label class="col-sm-2 control-label" style="text-align:left; margin-left:15%">Invoice Date:</label>
								<div class="col-md-3"><input type="text"  id="invoice_date"  name="invoice_date"class="form-control" value="<?php echo $this->_tpl_vars['ListDet']['invoice_date']; ?>
"  autocomplete="Off">
								</div>
								</div>				    
							   </div>
							  ...
							  <label class="col-sm-2 control-label" style="text-align:left;">Supplier Name:</label>
                               <div class="col-md-3"><input type="text" id="supplier_name"  name="supplier_name"class="form-control" value="<?php echo $this->_tpl_vars['ListDet']['supplier_name']; ?>
" autocomplete="Off" data-toggle="modal" data-target="#myModal" readonly="true" placeholder="Search">
							   </div>
							   </div>
							   <div id="errsupplier_code"> 
								<label class="col-sm-2 control-label" style="text-align:left; margin-left:15%">Supplier Code:</label>
								<div class="col-md-3"><input type="text"  id="supplier_code"  name="supplier_code"class="form-control" value="<?php echo $this->_tpl_vars['ListDet']['supplier_code']; ?>
"  autocomplete="Off" readonly="true">
							  ...
							  <label class="col-sm-2 control-label" style="text-align:left;">Frieght Charges:</label>
                               <div class="col-md-3"><input type="text" id="frieght_charges"  name="frieght_charges"class="form-control" value="<?php echo $this->_tpl_vars['ListDet']['frieght_charges']; ?>
" onKeyUp="numericFilter(this)" maxlength="10" autocomplete="Off">
							   </div>
							   </div>
							   <div id="errlocation"> 
								...
								<select class="form-control" id="location" name="location" autocomplete="Off">
							   	<?php if ($this->_tpl_vars['ListDet']['location'] == 'PAT'): ?>
								   <option value="<?php echo $this->_tpl_vars['ListDet']['location']; ?>
" selected="selected"><?php echo $this->_tpl_vars['ListDet']['location']; ?>
</option>
								   <option value="WAV">WAV</option>
								    <option value="TAD" >TAD</option>
								<?php elseif ($this->_tpl_vars['ListDet']['location'] == 'WAV'): ?>
								  <option value="<?php echo $this->_tpl_vars['ListDet']['location']; ?>
" selected="selected"><?php echo $this->_tpl_vars['ListDet']['location']; ?>
</option>
								  <option value="PAT" >PAT</option>  
							      <option value="TAD" >TAD</option>  
							   <?php elseif ($this->_tpl_vars['ListDet']['location'] == 'TAD'): ?>
								  <option value="<?php echo $this->_tpl_vars['ListDet']['location']; ?>
" selected="selected"><?php echo $this->_tpl_vars['ListDet']['location']; ?>
</option>
							      <option value="PAT" >PAT</option>
...
" autocomplete="off" readonly="true"></div>
							   ...
							   <div class="col-md-4" id="erritem_category"> <input type="text" id="item_category"  name="item_category" class="form-control"  value="<?php echo $this->_supers['post']['item_category']; ?>
" autocomplete="off" readonly="true"></div>
							   
							   <label class="col-sm-2 control-label" style="text-align:left;">Material Category Code:</label>
                               <div class="col-md-4"  id="erritem_category_code"> <input type="text" id="item_category_code" name="item_category_code" class="form-control" value="<?php echo $this->_supers['post']['item_category_code']; ?>
...
" autocomplete="off" onKeyUp="numeric_filter(this),cost_calculations()"></div>
							   </div>
							    <div class="form-group">
...
" autocomplete="off" onKeyUp="gst_calculations();"></div>
							   </div>
							    <div class="form-group">
...
');"><?php echo $this->_tpl_vars['ListDet']['sl_no']; ?>
			    ...
			    <td  align="left"><a  href="#." onClick="closefn('<?php echo $this->_tpl_vars['ListDet']['item_name']; ?>
...
<table align="center" cellspacing="0" cellpadding="3" width="100%" border=0 class="table table-bordered">
	...
	<tr> 
		...
		<td class="error" width=50%></td>
			 ...
			 <?php if ($this->_tpl_vars['SuccessMessage_on_edit'] != ""): ?>
	<tr> 
...
?>        
	...
	<?php $this->assign('invoice_amount', ($this->_tpl_vars['total_price'])); ?>
				<!--<td><a title=" Ticket" href="tickets.php?id=<?php echo '<?='; ?>
$row['ticket_id']<?php echo '?>'; ?>
"><?php echo $this->_tpl_vars['ListDet']['customer_type']; ?>
</a>&nbsp;</td>-->
...
;">  <a ><?php echo $this->_tpl_vars['details_list']['material_code']; ?>
                ...
                <td align="center">  <a ><?php echo $this->_tpl_vars['details_list']['item_description']; ?>
</a>&nbsp;</td>
				<td align="center">  <a ><?php echo $this->_tpl_vars['details_list']['material_category']; ?>
</a>&nbsp;</td>
                <td align="center" style="background-color:<?php echo '<?='; ?>
$row['priority_color']<?php echo '?>'; ?>
;">  <a ><?php echo $this->_tpl_vars['details_list']['item_category_code']; ?>
</a></td>
...
');"></a></td>
							<!--	<td class="nohover" align="center" style="background-color:<?php echo '<?='; ?>
$row['priority_color']<?php echo '?>'; ?>
;">  <a ><?php echo $this->_tpl_vars['details_list']['created_by']; ?>
</a></td>-->	
				<!--<td class="nohover" align="center"><a href="#"><img src="images/icons/delete.png" border="0" align="absmiddle" alt="Delete" onClick="Javascript:deleteCats('<?php echo $this->_tpl_vars['details_list']['inward_entry_id']; ?>
','<?php echo $this->_tpl_vars['details_list']['sl_no']; ?>
')" >	</a></td>-->	
	<!--<td align="center" class="nohover"><input type="checkbox" name="ticks[]" value="<?php echo $this->_tpl_vars['details_list']['inward_entry_id']; ?>
" onClick="highLight(this.value,this.checked);"></td>	-->																
			...
			<?php endforeach; endif; unset($_from); ?>
				...
				<td align="right"><?php echo $this->_tpl_vars['execute_query']['0']['sum_total']; ?>
</td>
