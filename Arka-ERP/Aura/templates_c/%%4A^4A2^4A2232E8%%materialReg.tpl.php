<?php /* Smarty version 2.6.25, created on 2017-01-21 17:09:12
         compiled from materialReg.tpl */ ?>
...
<!--                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
						...
						<input type="hidden" id="hdAction" name="hdAction" />
                        	...
                        	<select class="form-control" name="materialType" id="materialType" value="<?php echo $this->_supers['post']['materialType']; ?>
" autocomplete="off">
...
" autocomplete="off" onKeyUp="numericFilter(this);"></div>
                               ...
                               <select class="form-control" name="materialCategory" id="materialCategory" value="<?php echo $this->_supers['post']['materialCategory']; ?>
" autocomplete="off">
							   ...
							   <div class="col-md-4" id="errdate"> <input type="text"  id="date"  name="date" class="form-control" maxlength="19" value="<?php echo $this->_supers['post']['date']; ?>
" readonly="true" autocomplete="off"></div>
							   </div>
							   <div class="form-group">
							   <label class="col-sm-2 control-label" style="text-align:left;">Material Code:</label>
                               <div class="col-md-4"  id="errmaterialCode"> <input type="text" id="materialCode" name="materialCode" class="form-control" value="<?php echo $this->_supers['post']['materialCode']; ?>
" autocomplete="off">						</div>
							   
							   <label class="col-sm-2 control-label" style="text-align:left; ">Material Name:</label>
							   <div class="col-md-4" id="errmaterialName"> <input type="text"  id="materialName"  name="materialName" class="form-control" maxlength="19" value="<?php echo $this->_supers['post']['materialName']; ?>
" autocomplete="off"></div>
							   </div>
							   <div class="form-group">
							   <label class="col-sm-2 control-label" style="text-align:left; ">Material Description:</label>
							   <div class="col-md-4" id="errmaterialDescription"> <textarea  id="materialDescription"  name="materialDescription" class="form-control" rows="3" cols="10" autocomplete="off"><?php echo $this->_supers['post']['materialDescription']; ?>
</textarea></div>
  							   <label class="col-sm-2 control-label" style="text-align:left;">Material Image:</label>
							   <div class="col-md-4" id="errmaterialImage"> <input type="file"  id="materialImage"  name="materialImage" class="form-control" maxlength="19" value="<?php echo $this->_supers['post']['materialImage']; ?>
" autocomplete="off"></div>
							   </div>
