<?php /* Smarty version 2.6.25, created on 2016-02-12 15:45:34
         compiled from customerDetails.tpl */ ?>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                          <h5 style="padding-left:40%;">Customer Details</h5>
...
?>
							...
							<div class="col-md-2 control-label" style="text-align:left;"><td><?php echo $this->_tpl_vars['ListDet']['email']; ?>
							  ...
							  <div class="form-group">
							   <div id="errPhone"> <label class="col-sm-2 control-label" style="text-align:left;"> Phone:</label>
