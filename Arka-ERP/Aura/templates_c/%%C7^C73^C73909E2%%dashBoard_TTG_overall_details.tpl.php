<?php /* Smarty version 2.6.25, created on 2016-05-07 12:34:33
         compiled from dashBoard_TTG_overall_details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'dashBoard_TTG_overall_details.tpl', 29, false),)), $this); ?>
   </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
									<iframe height="490px" width="98%" id="tab-1"  src="./ttg_overview.php?id=<?php echo $this->_supers['get']['this']; ?>
...
"  style="border:1px;"></iframe>
								...
								<div id="tab-3" class="tab-pane">
									<iframe height="580px" width="98%" src="./ttg_error_no_of_times.php?id=<?php echo $this->_supers['get']['this']; ?>
" style="border:1px;"></iframe>
                                </div>
							<!--	<div id="tab-3" class="tab-pane">
...
" style="border:1px;"></iframe>
							...
							-->
						<div id="tab-12" class="tab-pane">
                        			<iframe  height="820px" width="98%" src="./ttg_display.php?id=<?php echo $this->_supers['get']['this']; ?>
" style="border:1px;"></iframe>
                                </div>
