<?php /* Smarty version 2.6.25, created on 2017-11-04 14:43:42
         compiled from outwardList.tpl */ ?>
<head>
...
">
						<td><a href="./outwardDetails.php?outward_entry_no=<?php echo $this->_tpl_vars['ListOutward']['outward_entry_no']; ?>
"><?php echo $this->_tpl_vars['i']; ?>
</a></td>	
						<td><a href="./outwardDetails.php?outward_entry_no=<?php echo $this->_tpl_vars['ListOutward']['outward_entry_no']; ?>
"><?php echo $this->_tpl_vars['ListOutward']['outward_entry_no']; ?>
</a></td>	
						<td><a href="./outwardDetails.php?outward_entry_no=<?php echo $this->_tpl_vars['ListOutward']['outward_entry_no']; ?>
"><?php echo $this->_tpl_vars['ListOutward']['material_name']; ?>
</a></td>			        
						<td><a href="./outwardDetails.php?outward_entry_no=<?php echo $this->_tpl_vars['ListOutward']['outward_entry_no']; ?>
"><?php echo $this->_tpl_vars['ListOutward']['date_of_entry']; ?>
</a></td>	
						<td><a href="./outwardDetails.php?outward_entry_no=<?php echo $this->_tpl_vars['ListOutward']['outward_entry_no']; ?>
"><?php echo $this->_tpl_vars['ListOutward']['to_name']; ?>
</a></td>			        
						<td><a href="./outwardDetails.php?outward_entry_no=<?php echo $this->_tpl_vars['ListOutward']['outward_entry_no']; ?>
"><?php echo $this->_tpl_vars['ListOutward']['purpose']; ?>
</a></td>	
						
			   <td class="center"><a href="./outwardEdit.php?outward_entry_no=<?php echo $this->_tpl_vars['ListOutward']['outward_entry_no']; ?>
" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" class="fa fa-trash" onClick="deleteCats('<?php echo $this->_tpl_vars['ListOutward']['outward_entry_no']; ?>
');"></a></td> 
