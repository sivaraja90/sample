<?php /* Smarty version 2.6.25, created on 2017-01-21 17:42:22
         compiled from materialList.tpl */ ?>
<head>
...
" class="gradeX">
			<td align="left"><a href="./materialDetails.php?m_code=<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
">&nbsp;<?php echo $this->_tpl_vars['i']; ?>
</td>
			<td align="left"><a href="./materialDetails.php?m_code=<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
">&nbsp;&nbsp;<?php echo $this->_tpl_vars['Liststock']['m_type']; ?>
</td>
			<td align="left"><a href="./materialDetails.php?m_code=<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
">&nbsp;&nbsp;<?php echo $this->_tpl_vars['Liststock']['m_cat']; ?>
</td>
			<td align="left"><a href="./materialDetails.php?m_code=<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
">&nbsp;&nbsp;<?php echo $this->_tpl_vars['Liststock']['m_name']; ?>
</td>
			<td align="left"><a href="./materialDetails.php?m_code=<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
">&nbsp;&nbsp;<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
</td>
			<td align="left"><a href="./materialDetails.php?m_code=<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
">&nbsp;&nbsp;<?php echo $this->_tpl_vars['Liststock']['unit']; ?>
</td>
			<td align="left"><a href="./materialDetails.php?m_code=<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
">&nbsp;&nbsp;<?php echo $this->_tpl_vars['Liststock']['unit_price']; ?>
</td>
			 <td class="center">&nbsp;&nbsp;&nbsp;&nbsp;<a href="./materialEdit.php?m_code=<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
"><i class="fa fa-edit"></i></a></td> 
			  <td class="center">	&nbsp;&nbsp; &nbsp;&nbsp;<a href="#" class="fa fa-trash" onClick="deleteCats('<?php echo $this->_tpl_vars['Liststock']['m_code']; ?>
');"></a></td> 
			</tr>
