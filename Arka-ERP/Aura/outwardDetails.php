  ...
  require('includes/common.php');
	...
	$objOutward->list_outward_details($objArray);*/
	 ...
	 if(isset($_GET['server_response']))
         {
          $objSmarty->assign('SuccessMessage1', 'Outward Details');
	...
	/*
	 	  if(isset($_POST['hdAction']))
	  {
  		...
  		if($Outward->InsertOutwardContent($_POST))
		$stock_outward->list_inward_details();
		
       }
	   
	  	if(isset($_GET['deleid']))
		{
		$Outward->delete_inward_details($_REQUEST);
		$Outward->list_inward_details();
		} 
	...
	// if(isset($_POST['hdAction_edit']) && isset($_POST['update']))
  	//  $stock_outward->EditStockInward($_POST);
