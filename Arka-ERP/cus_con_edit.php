...
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	{
		$objCustomerMgmt->EditCustomerDetails($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
	{
		$objSmarty->assign('SuccessMessage', 'Contact Updated Successfully');
	}
	if(isset($_GET['sl_no']))
	{
		$objCustomerMgmt->EditCustomerContact($_GET['sl_no']);
	}
	
  $objSmarty->assign('IncludeTpl', 'cus_con_edit.tpl');
