<?php
  require('includes/common.php');
	...
	$ObjSalesOrder->mail_list($objArray);
	if(isset($_GET['sales_quote_revise_no']))
	{
	$ObjSalesOrder->mail_list($_GET['sales_quote_revise_no']);
	}

	if(isset($_POST['hdAction']))
	{
		$ObjSalesOrder->InsertSalesOrderMail($_POST,$_FILES);
	}
...
if(isset($_GET['succs_msg']))
 {
  ...
  $objSmarty->assign('IncludeTpl', 'sales_order_mail.tpl');
