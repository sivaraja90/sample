<?php
  require('includes/common.php');
	...
	$objVendorMgmt	->ViewVendorAddress($objArray);
	//$objVendorReg	->ListSales($objArray);
	
/*$objVendorReg->DateStamp();
	$objVendorReg->TimeStamp();*/



  $objSmarty->assign('IncludeTpl', 'vendor_address_detail.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- View Vendor Address');
