<?php
  require('includes/common.php');
	...
	$ObjMaterialReg->ListMaterial($objArray);
if(isset($_GET['material_code']))
{
	$ObjMaterialReg->DeleteMaster($_GET['material_code']);
}
if(isset($_GET['succs_msg_for_del']))
{
	$objSmarty->assign('SuccessMessage', 'Material record deleted Successfully');
}

	$objSmarty->assign('IncludeTpl', 'material_list.tpl');
	$objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Material List');
