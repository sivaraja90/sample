...
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	{
		$objVendorMgmt->EditDetails($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
	{
		$objSmarty->assign('SuccessMessage', 'Vendor Contact Updated Successfully');
	}
	if(isset($_GET['sl_no']))
	{
	
		$objVendorMgmt->EditContact($_GET['sl_no']);
	}

  $objSmarty->assign('IncludeTpl', 'vendor_contact_edit.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Contact Edit');
