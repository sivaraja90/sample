<?php
  require('includes/common.php');
	...
	$objSalesQuoteReg	->SelectSalesDetail($_GET['revised_version'] && $_GET['sales_quote_no']);
	$objSalesQuoteReg	->ListSales($_GET['revised_version'] && $_GET['sales_quote_no']);
	
  $objSmarty->assign('IncludeTpl', 'sale_view.tpl');
