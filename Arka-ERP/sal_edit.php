...
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	{
		$objSalesOrder->EditDetails($_POST);
	}
	...
	if(isset($_GET['sl_no']))
	{
		...
		$objSalesOrder->EditContact($_GET['sl_no']);
	}
	if(isset($_GET['customer_id']))
	{
		$objSalesOrder->ListContact1($_GET['customer_id']);
	}
...
//	$ObjDashboard->RolesLists();
  ...
  $objSmarty->assign('IncludeTpl', 'sal_edit.tpl');
