<?php
  require('includes/common.php');
	...
	$ObjSalesOrder->ListSalesOrder($_GET['sales_order_no']);
	
	if(isset($_GET['sales_order_no']))
	{
		$ObjSalesOrder->DeleteSalesEditDetails($_GET['sales_order_no']);
  ...
  $objSmarty->assign('IncludeTpl', 'sales_quote_list.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Sales Quote List');
