<?php
  require('includes/common.php');
	...
	$ObjPoReg	= new PoReg();
	$ObjPoReg->ListPO($_GET);
	$ObjPoReg->RolesLists($objArray);
	if(isset($_GET['po_no']))
	{
	$ObjPoReg->DeletePO($_GET['po_no']);
	}
  ...
  $objSmarty->assign('IncludeTpl', 'po_list.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Po List');
