<?php
  require('includes/common.php');
	...
	{
	$ObjVendorMgmt->ViewEdit($_GET['Vendor_id']);
	}
	if(isset($_POST['hdAction']))
	{
	$ObjVendorMgmt->EditVendor($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
	 {
	 	  $objSmarty->assign('SuccessMessage', 'Vendor Updated Successfully');
	 } 

  $objSmarty->assign('IncludeTpl', 'vendor_edit.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- VendorReg');
