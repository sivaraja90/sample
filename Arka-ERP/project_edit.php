...
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	{
		$objProjectQuoteReg->EditDetails($_POST);
	}
	...
	if(isset($_GET['sl_no']))
	{
		...
		$objProjectQuoteReg->EditProject($_GET['sl_no']);
	}
	/*if(isset($_GET['enquiry_id']))
	{
		$objProjectQuoteReg->ListProject($_GET['enquiry_id']);
	}*/
	if(isset($_GET['enquiry_id']))
	{
		$objProjectQuoteReg->ListProject1($_GET['enquiry_id']);
	}
	if((isset($_GET['sl_no'])) && (isset($_GET['project_quote_no'])))
	{
	
		$objProjectQuoteReg->DeleteProjectEditDetails($_GET['sl_no'],$_GET['project_quote_no']);
	}
...
//	$ObjDashboard->RolesLists();
  ...
  $objSmarty->assign('IncludeTpl', 'project_edit.tpl');
