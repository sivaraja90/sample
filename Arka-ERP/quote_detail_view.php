<?php
  require('includes/common.php');
	...
	{
		$ObjQuoteReg-> ViewQuote($_GET['quote_id']);
		$ObjQuoteReg-> ViewQuoteMaster($_GET['quote_id']);
	}
	
	$ObjQuoteReg->DateStamp();
	$ObjQuoteReg->TimeStamp();

  $objSmarty->assign('IncludeTpl', 'quote_detail_view.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- QuoteDetail');
