<?php
  require('includes/common.php');
	...
	{
		$objServiceQuoteReg->EditService($_POST);
	}
	if(isset($_GET['service_quote_no']))
	{
		$objServiceQuoteReg->SelectId($_GET['service_quote_no']);
	}
	...
	{
		$objSmarty->assign('SuccessMessage', 'Service Updated Successfully');
	}
if((isset($_GET['sl_no'])) && (isset($_GET['service_quote_no'])) && (isset($_GET['revised_version'])) && (isset($_GET['total'])) && (isset($_GET['sub_total'])))
	{
	
		$objServiceQuoteReg->DeleteServiceEdit($_GET['sl_no'],$_GET['service_quote_no'], $_GET['revised_version'],$_GET['total'],$_GET['sub_total']);
  ...
  $objSmarty->assign('IncludeTpl', 'service_edit.tpl');
