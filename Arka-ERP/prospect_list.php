<?php
  require('includes/common.php');
	...
	$Objprospect-> ListProspect($objArray);
	
	if(isset($_GET['prospect_id']))
	{
		$Objprospect->DeleteMaster($_GET['prospect_id']);
	}
		if(isset($_GET['succs_msg_for_del']))
         {
          $objSmarty->assign('SuccessMessage', 'Prospect Deleted Successfully');
         } 
  $objSmarty->assign('IncludeTpl', 'prospect_list.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Prospect List');
