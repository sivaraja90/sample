<?php
  require('includes/common.php');
	...
	include_once $config['SiteClassPath']."class.prospect.php";
	...
	$Objprospect->Viewprospect($objArray);
	/*
	if(isset($_GET['enquiry_id'])){
	$Objprospect->ViewSales($_GET['enquiry_id']);
	$Objprospect->ViewProject($_GET['enquiry_id']);
	$Objprospect->ViewService($_GET['enquiry_id'],$_GET['sl_no']);
	$Objprospect->ViewFollow($_GET['enquiry_id']);
	$Objprospect->ViewEdit($_GET['enquiry_id']);
	}
	
	if(isset($_POST['hdAction']))
	{
		$Objprospect->UpdateAssign($_POST);
	}*/
	
	
/*
	$Objprospect->HideAddButton($objArray);
	$Objprospect->HideAddSales($objArray);
	$Objprospect->HideAddService($objArray);*/

 $objSmarty->assign('IncludeTpl', 'prospect_detail.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Prospect Detail');
