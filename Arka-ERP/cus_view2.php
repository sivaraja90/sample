<?php
  require('includes/common.php');
	...
	{
	$objProjectOrder->ViewProjectOrderQuote1($_GET['project_order_no']);
	}
	if((isset($_GET['project_order_no'])) && isset($_GET['sl_no']))
	{
...
//	$ObjDashboard->RolesLists();
  ...
  $objSmarty->assign('IncludeTpl', 'cus_view2.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- View Project');
