...
<?php
  require('includes/common.php');
	...
	{
	$ObjServiceOrder	->ToAddress2($_GET["service_order_no"]);
	}
$ObjServiceOrder	->GetEnquiryType($objArray);
	if(isset($_POST['hdAction']))
	{
	$ObjServiceOrder->InsertServiceInvoice($_POST);
	}
  ...
  $objSmarty->assign('IncludeTpl', 'service_invoice.tpl');
