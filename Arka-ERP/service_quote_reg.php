<!-- --><?php
  require('includes/common.php');
	...
	$ObjServiceQuoteReg->ViewServiceQuote();
	...
	if(isset($_GET['succs_msg_for_insert']))
         {
          $objSmarty->assign('SuccessMessage', 'New Service Added Successfully');
         } 

  $objSmarty->assign('IncludeTpl', 'service_quote_reg.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- ServiceQuoteReg');
