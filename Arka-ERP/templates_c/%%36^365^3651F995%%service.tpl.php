<?php /* Smarty version 2.6.25, created on 2017-11-30 16:51:23
         compiled from service.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'service.tpl', 413, false),)), $this); ?>
...
" readonly="true"  tabindex="1" placeholder="service Quote No">  	
...
<?php endif; ?>
				...
				<th class="col-sm-2 control-th">Quote Date</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="<?php echo $this->_tpl_vars['ServiceIn']['0']['service_quote_date']; ?>
" placeholder="Quote Date" onClick="doOnLoad();" tabindex="2" readonly="true">
			...
			<tr class="form-group" >
					<th class="col-sm-2 control-th">Payment</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" placeholder="ex :  50%" id="payment" name="payment" value="<?php echo $this->_tpl_vars['ServiceTerm']['0']['payment']; ?>
"  tabindex="3" autocomplete="Off">
						...
						<td class="col-sm-5">
						 <input type="text" class="form-control" placeholder="ex : 2 to 3 Weeks" id="delivery" name="delivery" value="<?php echo $this->_tpl_vars['ServiceTerm']['0']['delivery']; ?>
" tabindex="4" autocomplete="Off">
					...
					<tr class="form-group" >
						...
						<td class="col-sm-5">
					<select id="validity" name="validity" class="form-control" value="<?php echo $this->_tpl_vars['ServiceTerm']['0']['validity']; ?>
" tabindex="5" >
