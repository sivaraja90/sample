<?php /* Smarty version 2.6.25, created on 2016-07-02 15:42:39
         compiled from project_invoice.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'project_invoice.tpl', 197, false),)), $this); ?>
...
">
						<input type="hidden"  id="revised_version" name="revised_version" value="<?php echo $this->_tpl_vars['View']['revised_version']; ?>
" >
...
" placeholder="Invoice Number" tabindex="1" autocomplete="Off" readonly="true">
						</td>
						<td class="col-sm-5">
						<!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
						</td>
						
				<th class="col-sm-2 control-th">Project Order Number</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="project_order_no" name="project_order_no" value="<?php echo $this->_supers['get']['project_order_no']; ?>
...
" autocomplete="Off" onKeyUp="numericFilter(this);">
