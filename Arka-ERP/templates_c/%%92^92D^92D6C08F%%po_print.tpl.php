<?php /* Smarty version 2.6.25, created on 2016-08-06 17:22:20
         compiled from po_print.tpl */ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
...
?>
        <div class="row invoice-info">
          <div class="col-sm-4 invoice-col">
			...
			Consignee<br> 
              <strong><?php echo $this->_tpl_vars['View']['supplier_company_name']; ?>
,</strong><br>
              <?php echo $this->_tpl_vars['View']['supplier_address']; ?>
,<br>
			  <?php echo $this->_tpl_vars['View']['supplier_address1']; ?>
,
...
"></td>-->
                  <td><?php echo $this->_tpl_vars['View']['item_quantity']; ?>
</td>
                  <td><?php echo $this->_tpl_vars['View']['item_sub']; ?>
(<?php echo $this->_tpl_vars['View']['item_tax_per']; ?>
%)</td>
				  <td><?php echo $this->_tpl_vars['View']['item_total_price']; ?>
</td>
                </tr>
               <?php endforeach; endif; unset($_from); ?>
              </tbody>
