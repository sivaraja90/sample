<?php /* Smarty version 2.6.25, created on 2016-02-06 12:52:56
         compiled from service_reg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'service_reg.tpl', 748, false),)), $this); ?>
...
function validate_phone(data)
{
       ...
       function validate_fields()
        {	
		var fields=["emp_id","company_name","salutation","emp_first_name","emp_last_name","company_code","father_name","mother_name","d_o_b","sex","mobile_1","image","qualification","area_code","phone1","extension","designation","joining_date","residence_mobile","address1","area","pincode","personal_mail","company_mail","no_of_year_exp","created_by","remarks"]; 	
  ...
  <body class="hold-transition skin-blue sidebar-mini" onLoad="doOnLoad();">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<h4>
        <small><a href="service_list.php"><i class="fa fa-list">
		List Service</i></a></small>&ensp;&ensp;&ensp;
		<small><a href="service_reg.php"><i class="fa fa-user-plus">
        ...
        <section class="content">
          ...
          <div class="box box-info">
            <div class="box-header with-border" align="center">
              <h3 class="box-title">Service Registration</h3>
...
" tabindex="1" placeholder="Employee Id" autocomplete="0ff">
                      </div>
...
" tabindex="4" style="margin-left:-25px; width:150px;" onKeyUp="text_filter(this)" autocomplete="0ff">
					</div>
					<div class="col-sm-3">
...
" tabindex="5" style="width:130px;" onKeyUp="text_filter(this)" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
...
" tabindex="7" placeholder="Father Name" onKeyUp="text_filter(this)" autocomplete="0ff">
                      </div>
                    </div>
					  <div class="form-group">
...
"  maxlength="10" placeholder="Mobile No 2"  onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="0ff">
                      </div>
                    </div>
...
" tabindex="13" placeholder="Qualification" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="department" name="department" value="TESTING" tabindex="17" placeholder="Department" data-toggle="modal" data-target="#Department"  readonly="true" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>	
					<div class="form-group">
...
" tabindex="25" placeholder="Personal Mail" autocomplete="0ff">
                      </div>
                    </div>
					<div class="form-group">
...
" tabindex="27" placeholder="Experience" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5" >
                      <textarea class="form-control" id="remarks" name="remarks" tabindex="29" placeholder="Remarks" value="<?php echo $this->_supers['post']['remarks']; ?>
...
" tabindex="2" placeholder="Company Name" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
                    <div class="form-group">
...
" tabindex="6" placeholder="Company Code" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
...
" tabindex="8" placeholder="Mother Name" onKeyUp="text_filter(this)" autocomplete="0ff">
                      </div>
                    </div> 
					 <div class="form-group">
...
" tabindex="10" placeholder="Sex" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
...
" placeholder="Area Code" tabindex="14" onKeyUp="numericFilter(this);" autocomplete="0ff" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone1" name="phone1" value="<?php echo $this->_supers['post']['phone1']; ?>
" placeholder="Phone No" tabindex="15"onKeyUp="numericFilter(this);" autocomplete="0ff" >
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="<?php echo $this->_supers['post']['extension']; ?>
" placeholder="Extension" tabindex="16" onKeyUp="numericFilter(this);" autocomplete="0ff" >
                       </div>
...
" placeholder="Area Code 1" onKeyUp="numericFilter(this);" autocomplete="0ff" >
					  </div>
                      <div class="col-sm-2">
...
" placeholder="extension 1" onKeyUp="numericFilter(this);" autocomplete="0ff" >
                       </div>
					   </div>
...
" tabindex="18" placeholder="Designation"    autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					 <div class="form-group">
...
"  tabindex="22" placeholder="Address2" autocomplete="0ff">
                      </div>
                    </div>
					<div class="form-group">
...
" tabindex="26" placeholder="Company Mail" onKeyUp="clear_err_email_id();" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
...
" tabindex="28" placeholder="Created By" autocomplete="0ff">
						<input type="hidden" class="form-control" id="created_time" name="created_time" tabindex="10" placeholder="Time" Value="<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%I:%M:%S %p') : smarty_modifier_date_format($_tmp, '%I:%M:%S %p')); ?>
">
						<input type="hidden" class="form-control" id="created_date" name="created_date" tabindex="8" placeholder="Date" value="<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
" >
                      </div>
                    </div>		
