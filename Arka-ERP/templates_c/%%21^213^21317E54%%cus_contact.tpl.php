<?php /* Smarty version 2.6.25, created on 2017-11-30 16:46:42
         compiled from cus_contact.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'cus_contact.tpl', 436, false),)), $this); ?>
...
">
				   ...
				   <tr class="form-group">
                      ...
                      <td class="col-sm-2">
					  <select id="salutation" name="salutation"  class="form-control" tabindex="1" value="<?php echo $this->_supers['post']['salutation']; ?>
...
" tabindex="2" style="margin-left:-108px; width:150px;" onKeyUp="text_filter(this);" autocomplete="off">
					  </td>
					  <td class="col-sm-3">
...
" style="margin-left:-28px; width:150px;" tabindex="3" onKeyUp="text_filter(this);" autocomplete="off"><td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>&nbsp;&nbsp;--></td>
                      </td>
...
" maxlength="10" tabindex="4" style="width:150;" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off"><td><input type="button" class="btn btn-danger btn-xs" value="ADD MOBILE"  onClick="add_more_mobile();" style="margin-right:-100px;"><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>&nbsp;&nbsp;--></td>
                     </td>
                    </tr>
					<tr class="form-group" id="hdn_mobile2" style="display:none;">
                      <th class="col-sm-4 control-th">Mobile No 2 </th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="mobile_no2" name="mobile_no2" maxlength="10" placeholder="Mobile No 2" value="<?php echo $this->_supers['post']['mobile_no2']; ?>
...
" name="created_by" readonly="true" tabindex="5">
                      </td>
					</tr>
					<tr class="form-group">
...
" placeholder="Designation" tabindex="6" onKeyUp="text_filter(this);" autocomplete="off">
...
">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="area" value="<?php echo $this->_supers['post']['area']; ?>
" name="area" placeholder="Area" tabindex="7" autocomplete="off" onKeyUp="text_filter(this);"><td><!--<input type="button" class="btn btn-danger btn-xs" value="ADD Address"  onClick="add_address();" style="margin-right:-100px;">--><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>&nbsp;&nbsp;--></td>
                     </td>
					...
					<!--<tr class="form-group" id="hdn_address2" style="display:none;">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="address2" name="address2" maxlength="10" placeholder="Address" value="<?php echo $this->_supers['post']['address2']; ?>
" autocomplete="off">
                      </td>
                    </tr>
					<tr class="form-group" id="hdn_address3" style="display:none;">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="address3" name="address3" maxlength="10" placeholder="Address" value="<?php echo $this->_supers['post']['address3']; ?>
" autocomplete="off">
                      </td>
                    </tr>-->
					 <tr class="form-group">
                      <th class="col-sm-4 control-th">Phone No</th>
					    <td class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" maxlength="6" value="<?php echo $this->_supers['post']['area_code']; ?>
" placeholder="Area Code" tabindex="8" style="width:75px;" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" maxlength="10" value="<?php echo $this->_supers['post']['phone_no']; ?>
" placeholder="Phone No" maxlength="9" style="width:100px; margin-left:-100px;" tabindex="8"onKeyUp="numericFilter(this);" autocomplete="off" >
                      </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" maxlength="4" placeholder="Extension" value="<?php echo $this->_supers['post']['extension']; ?>
" tabindex="10" style="width:100px; margin-left:-70px;" onKeyUp="numericFilter(this);" autocomplete="off"></td>
...
" placeholder="Email Id" tabindex="11" onKeyUp="clear_err_email_id();" autocomplete="off" onBlur="chk_exist_email(this);">
...
" placeholder="Email Id 1"  onKeyUp="clear_err_email_id();" autocomplete="off" onBlur="chk_exist_email(this);">
                      </td>
					  </tr>
					<tr class="form-group">
...
" tabindex="12" autocomplete="off"></textarea>
                      <td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					  </td>
                    </tr>
					</table>
