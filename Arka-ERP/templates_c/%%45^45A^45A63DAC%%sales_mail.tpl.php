<?php /* Smarty version 2.6.25, created on 2017-11-30 16:51:21
         compiled from sales_mail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sales_mail.tpl', 146, false),)), $this); ?>
...
"  readonly="true" autocomplete="off">
		...
		<?php endif; ?>
			...
			<table  class="table table-bordered table-striped">
				...
				<?php $_from = $this->_tpl_vars['EnqSalmailview']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['salMail']):
?>
				<tr class="taglist2">
				<td >&nbsp;</td>
				<?php if ($this->_tpl_vars['salMail']['mail_id'] != ""): ?>
				<td><input type="checkbox" name="check2" id="check2" onClick="dynInput(this);" value="<?php echo $this->_tpl_vars['salMail']['mail_id']; ?>
" />&nbsp;&nbsp;<?php echo $this->_tpl_vars['salMail']['mail_id']; ?>
&nbsp;&nbsp;<?php endif; ?>&nbsp;&nbsp;<?php if ($this->_tpl_vars['salMail']['mail_id1'] != ""): ?>
				<input type="checkbox" name="check1" id="check1" onClick="dynInput(this);" value="<?php echo $this->_tpl_vars['salMail']['mail_id1']; ?>
" />&nbsp;&nbsp;<?php echo $this->_tpl_vars['salMail']['mail_id1']; ?>
</td>
				<?php endif; ?>
				</tr>
