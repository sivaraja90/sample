<?php /* Smarty version 2.6.25, created on 2017-01-27 11:12:04
         compiled from vendor_address_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'vendor_address_edit.tpl', 343, false),)), $this); ?>
...
">
				   ...
				   <?php $_from = $this->_tpl_vars['EditAddress']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['Contact']):
?>
				   <input type="hidden" id="sl_no" name="sl_no" value="<?php echo $this->_tpl_vars['Contact']['sl_no']; ?>
" />
				   <input type="hidden" id="vendor_id" name="vendor_id" value="<?php echo $this->_tpl_vars['Contact']['vendor_id']; ?>
"/>
					<tr class="form-group">
                      <th class="col-sm-4 control-th">vendorId</th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="vendor_id" value="<?php echo $this->_tpl_vars['Contact']['vendor_id']; ?>
" name="vendor_id" tabindex="1" placeholder="Vendor Id" readonly="true" >
                      </td>
...
" placeholder="Area" tabindex="2" onKeyUp="text_filter(this);" >
					      </td>
					   <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
                     ...
                     <tr class="form-group">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="address" name="address"  placeholder="Address" tabindex="3" value="<?php echo $this->_tpl_vars['Contact']['address']; ?>
" onClick="doOnLoad();"  autocomplete="off" >
                      </td>
					   <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
                   
                      <th class="col-sm-4 control-th">Address1</th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="address1" name="address1" value="<?php echo $this->_tpl_vars['Contact']['address1']; ?>
" placeholder="Address1" tabindex="4" onKeyUp="text_filter(this);">
...
">
					 ...
					 <tr class="form-group">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="landmark" name="landmark" value="<?php echo $this->_tpl_vars['Contact']['landmark']; ?>
" placeholder="Land Mark" tabindex="5" >
                   </td>
					 <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					     <th class="col-sm-4 control-th">City</th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="city" name="city" tabindex="6" value="<?php echo $this->_tpl_vars['Contact']['city']; ?>
" placeholder="City" >
                      </td>
					  <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					</tr> 
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="pincode" name="pincode" value="<?php echo $this->_tpl_vars['Contact']['pincode']; ?>
" placeholder="Pincode" tabindex="7" maxlength="6" onKeyUp="numericFilter(this);" >
                      </td>
					  <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					   <th class="col-sm-4 control-th">Remarks</th>
                      <td class="col-sm-6">
                        <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks" tabindex="8"><?php echo $this->_tpl_vars['Contact']['remarks']; ?>
</textarea>
                      					  </td>
										  <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					  </tr>
...
" placeholder="Created By" tabindex="9" readonly="true"><td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
                    </tr>
