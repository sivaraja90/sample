<?php /* Smarty version 2.6.25, created on 2016-02-15 15:27:29
         compiled from sales_quote_reg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sales_quote_reg.tpl', 604, false),)), $this); ?>
...
">
                  ...
                  <div class="box-body">
				   ...
				   <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sales_quote_no" name="sales_quote_no" value="<?php echo $this->_tpl_vars['s_quote']; ?>
" placeholder="Sales Quote No" tabindex="1" readonly="true" autocomplete="off">
                      </div>
...
" placeholder="Revised Version"  tabindex="3" autocomplete="off" readonly="true" >
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
...
" placeholder="Pincode" tabindex="17" onBlur="chk_exist_pin(this)" maxlength="6" onKeyUp="numericFilter(this);"  autocomplete="off">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="unit_basic" name="unit_basic" value="<?php echo $this->_supers['post']['unit_basic']; ?>
" placeholder="Unit Basic" tabindex="19" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="vat_value" name="vat_value" value="<?php echo $this->_supers['post']['vat_value']; ?>
" placeholder="Vat Value"  onKeyUp="getvalue();numericFilter(this);" tabindex="21" autocomplete="off">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sub_total" name="sub_total" value="<?php echo $this->_supers['post']['sub_total']; ?>
...
" placeholder="Company Name" tabindex="4" autocomplete="off" >
                      </div>
					  </div>
					  <div class="form-group">
                      <label class="col-sm-3 control-label">Contact Person</label>
                  <div class="col-sm-5">
						<input type="text" class="form-control" id="contact_name" name="contact_name" placeholder="Contact Name" value="<?php echo $this->_supers['post']['contact_name']; ?>
" tabindex="6" onKeyUp="text_filter(this);" autocomplete="off">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="file"  id="profile_image" name="profile_image" maxlength="25" value="<?php echo $this->_supers['post']['profile_image']; ?>
" placeholder="Profile Image" tabindex="8" autocomplete="off">
                      </div>
					&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					  </div>
					  <div class="form-group">
...
" placeholder="City" tabindex="16" autocomplete="off">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="product_description" name="product_description" value="<?php echo $this->_supers['post']['product_description']; ?>
" placeholder="Product Description" tabindex="18" autocomplete="off" >
                      </div> &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font></div>
					   <div class="form-group" style=" margin-top:-15px;" >
                      <label class="col-sm-3 control-label">Quantity</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quantity" name="quantity" value="<?php echo $this->_supers['post']['quantity']; ?>
" placeholder="Quantity" tabindex="20" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="vat_percentage" name="vat_percentage" value="<?php echo $this->_supers['post']['vat_percentage']; ?>
