<?php /* Smarty version 2.6.25, created on 2017-11-03 16:49:34
         compiled from product_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'product_edit.tpl', 742, false),)), $this); ?>
        ...
        <section class="content">
          ...
          <div class="box box-default">
			...
			<input type="hidden" name="hdAction" />
					...
					<input type="hidden" id="hdn_salutation" name="hdn_salutation" value="<?php echo $this->_tpl_vars['ListDet']['salutaion']; ?>
">
					<input type="hidden" id="hdn_order_status" name="hdn_order_status" value="<?php echo $this->_tpl_vars['ListDet']['order_status']; ?>
">
					<input type="hidden" id="hdn_customer_status" name="hdn_customer_status" value="<?php echo $this->_tpl_vars['ListDet']['customer_status']; ?>
">
					<input type="hidden" id="hdn_customer_type" name="hdn_customer_type" value="<?php echo $this->_tpl_vars['ListDet']['customer_type']; ?>
">
                  ...
                  <div class="box-body">
				   <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_code" value="<?php echo $this->_tpl_vars['ListDet']['item_code']; ?>
" name="item_code" tabindex="1" placeholder="Item Code" readonly="true">
                      </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_category" name="item_category" value="<?php echo $this->_tpl_vars['ListDet']['item_category']; ?>
" tabindex="3" placeholder="Item Category">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_description" name="item_description" value="<?php echo $this->_tpl_vars['ListDet']['item_description']; ?>
" tabindex="5" placeholder="Item Description">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="consumer_basic" name="consumer_basic" value="<?php echo $this->_tpl_vars['ListDet']['consumer_basic']; ?>
" tabindex="7" placeholder="Consumer Basic">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="features" name="features" value="<?php echo $this->_tpl_vars['ListDet']['features']; ?>
" tabindex="9" placeholder="Features">
                      </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="dimensions" name="dimensions" value="<?php echo $this->_tpl_vars['ListDet']['dimensions']; ?>
" tabindex="11" placeholder="Dimentions">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total" name="total" value="<?php echo $this->_tpl_vars['ListDet']['total']; ?>
" tabindex="13" placeholder="Total" onKeyUp="numericFilter(this);">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks" tabindex="15"><?php echo $this->_tpl_vars['ListDet']['remarks']; ?>
</textarea>
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954">&nbsp;</font>-->
                    </div>
					...
					<!--**********************************************************-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_name" name="item_name" value="<?php echo $this->_tpl_vars['ListDet']['item_name']; ?>
" tabindex="2" placeholder="Item Name">
                      </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_category_code" value="<?php echo $this->_tpl_vars['ListDet']['item_category_code']; ?>
" tabindex="4" name="item_category_code" placeholder="Item category code">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_color" name="item_color" value="<?php echo $this->_tpl_vars['ListDet']['item_color']; ?>
" tabindex="6" placeholder="Item Color">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954">&nbsp;</font>-->
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="baan_company" name="baan_company" value="<?php echo $this->_tpl_vars['ListDet']['baan_company']; ?>
" tabindex="8" placeholder="Baan Company">
                      </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">
...
" name="image" tabindex="12" autocomplete="off"></div>
						 ...
						 <input type="text" id="image1" value="<?php echo $this->_tpl_vars['ListDet']['image']; ?>
" name="image1" tabindex="12" autocomplete="off" size="18" readonly="true">&nbsp;&nbsp;<div class="fa fa-pencil-square-o" id="" onClick="image_hide();"> </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pkg" name="pkg" value="<?php echo $this->_tpl_vars['ListDet']['pkg']; ?>
" tabindex="12" placeholder="123" onKeyUp="numericFilter(this);">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954">&nbsp;</font>-->
                    </div>
					<div class="form-group">
                     ...
                     <div class="col-sm-5">
                        <input type="text" class="form-control" id="price_date" name="price_date"  value="<?php echo $this->_tpl_vars['ListDet']['price_date']; ?>
" placeholder="Date" tabindex="14" onClick="doOnLoad();"  readonly="true">
                      </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="ed" value="<?php echo $this->_tpl_vars['ListDet']['ed']; ?>
" name="ed" tabindex="16" placeholder="ED" onKeyUp="numericFilter(this);">
...
">
					 ...
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="wh" value="<?php echo $this->_tpl_vars['ListDet']['ware_house']; ?>
" name="wh" tabindex="18" placeholder="Wh">
						<input type="hidden" class="form-control" id="created_by"  name="created_by" placeholder="Created By" value="<?php echo $this->_tpl_vars['ListDet']['created_by']; ?>
"  readonly="true" >
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
