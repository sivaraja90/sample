<?php /* Smarty version 2.6.25, created on 2016-07-02 11:30:17
         compiled from project_view.tpl */ ?>
...
'; ?>
 ...
 <!--<h4 class="box-title"><center>Project Quote Detailed View</center></h4>-->
...
"/>
					<input type="hidden" id="project_quote_no" name="project_quote_no" value="<?php echo $this->_tpl_vars['Edit']['project_quote_no']; ?>
"/>
				   <?php $_from = $this->_tpl_vars['ProjectList3']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['Edit']):
?>
				  <tr class="form-group">
                      <th class="col-sm-4 control-th" style="font-weight:bold;">Project Quote No </th>
                      <td class="col-sm-2">
                       <?php echo $this->_tpl_vars['Edit']['project_quote_no']; ?>
...
<br>
					...
					<form id="Projectlist" name="Projectlist" method="post">
                    ...
                    <tbody>
                      ...
                      <?php $_from = $this->_tpl_vars['ProjectList2']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
