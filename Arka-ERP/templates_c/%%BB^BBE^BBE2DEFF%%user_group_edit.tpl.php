<?php /* Smarty version 2.6.25, created on 2017-01-07 15:45:21
         compiled from user_group_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'user_group_edit.tpl', 50, false),)), $this); ?>
...
?>
				   <div class="col-md-6">
                    <div class="form-group">			 
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="group_id" name="group_id" value="<?php echo $this->_tpl_vars['View']['group_id']; ?>
...
">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="group_name" name="group_name" tabindex="2" value="<?php echo $this->_tpl_vars['View']['group_name']; ?>
" placeholder="Group Name" autocomplete="Off" onKeyUp="textFilter(this);">
					 ...
					 <div class="form-group">			 
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="description" name="description" tabindex="3" value="<?php echo $this->_tpl_vars['View']['description']; ?>
