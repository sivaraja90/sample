<?php /* Smarty version 2.6.25, created on 2016-08-05 13:08:51
         compiled from service_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'service_edit.tpl', 380, false),)), $this); ?>
...
"/>
				...
				<th class="col-sm-2 control-th">Quote Date</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="<?php echo $this->_tpl_vars['LDList2']['0']['service_quote_date']; ?>
...
function deleteCat(CatIdent,CusIdent,Rive,Total,Sub){
  ...
  FormName.action= "service_edit.php?sl_no="+CatIdent+"&service_quote_no="+CusIdent+"&revised_version="+Rive+"&total="+Total+"&sub_total="+Sub;
  FormName.submit();
 }
 }
    </script>
