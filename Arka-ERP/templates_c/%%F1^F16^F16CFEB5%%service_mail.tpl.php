<?php /* Smarty version 2.6.25, created on 2016-07-30 15:38:14
         compiled from service_mail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'service_mail.tpl', 143, false),)), $this); ?>
...
"  readonly="true" autocomplete="off">
			...
			<table  class="table table-bordered table-striped">
				<?php $_from = $this->_tpl_vars['EnqSermailview']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['serMail']):
?>
				<tr class="taglist2">
				<td >&nbsp;</td>
				<?php if ($this->_tpl_vars['serMail']['mail_id'] != ""): ?>
				<td><input type="checkbox" name="check2" id="check2" onClick="dynInput(this);" value="<?php echo $this->_tpl_vars['serMail']['mail_id']; ?>
" />&nbsp;&nbsp;<?php echo $this->_tpl_vars['serMail']['mail_id']; ?>
&nbsp;&nbsp;<?php endif; ?>&nbsp;&nbsp;<?php if ($this->_tpl_vars['serMail']['mail_id1'] != ""): ?>
				<input type="checkbox" name="check1" id="check1" onClick="dynInput(this);" value="<?php echo $this->_tpl_vars['serMail']['mail_id1']; ?>
" />&nbsp;&nbsp;<?php echo $this->_tpl_vars['serMail']['mail_id1']; ?>
</td>
				<?php endif; ?>
				</tr>
				...
				<tr>
				<th>To</th>			
				<td><textarea id="mail_id2" name="mail_id2" style="width:530px;" value="<?php echo $this->_supers['post']['mail_id2']; ?>
"><?php echo $this->_supers['post']['mail_id2']; ?>
</textarea></td>
				</tr>
				<tr>
				<th>cc</th>
				<td><input type="text" name="cc" id="cc" value="valliappan@arkagroup.co.in" style="width:530px;"/></td>
				</tr>
				<tr>
				<th>Subject</th>
				<td><textarea id="subject" name="subject" style="width:530px;" value="<?php echo $this->_supers['post']['subject']; ?>
" ><?php echo $this->_supers['post']['subject']; ?>
</textarea></td>
				</tr>
				<tr>
				<th>Message</th>
				<td><textarea class="ckeditor" id="message" name="message" style="width:545px;"><?php echo $this->_supers['post']['message']; ?>
</textarea></td>
				</tr>
				<tr>
				<th>Attachment 1</th>
