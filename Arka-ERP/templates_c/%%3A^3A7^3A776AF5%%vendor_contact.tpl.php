<?php /* Smarty version 2.6.25, created on 2017-01-27 11:12:03
         compiled from vendor_contact.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'vendor_contact.tpl', 425, false),)), $this); ?>
...
">
				   ...
				   <table class="col-md-6">
					<tr class="form-group">
                      ...
                      <td class="col-sm-2">
					  <select id="salutation" name="salutation"  class="form-control" tabindex="3" value="<?php echo $this->_supers['post']['salutation']; ?>
...
"  placeholder="Date" onClick="doOnLoad();" tabindex="6" readonly="true"  autocomplete="Off"></td><td>
...
" placeholder="Area" tabindex="9" autocomplete="off" onKeyUp="text_filter(this);">
               			<td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
                      </tr> 
					 <tr class="form-group">
...
" placeholder="Phone No" style="width:100px; margin-left:-100px;" tabindex="11"onKeyUp="numericFilter(this);" autocomplete="off" >
                      </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" placeholder="Extension" value="<?php echo $this->_supers['post']['extension']; ?>
" tabindex="12" style="width:100px; margin-left:-70px;" onKeyUp="numericFilter(this);" autocomplete="off">
						</td>
