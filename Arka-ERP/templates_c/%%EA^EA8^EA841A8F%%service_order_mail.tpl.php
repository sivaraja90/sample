<?php /* Smarty version 2.6.25, created on 2016-07-30 17:46:35
         compiled from service_order_mail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'service_order_mail.tpl', 126, false),)), $this); ?>
...
<form name="ServiceMailAdd" id="ServiceMailAdd" method="post" enctype="multipart/form-data">
		<input type="hidden" name="hdAction">
			<?php $_from = $this->_tpl_vars['Sermailview']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
">											
 			<input type="hidden" id="service_quote_revise_no" name="service_quote_revise_no" value="<?php echo $this->_tpl_vars['View']['service_quote_revise_no']; ?>
">
...
?>
				<tr class="taglist2">
				<td >&nbsp;</td>
				<?php if ($this->_tpl_vars['serMail']['email_id'] != ""): ?>
				<td ><input type="checkbox" name="check1" id="check1" onClick="dynInput(this);" value="<?php echo $this->_tpl_vars['serMail']['email_id']; ?>
" />&nbsp;&nbsp;<?php echo $this->_tpl_vars['serMail']['email_id']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;
				<?php endif; ?>
				<?php if ($this->_tpl_vars['serMail']['email_id1'] != ""): ?>
				<input type="checkbox" name="check2" id="check2" onClick="dynInput(this);" value="<?php echo $this->_tpl_vars['serMail']['email_id1']; ?>
" />&nbsp;&nbsp;<?php echo $this->_tpl_vars['serMail']['email_id1']; ?>
</td>
				<?php endif; ?>
				</tr>
				<?php endforeach; endif; unset($_from); ?>
				<tr>
				<th>To</th>			
				<td><textarea id="mail_id2" name="mail_id2" style="width:515px;"><?php echo $this->_supers['post']['mail_id2']; ?>
</textarea></td>
				</tr>
				<tr>
				<th>cc</th>
...
"><?php echo $this->_supers['post']['subject']; ?>
				...
				<tr>
				<th>Message</th>
				<td><textarea class="ckeditor" id="message" name="message" style="width:515px;"><?php echo $this->_supers['post']['message']; ?>
</textarea></td>
				</tr>
				<tr>
				<th>Attachment 1</th>
