<?php /* Smarty version 2.6.25, created on 2017-07-04 13:03:56
         compiled from enquiry_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'enquiry_edit.tpl', 779, false),)), $this); ?>
...
?>		
        ...
        <section class="content">
		 ...
		 <?php endif; ?>		<input type="hidden" id="hdn_customer_type" name="hdn_customer_type" value="<?php echo $this->_tpl_vars['Edit']['customer_type']; ?>
">
...
"  >
					...
					<input type="hidden" id="hdn_salutation" name="hdn_salutation" value="<?php echo $this->_tpl_vars['Edit']['salutaion']; ?>
">
					<input type="hidden" id="hdn_order_status" name="hdn_order_status" value="<?php echo $this->_tpl_vars['Edit']['order_status']; ?>
">
					<input type="hidden" id="hdn_customer_status" name="hdn_customer_status" value="<?php echo $this->_tpl_vars['Edit']['customer_status']; ?>
">
					<input type="hidden" id="hdn_customer_type" name="hdn_customer_type" value="<?php echo $this->_tpl_vars['Edit']['customer_type']; ?>
">
                  <div class="box-body">
...
?>
				   <div class="col-md-6">
				    <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="enquiry_id" name="enquiry_id" placeholder="Enquiry Id" value="<?php echo $this->_tpl_vars['Edit']['enquiry_id']; ?>
" tabindex="1"  value="test">
					...
					<div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="customer_id" name="customer_id" value="<?php echo $this->_tpl_vars['Edit']['customer_id']; ?>
" placeholder="Customer Id" tabindex="3">
                      </div>
                    </div>
                  ...
                  <div class="col-sm-5">
					...
					<option id"<?php echo $this->_tpl_vars['Edit']['customer_name']; ?>
" value="<?php echo $this->_tpl_vars['Edit']['customer_name']; ?>
" selected="selected"><?php echo $this->_tpl_vars['Edit']['customer_name']; ?>
(<?php echo $this->_tpl_vars['Edit']['area']; ?>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No" value="<?php echo $this->_tpl_vars['Edit']['mobile_no']; ?>
" maxlength="10" tabindex="7" onKeyUp = "numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);">
                      </div>
                    </div>
				...
				<div class="col-sm-5">
				<input type="email" class="form-control" id="mail_id" name="mail_id" placeholder="Email Id" value="<?php echo $this->_tpl_vars['Edit']['email_id']; ?>
" tabindex="11" onKeyUp="clear_err_email_id();">
				</div>
				</div> 																		
				...
				<div class="col-sm-5">
				<input type="email" class="form-control" id="mail_id1" name="mail_id1" placeholder="Email Id 1" value="<?php echo $this->_tpl_vars['Edit']['email_id1']; ?>
" tabindex=""  onKeyUp="clear_err_email_id();" >
				</div>
				</div>
				...
				<div class="form-group" id="snzDate">
                      ...
                      <div class="col-sm-5">
            <input type="text" class="form-control" id="snooze_date" name="snooze_date" placeholder ="Snooze Date"  value="<?php echo $this->_tpl_vars['Edit']['snooze_date']; ?>
" tabindex="13" readonly="true">
					...
					<div class="form-group" id="closedDate" style="display:none"> 
                      ...
                      <div class="col-sm-5">
        <input type="text" class="form-control" id="closed_date" name="closed_date"  placeholder ="Closed Date" value="<?php echo $this->_tpl_vars['Edit']['closed_date']; ?>
...
" tabindex="" readonly="true" >
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address" name="address" placeholder="Address" value="<?php echo $this->_tpl_vars['Edit']['address']; ?>
" tabindex="17">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" placeholder="Address1" value="<?php echo $this->_tpl_vars['Edit']['address1']; ?>
" tabindex="19">
                      </div> 
					  </div> 
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" placeholder="Area" tabindex="21" value="<?php echo $this->_tpl_vars['Edit']['area']; ?>
" onKeyUp="text_filter(this);">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="landmark" name="landmark" placeholder="Land Mark" value="<?php echo $this->_tpl_vars['Edit']['landmark']; ?>
" tabindex="23">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="city" name="city" placeholder="City" tabindex="25" value="<?php echo $this->_tpl_vars['Edit']['city']; ?>
" onKeyUp="text_filter(this);">
                      </div>
					  </div>
					...
					<div class="col-sm-5">
					<input type="text" class="form-control" id="pincode" name="pincode" placeholder="Pincode" tabindex="27" value="<?php echo $this->_tpl_vars['Edit']['pincode']; ?>
" maxlength="6" onBlur="chk_exist_pin(this)" onKeyUp="numericFilter(this);">
					</div>
					</div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
					  <select id="pg" name="pg" class="form-control" tabindex="12" value="<?php echo $this->_tpl_vars['Edit']['PG']; ?>
" onChange="pg_select();">
						<option id"<?php echo $this->_tpl_vars['Edit']['pg']; ?>
" value="<?php echo $this->_tpl_vars['Edit']['pg']; ?>
" selected="selected"><?php echo $this->_tpl_vars['Edit']['PG']; ?>
</option>
					...
					<!--**********************************************************-->
                     <div class="col-md-6">
                      ...
                      <div class="col-sm-5">
   <input type="text" class="form-control" id="company_name" name="company_name" value="<?php echo $this->_tpl_vars['Edit']['company_name']; ?>
"  placeholder="Company Name" tabindex="2" onKeyUp="text_filter(this);">
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">ARKA Group </label>
						<div class="col-sm-5">
						<select id="arka_group" name="arka_group" class="form-control" value="<?php echo $this->_tpl_vars['Edit']['arka_group']; ?>
"  tabindex="4">
			<?php if ($this->_tpl_vars['Edit']['arka_group'] == 'Universal Infrastructure Systems'): ?>
			...
			<?php elseif ($this->_tpl_vars['Edit']['arka_group'] == 'Asian Engineering'): ?>
			...
			<option value="Arka Automaations LTD">Arka Automaations LTD</option>
			<option value="Adroit Solutionz">Adroit Solutionz</option>
			<?php elseif ($this->_tpl_vars['Edit']['arka_group'] == 'Arka Automaations LTD'): ?>
			<option value="Universal Infrastructure Systems">Universal Infrastructure Systems</option>
			<option value="Asian Engineering">Asian Engineering</option>
			<option selected="selected">Arka Automaations LTD</option>
			<option value="Adroit Solutionz">Adroit Solutionz</option>
			<?php elseif ($this->_tpl_vars['Edit']['arka_group'] == 'Adroit Solutionz'): ?>
			<option value="Universal Infrastructure Systems">Universal Infrastructure Systems</option>
			<option value="Asian Engineering">Asian Engineering</option>
			<option value="Arka Automaations LTD">Arka Automaations LTD</option>
			<option selected="selected">Adroit Solutionz</option>
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-5">
      <input type="text" class="form-control" id="designation" name="designation" placeholder="Designation" value="<?php echo $this->_tpl_vars['Edit']['designation']; ?>
" tabindex="6" onKeyUp="text_filter(this);">
...
">
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Phone No</label>
					    <div class="col-sm-2">
         <input type="text" class="form-control" id="area_code" name="area_code" placeholder="Area Code" value="<?php echo $this->_tpl_vars['Edit']['area_code']; ?>
" tabindex="8" onKeyUp="numericFilter(this);" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="Phone No" value="<?php echo $this->_tpl_vars['Edit']['phone_no']; ?>
" maxlength="9" tabindex="9" style="width:60px; margin-left:-25px;" onKeyUp="numericFilter(this);" >
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" placeholder="Extension" value="<?php echo $this->_tpl_vars['Edit']['extension']; ?>
" tabindex="10" onKeyUp="numericFilter(this);" style="margin-left:-45px;" >
                       </div>
					   </div>
                      ...
                      <label class="col-sm-3 control-label">Enquiry Type </label>
						<div class="col-sm-5">
						<select id="enquiry_type" name="enquiry_type" class="form-control" tabindex="12" value="<?php echo $this->_tpl_vars['Edit']['enquiry_type']; ?>
" >
						<option id"<?php echo $this->_tpl_vars['Edit']['enquiry_type']; ?>
" value="<?php echo $this->_tpl_vars['Edit']['enquiry_type']; ?>
" selected="selected"><?php echo $this->_tpl_vars['Edit']['enquiry_type']; ?>
</option>
						<option value="0">----Select------</option>
						<option>Sales</option>
					...
					<div class="form-group" id="closedTime" style="display:none">
                      ...
                      <div class="col-sm-2">
          < input type="text" class="form-control" id="closed_hours" name="closed_time"  placeholder="Hours" maxlength="8" tabindex="14" value="<?php echo $this->_tpl_vars['Edit']['closed_hours']; ?>
"  tabindex="11">
						</div>
						<div class="col-sm-2">
					    <input type="text" class="form-control" id="closed_minutes" name="closed_minutes" placeholder="Minutes" maxlength="59" value="<?php echo $this->_tpl_vars['Edit']['closed_minutes']; ?>
" tabindex="" style="margin-left:-20px;" onKeyUp="numericFilter(this);" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="closed_seconds" name="closed_seconds" placeholder="Seconds" value="<?php echo $this->_tpl_vars['Edit']['closed_seconds']; ?>
" maxlength="59" tabindex="" style="margin-left:-40px;" onKeyUp="numericFilter(this);" >
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
						<select id="enquiry_status" name="enquiry_status" class="form-control" tabindex="16" value="<?php echo $this->_tpl_vars['Edit']['enquiry_status']; ?>
" >
						<option id"<?php echo $this->_tpl_vars['Edit']['enquiry_status']; ?>
" value="<?php echo $this->_tpl_vars['Edit']['enquiry_status']; ?>
" selected="selected"><?php echo $this->_tpl_vars['Edit']['enquiry_status']; ?>
</option>
						<option value="0">----Select-----</option>
...
" selected="selected"><?php echo $this->_tpl_vars['Edit']['open_status']; ?>
					   ...
					   <div class="form-group">
						  ...
						  <div class="col-sm-5">
							<input type="text" class="form-control" id="enquiry_through" name="enquiry_through" value="<?php echo $this->_tpl_vars['Edit']['enquiry_through']; ?>
" placeholder="Enquiry Through"  tabindex="18" data-toggle="modal" data-target="#Enquiry" >
						  </div>
						</div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="reference_id" name="reference_id" placeholder="Reference Id" value="<?php echo $this->_tpl_vars['Edit']['reference_id']; ?>
" tabindex="20" >
                      </div>
                    </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
<!--      <input type="text" class="form-control" id="assign_to" name="assign_to" placeholder="Assign To" value="<?php echo $this->_tpl_vars['Edit']['assign_to']; ?>
" tabindex="22" onKeyUp="text_filter(this);">-->
	   <select id="assign_to" name="assign_to" class="form-control" value="<?php echo $this->_tpl_vars['Edit']['assign_to']; ?>
" tabindex="8" >
...
" tabindex="8" onKeyUp="text_filter(this);">-->
						<option id"<?php echo $this->_tpl_vars['Edit']['assign_to']; ?>
" value="<?php echo $this->_tpl_vars['Edit']['assign_to']; ?>
" selected="selected"><?php echo $this->_tpl_vars['Edit']['assign_to']; ?>
</option>
						<option value="0">----Select------</option>
...
"><?php echo $this->_tpl_vars['asslist']['username']; ?>
					...
					<?php endforeach; endif; unset($_from); ?>
						...
						<div class="col-sm-5">
						<input type="text" class="form-control" id="requirement" name="requirement" placeholder="Requirement" autocomplete="off" value="<?php echo $this->_tpl_vars['Edit']['requirement']; ?>
" tabindex="24"  data-toggle="modal" data-target="#Requirement"  >
						</div> 
						</div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="branch" name="branch" placeholder="Branch" value="<?php echo $this->_tpl_vars['Edit']['branch']; ?>
" tabindex="10">
                      </div>
                    </div>
                      ...
                      <div class="col-sm-5">
                        <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks" value="" tabindex="26"><?php echo $this->_tpl_vars['Edit']['remarks']; ?>
</textarea>
                      </div>
                    </div>		
  ...
  <div class="modal fade" id="Requirement" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="width:750px;">
		...
		<div id="standard_bar"  style="width:600px;height:80px;border:solid 1px #cfcfcf;" align="left" value="<?php echo $this->_tpl_vars['ListView']['0']['requirement']; ?>
"></div>
