<?php /* Smarty version 2.6.25, created on 2017-11-30 18:14:49
         compiled from product_reg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'product_reg.tpl', 794, false),)), $this); ?>
                  ...
                  <div class="box-body">
				   <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_code" value="<?php echo $this->_supers['post']['item_code']; ?>
" name="item_code" tabindex="1" placeholder="Item Code" autocomplete="off" >
                      </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_category" value="<?php echo $this->_supers['post']['item_category']; ?>
" name="item_category" tabindex="3" placeholder="Item Category" autocomplete="off">
                      </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_description" value="<?php echo $this->_supers['post']['item_description']; ?>
" name="item_description" tabindex="5" placeholder="Item Description" autocomplete="off">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="consumer_basic" value="<?php echo $this->_supers['post']['consumer_basic']; ?>
" name="consumer_basic" tabindex="7" placeholder="Consumer Basic" autocomplete="off" onKeyUp="numericFilter(this);">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="features" value="<?php echo $this->_supers['post']['features']; ?>
" name="features" tabindex="9" placeholder="Features" autocomplete="off">
                      </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="dimensions" value="<?php echo $this->_supers['post']['dimensions']; ?>
" name="dimensions" tabindex="11" placeholder="dimensions" autocomplete="off">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total" value="<?php echo $this->_supers['post']['total']; ?>
" name="total" tabindex="13" placeholder="Total" autocomplete="off" onKeyUp="numericFilter(this);">
                      </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <textarea class="form-control" id="remarks" name="remarks" value="" placeholder="Remarks" tabindex="15" autocomplete="off"><?php echo $this->_tpl_vars['View']['remarks']; ?>
</textarea>
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954">&nbsp;</font>-->
                    </div>
					...
					<!--**********************************************************-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_name" name="item_name" value="<?php echo $this->_supers['post']['item_name']; ?>
" tabindex="2" placeholder="Item Name" autocomplete="off" onKeyUp="text_filter(this);">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_category_code" value="<?php echo $this->_supers['post']['item_category_code']; ?>
" tabindex="4" name="item_category_code" placeholder="Item category code" autocomplete="off">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_color" value="<?php echo $this->_supers['post']['item_color']; ?>
" name="item_color" tabindex="6" placeholder="Item Color" autocomplete="off">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954">&nbsp;</font>-->
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="baan_company" value="<?php echo $this->_supers['post']['baan_company']; ?>
" name="baan_company" tabindex="8" placeholder="Baan Company" autocomplete="off">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
...
" name="image" tabindex="10" autocomplete="off"  >
                      </div>
					<!-- &nbsp;&nbsp;<font class="error" color="#f56954">&nbsp;</font>-->
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pkg" name="pkg" value="<?php echo $this->_supers['post']['pkg']; ?>
" tabindex="12" placeholder="123" onKeyUp="numericFilter(this);">
					...
					<div class="form-group">
                     ...
                     <div class="col-sm-5">
                        <input type="text" class="form-control" id="price_date" name="price_date"  value="<?php echo $this->_supers['post']['price_date']; ?>
" placeholder="Date" tabindex="14" onClick="doOnLoad();"  readonly="true" autocomplete="off">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
             <input type="text" class="form-control" id="ed" value="<?php echo $this->_supers['post']['ed']; ?>
" name="ed" tabindex="16" placeholder="ED" autocomplete="off" onKeyUp="numericFilter(this);">
...
">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="wh" value="<?php echo $this->_supers['post']['wh']; ?>
" name="wh" tabindex="18" placeholder="Wh" autocomplete="off" >
						<input type="hidden" class="form-control" id="created_by"  name="created_by" value="<?php echo $this->_supers['session']['UserName']; ?>
" tabindex="18" readonly="true" autocomplete="off">
                      </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
                    </div>
