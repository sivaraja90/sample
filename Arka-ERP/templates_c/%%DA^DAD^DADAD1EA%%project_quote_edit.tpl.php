<?php /* Smarty version 2.6.25, created on 2016-08-05 18:51:43
         compiled from project_quote_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'project_quote_edit.tpl', 380, false),)), $this); ?>
...
function text_filter(data)
{
   data.value = data.value.replace(/[^ .a-z]/ig,"");
       ...
       function validate_fields()
		...
		var fields=["quote_date","payment","delivery","validity","product_description","total_material","material_tax_per","total_material_cost","total_labour","labour_tax_per","total_labour_cost"];
	...
	<td class="col-sm-3">
		...
		<tr class="form-group">	
				<th class="col-sm-2 control-th">Project Quote No </th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="project_quote_no" name="project_quote_no"  value="<?php echo $this->_supers['get']['project_quote_no']; ?>
" readonly="true"  tabindex="1" placeholder="Project Quote No">  	
						<input type="hidden" class="form-control" id="revised_version" name=" revised_version"  value="<?php echo $this->_supers['get']['revised_version']; ?>
" readonly="true" tabindex="1" placeholder="revised_version" autocomplete="Off">
						<input type="hidden" class="form-control" id="enquiry_id" name=" enquiry_id"  value="<?php echo $this->_tpl_vars['RevDetail']['0']['enquiry_id']; ?>
" readonly="true" tabindex="1" placeholder="enquiry_id" autocomplete="Off">
...
"/>
				...
				<th class="col-sm-2 control-th">Quote Date</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="<?php echo $this->_tpl_vars['LDList2']['0']['quote_date']; ?>
...
"   tabindex="19">
				...
				<form name="ProjectList" id="ProjectList" method="post">
                  <table id="example2" class="table table-bordered table-striped" style="font-size:13px; font-family:'Times New Roman', Times, serif;">
                    ...
                    <tbody>
                     <?php $_from = $this->_tpl_vars['Revise']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
','<?php echo $this->_tpl_vars['Contact']['revised_version']; ?>
','<?php echo $this->_tpl_vars['Contact']['total']; ?>
...
function deleteCat(CatIdent,CusIdent,Rive,Total,Sub){
  if(confirm("Are you sure to Delete this Content?")){

  FormName		= document.ProjectList;
  FormName.action= "project_quote_edit.php?sl_no="+CatIdent+"&project_quote_no="+CusIdent+"&revised_version="+Rive+"&total="+Total+"&sub_total="+Sub;
  FormName.submit();
 }
 }
    </script>
