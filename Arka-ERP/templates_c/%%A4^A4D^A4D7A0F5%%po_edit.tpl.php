<?php /* Smarty version 2.6.25, created on 2016-08-07 10:07:28
         compiled from po_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'po_edit.tpl', 934, false),)), $this); ?>
...
" readonly="true" >
					...
					<input type="hidden" id="hdn_salutation" name="hdn_salutation" value="<?php echo $this->_tpl_vars['POList']['salutaion']; ?>
">
					<input type="hidden" id="hdn_order_status" name="hdn_order_status" value="<?php echo $this->_tpl_vars['POList']['order_status']; ?>
">
					<input type="hidden" id="hdn_customer_status" name="hdn_customer_status" value="<?php echo $this->_tpl_vars['POList']['customer_status']; ?>
">
					<input type="hidden" id="hdn_customer_type" name="hdn_customer_type" value="<?php echo $this->_tpl_vars['POList']['customer_type']; ?>
">
    ...
    foreach ($_from as $this->_tpl_vars['POList']):
?>
                  <div class="box-body">
				   <div class="col-md-6">
                    <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="po_no" name="po_no" tabindex="1" value="<?php echo $this->_tpl_vars['POList']['po_no']; ?>
" placeholder="PO No" autocomplete="off">
                      </div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_company" name="supplier_company" placeholder="Supplier Company" value="<?php echo $this->_tpl_vars['POList']['supplier_company_name']; ?>
" tabindex="3"  onKeyUp="text_filter(this);" autocomplete="off">
					 ...
					 <div class="form-group">
					  ...
					  <div class="col-sm-5">
                        <input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="Contact Person" value="<?php echo $this->_tpl_vars['POList']['contact_person']; ?>
" tabindex="5"  onKeyUp="text_filter(this);" autocomplete="off">
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-5">
					   <select id="po_status" name="po_status" class="form-control" tabindex="7" value="<?php echo $this->_tpl_vars['POList']['po_status']; ?>
" >
						<option id"<?php echo $this->_tpl_vars['POList']['po_status']; ?>
" value="<?php echo $this->_tpl_vars['POList']['po_status']; ?>
" selected="selected"><?php echo $this->_tpl_vars['POList']['po_status']; ?>
</option>
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_ref_id" name="quote_ref_id" tabindex="9" value="<?php echo $this->_tpl_vars['POList']['quote_ref_id']; ?>
...
">
                      ...
                      <div class="col-sm-5">
						<select id="deliver_to" name="deliver_to"  class="form-control" tabindex="13" value="<?php echo $this->_tpl_vars['POList']['deliver_to']; ?>
" autocomplete="off" >
						<option id"<?php echo $this->_tpl_vars['POList']['deliver_to']; ?>
" value="<?php echo $this->_tpl_vars['POList']['deliver_to']; ?>
" selected="selected"><?php echo $this->_tpl_vars['POList']['deliver_to']; ?>
</option>
					...
					<div class="form-group" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No" value="<?php echo $this->_tpl_vars['POList']['supplier_mobile_no']; ?>
" maxlength="10" tabindex="15" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
					<!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					...
					<div class="form-group" id="hdn_mobile2" style="display:none;">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no1" name="mobile_no1" value="<?php echo $this->_tpl_vars['POList']['supplier_mobile_no1']; ?>
" maxlength="10" placeholder="Mobile No 2"  onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                     <input type="text" class="form-control" id="address" name="address" value="<?php echo $this->_tpl_vars['POList']['supplier_address']; ?>
" tabindex="17" placeholder="Address" autocomplete="off">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" tabindex="19" value="<?php echo $this->_tpl_vars['POList']['area']; ?>
" placeholder="Area" autocomplete="off" onKeyUp="text_filter(this);">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pincode" name="pincode" tabindex="21" value="<?php echo $this->_tpl_vars['POList']['pincode']; ?>
" placeholder="Pincode" autocomplete="off" maxlength="6">
					...
					<div class="form-group">
                      ...
                      <select id="item_type" name="item_type" class="form-control" tabindex="22" value="<?php echo $this->_supers['post']['item_type']; ?>
" >
...
" onKeyUp="getvalue();numericFilter(this);"  tabindex="28" placeholder="Item Tax Percentage" autocomplete="off" >
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_total_price" name="item_total_price" value="<?php echo $this->_supers['post']['item_total_price']; ?>
"   tabindex="30" placeholder="Item Total Price" autocomplete="off" readonly="true">
                      </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					...
					<!--**********************************************************-->
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="po_date" name="po_date"  placeholder="PO Date" tabindex="2" value="<?php echo $this->_tpl_vars['POList']['po_date']; ?>
" onClick="doOnLoad();"  readonly="true" autocomplete="off"/>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_code" name="supplier_code" tabindex="4" value="<?php echo $this->_tpl_vars['POList']['supplier_code']; ?>
" placeholder="Supplier Code" autocomplete="off">
					...
					<!--<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="company_name" name="company_name" tabindex="4" value="<?php echo $this->_tpl_vars['POList']['supplier_company_name']; ?>
"  placeholder="Supplier Company Name" autocomplete="off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>-->
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
					  <select id="payment_status" name="payment_status" class="form-control" tabindex="6" value="<?php echo $this->_tpl_vars['POList']['payment_status']; ?>
" >
						<option id"<?php echo $this->_tpl_vars['POList']['payment_status']; ?>
" value="<?php echo $this->_tpl_vars['POList']['payment_status']; ?>
" selected="selected"><?php echo $this->_tpl_vars['POList']['payment_status']; ?>
</option>
						<option value="0">----Select------</option>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Quote Date</label>
                       <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_date" name="quote_date"  placeholder="quote_date" tabindex="8" value="<?php echo $this->_tpl_vars['POList']['quote_date']; ?>
" onClick="doOnLoad();"  readonly="true" autocomplete="off"/>
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Phone No</label>
                       <div class="col-sm-2">
                        <input type="text" class="form-control" id="area_code" name="area_code" value="<?php echo $this->_tpl_vars['POList']['area_code']; ?>
" placeholder="Area Code" tabindex="10" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="<?php echo $this->_tpl_vars['POList']['phone_no']; ?>
" placeholder="Phone No" tabindex="11"onKeyUp="numericFilter(this);" autocomplete="off"  style="margin-left:-25px;">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="<?php echo $this->_tpl_vars['POList']['extension']; ?>
" placeholder="Extension" tabindex="12" onKeyUp="numericFilter(this);" autocomplete="off"  style="margin-left:-45px;">
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Supplier Mail Id</label>
                        <div class="col-sm-5">
                  <input type="email" class="form-control" id="supplier_mail" name="supplier_mail" placeholder="Supplier Mail Id" value="<?php echo $this->_tpl_vars['POList']['supplier_email']; ?>
" tabindex="14" onKeyUp="clear_err_email_id();" autocomplete="off" >
                      </div>
                      ...
                      <label class="col-sm-3 control-label">Supplier Mail Id</label>
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="supplier_mail1" name="supplier_mail1" placeholder="Supplier Mail Id" value="<?php echo $this->_tpl_vars['POList']['supplier_email1']; ?>
"  onKeyUp="clear_err_email_id();" autocomplete="off" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" tabindex="16" value="<?php echo $this->_tpl_vars['POList']['supplier_address1']; ?>
" placeholder="Address1" autocomplete="off">
                      </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="city" name="city" tabindex="18" value="<?php echo $this->_tpl_vars['POList']['city']; ?>
" placeholder="City" autocomplete="off" onKeyUp="text_filter(this);">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                  <input type="text" class="form-control" id="created_by" name="created_by" tabindex="20" value="<?php echo $this->_supers['session']['UserName']; ?>
" placeholder="Created By" autocomplete="off" readonly="true">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					...
					<!--<div class="form-group">
                      ...
                      <div class="col-sm-5">
                       <input type="text" class="form-control" id="item_name" name="item_name" value="<?php echo $this->_tpl_vars['POList']['item_name']; ?>
" tabindex="19" placeholder="Item Name" autocomplete="off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>-->
					 <div class="form-group">
...
" onChange="split_cnt_dtls2(this.value);"  tabindex="23" onKeyUp="text_filter(this);">
...
" onChange="split_cnt_dtls1(this.value);"  tabindex="23" onKeyUp="text_filter(this);" style="display:none">
...
" onKeyUp="getvalue();numericFilter(this);"  tabindex="27" placeholder="Item Price" autocomplete="off" >
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_tax_value" name="item_tax_value"  value="<?php echo $this->_supers['post']['item_tax_value']; ?>
"  tabindex="29" placeholder="Item Tax Value" autocomplete="off" readonly="true">
						<input type="hidden" class="form-control" id="item_sub" name="item_sub" tabindex="29" placeholder="Item Sub" value="<?php echo $this->_supers['post']['item_sub']; ?>
