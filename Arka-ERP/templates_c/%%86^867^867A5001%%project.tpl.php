...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'project.tpl', 413, false),)), $this); ?>
...
<tr class="form-group">
	<td class="col-sm-3">
		<tr class="form-group">	
				<th class="col-sm-2 control-th">Project Quote No </th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="project_quote_no" name="project_quote_no"  value="<?php echo $this->_tpl_vars['p_quote']; ?>
" readonly="true"  tabindex="1" placeholder="Project Quote No">  	
								
						<?php if ($this->_tpl_vars['Revise']['0']['revised_version'] == ""): ?>
						<input type="hidden" class="form-control" id="revised_version" name="revised_version" value="<?php echo $this->_tpl_vars['r_version']; ?>
"  >
						<?php elseif ($this->_tpl_vars['Revise']['0']['revised_version'] != ""): ?>
						<input type="hidden" class="form-control" id="revised_version" name="revised_version" value="<?php echo $this->_tpl_vars['Revise']['0']['revised_version']; ?>
"  >
						<?php endif; ?>	
						<?php if ($this->_tpl_vars['SelectList'] != ""): ?>
...
?>
									<input type="hidden" class="form-control" id="enquiry_id" name="enquiry_id"value="<?php echo $this->_tpl_vars['View']['enquiry_id']; ?>
" >
									<input type="hidden" class="form-control" id="customer_id" name="customer_id" value="<?php echo $this->_tpl_vars['View']['customer_id']; ?>
">
									<input type="hidden" class="form-control" id="mobile_no" name="mobile_no" value="<?php echo $this->_tpl_vars['View']['mobile_no']; ?>
">
									<input type="hidden" class="form-control" id="address" name="address" value="<?php echo $this->_tpl_vars['View']['address']; ?>
">
									<input type="hidden" class="form-control" id="address1" name="address1" value="<?php echo $this->_tpl_vars['View']['address1']; ?>
">
									<input type="hidden" class="form-control" id="city" name="city" value="<?php echo $this->_tpl_vars['View']['city']; ?>
">
									<input type="hidden" class="form-control" id="area_code" name="area_code" value="<?php echo $this->_tpl_vars['View']['area_code']; ?>
">
									<input type="hidden" class="form-control" id="phone_no" name="phone_no" value="<?php echo $this->_tpl_vars['View']['phone_no']; ?>
" >
									<input type="hidden" class="form-control" id="extension" name="extension" value="<?php echo $this->_tpl_vars['View']['extension']; ?>
">
									<input type="hidden" class="form-control" id="created_by" name="created_by" value="<?php echo $this->_tpl_vars['View']['created_by']; ?>
">
									<input type="hidden" class="form-control" id="company_name" name="company_name" value="<?php echo $this->_tpl_vars['View']['company_name']; ?>
">
									<input type="hidden" class="form-control" id="area" name="area" value="<?php echo $this->_tpl_vars['View']['area']; ?>
" >
									 <input type="hidden" class="form-control" id="pincode" name="pincode" maxlength="6" value="<?php echo $this->_tpl_vars['View']['pincode']; ?>
">
									 <input type="hidden" class="form-control" id="email" name="email" value="<?php echo $this->_tpl_vars['View']['email_id']; ?>
">
									 <input type="hidden" class="form-control" id="email1" name="email1" value="<?php echo $this->_tpl_vars['View']['email_id1']; ?>
" />
									 <input type="hidden" class="form-control" id="salutation" name="salutation" value="<?php echo $this->_tpl_vars['View']['salutation']; ?>
" />
									<input type="hidden" class="form-control" id="customer_name" name="customer_name" value="<?php echo $this->_tpl_vars['View']['customer_name']; ?>
"/>
...
<?php endif; ?>
				...
				<th class="col-sm-2 control-th">Quote Date</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="<?php echo $this->_tpl_vars['ServiceIn']['0']['quote_date']; ?>
" placeholder="Quote Date" onClick="doOnLoad();" tabindex="2" readonly="true">
			...
			<tr class="form-group" >
					<th class="col-sm-2 control-th">Payment</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" placeholder="ex :  50%" id="payment" name="payment" value="<?php echo $this->_tpl_vars['ProjectTerm']['0']['payment']; ?>
"  tabindex="3" autocomplete="Off">
						...
						<td class="col-sm-5">
						 <input type="text" class="form-control" placeholder="ex : 2 to 3 Weeks" id="delivery" name="delivery" value="<?php echo $this->_tpl_vars['ProjectTerm']['0']['delivery']; ?>
" tabindex="4" autocomplete="Off">
					...
					<tr class="form-group" >
						...
						<td class="col-sm-5">
					<select id="validity" name="validity" class="form-control" value="<?php echo $this->_tpl_vars['ProjectTerm']['0']['validity']; ?>
" tabindex="5" >
...
')"><?php echo $this->_tpl_vars['i']; ?>
								...
								<td align="center"><a href="#" onClick="Javascript:viewCats('<?php echo $this->_tpl_vars['Contact']['customer_id']; ?>
')"><?php echo $this->_tpl_vars['Contact']['product_description']; ?>
</a></td>
								<td align="center"><a href="#" onClick="Javascript:viewCats('<?php echo $this->_tpl_vars['Contact']['customer_id']; ?>
...
')"><?php echo $this->_tpl_vars['Contact']['total']; ?>
								 ...
								 <td class="center">&nbsp;&nbsp; &nbsp;&nbsp;<a href="#" onClick="Javascript:deleteCat('<?php echo $this->_tpl_vars['Contact']['sl_no']; ?>
','<?php echo $this->_supers['get']['project_quote_no']; ?>
...
function deleteCat(CatIdent,CusIdent,Rev,Enq,Total,Sub){
  ...
  FormName.action= "project.php?sl_no="+CatIdent+"&project_quote_no="+CusIdent+"&revised_version="+Rev+"&enquiry_id="+Enq+"&total="+Total+"&sub_total="+Sub;
  FormName.submit();
 }
 }
     </script>
