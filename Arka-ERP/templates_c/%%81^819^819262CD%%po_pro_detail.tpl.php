<?php /* Smarty version 2.6.25, created on 2016-08-07 10:44:17
         compiled from po_pro_detail.tpl */ ?>
...
?>
					...
					<tr class="form-group">			 
                      ...
                      <td class="col-sm-2">
                       <?php echo $this->_tpl_vars['Edit']['po_no']; ?>
					 ...
					 <tr class="form-group">			 
                      ...
                      <td class="col-sm-2">
                       <?php echo $this->_tpl_vars['Edit']['item_price']; ?>
					 ...
					 <tr class="form-group">			 
                      ...
                      <td class="col-sm-2">
                       <?php echo $this->_tpl_vars['Edit']['item_tax_per']; ?>

                   </td>
                        <th class="col-sm-4 control-th" style="font-weight:bold;">ITem % value</th>
                       <td class="col-sm-2">
                           <?php echo $this->_tpl_vars['Edit']['item_tax_value']; ?>
					 ...
					 <tr class="form-group">			 
                      ...
                      <td class="col-sm-2">
                       <?php echo $this->_tpl_vars['Edit']['item_sub']; ?>

                   </td>
                        <th class="col-sm-4 control-th" style="font-weight:bold;">Total</th>
                       <td class="col-sm-2">
                           <?php echo $this->_tpl_vars['Edit']['item_total_price']; ?>
