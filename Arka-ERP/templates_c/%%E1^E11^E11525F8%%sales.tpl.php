...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sales.tpl', 419, false),)), $this); ?>
...
" placeholder="Sales Quote No" readonly="true" tabindex="1"/>                  <?php if ($this->_tpl_vars['Revise']['0']['revised_version'] == ""): ?>
...
" >
						<input type="hidden" class="form-control" id="contact_name" name="contact_name"  value="<?php echo $this->_tpl_vars['Select']['customer_name']; ?>
">
...
">
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="payment" name="payment" placeholder="ex :  50%" autocomplete="off" value="<?php echo $this->_tpl_vars['SaleTerm']['0']['payment']; ?>
" tabindex="3"/>					
						</td>
						<td class="col-sm-5">
						</td>	
						<th class="col-sm-2 control-th">Delivery</th>
						<td class="col-sm-5"><input type="text" class="form-control" id="delivery" name="delivery"  placeholder="ex : 2 to 3 Weeks" autocomplete="off" value="<?php echo $this->_tpl_vars['SaleTerm']['0']['delivery']; ?>
" tabindex="4" />
						...
						<td class="col-sm-5">
					<select id="validity" name="validity" class="form-control" value="<?php echo $this->_tpl_vars['SaleTerm']['0']['validity']; ?>
" tabindex="5" >
