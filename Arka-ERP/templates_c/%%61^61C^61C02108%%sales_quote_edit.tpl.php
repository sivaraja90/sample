<?php /* Smarty version 2.6.25, created on 2016-04-08 16:40:22
         compiled from sales_quote_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sales_quote_edit.tpl', 714, false),)), $this); ?>
...
?>
				   ...
				   <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sales_quote_no" name="sales_quote_no" value="<?php echo $this->_tpl_vars['View']['sales_quote_no']; ?>
" placeholder="Sales Quote No" tabindex="1" autocomplete="off" readonly="true" autocomplete="off">
                      </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="revised_version" name="revised_version" value="<?php echo $this->_tpl_vars['View']['sales_quote_revise_no']; ?>
...
" placeholder="Enquiry Id" tabindex="5" autocomplete="off" >
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                   <input type="text" class="form-control" id="po_no" name="po_no" value="<?php echo $this->_tpl_vars['View']['po_no']; ?>
" placeholder="Po No" tabindex="5" autocomplete="off" >
                      </div>
					    <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
				<div class="form-group">
...
" placeholder="Pincode" tabindex="17" onBlur="chk_exist_pin(this)" maxlength="6" onKeyUp="numericFilter(this);" autocomplete="off" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="created_by" name="created_by" tabindex="25" placeholder="Created By" value="<?php echo $this->_tpl_vars['View']['created_by']; ?>
...
"  placeholder="Timestamp Value">
					...
					<!--**********************************************************-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sales_order_no" name="sales_order_no" value="<?php echo $this->_tpl_vars['View']['sales_order_no']; ?>
" placeholder="Sales Order No" tabindex="2" autocomplete="off" readonly="true">
                      </div>
					  <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					       </div>
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_date" name="quote_date" value="<?php echo $this->_tpl_vars['View']['sales_order_date']; ?>
" placeholder="Quote Date" tabindex="2" autocomplete="off" readonly="true">
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="customer_name" name="customer_name" value="<?php echo $this->_tpl_vars['View']['customer_name']; ?>
...
" tabindex="6" onKeyUp="text_filter(this);" autocomplete="off">
                  ...
                  <div class="col-sm-5">
						<input type="text" class="form-control" id="po_date" name="po_date" placeholder="Po Date" value="<?php echo $this->_tpl_vars['View']['po_date']; ?>
...
" placeholder="Unit Basic" tabindex="19" autocomplete="off" onKeyUp="getvalue();">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="vat_value" name="vat_value" value="<?php echo $this->_tpl_vars['View']['vat_value']; ?>
" placeholder="Vat Value"  onKeyUp="getvalue();numericFilter(this);" tabindex="21" autocomplete="off">
                      </div>
					    <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quantity" name="quantity" value="<?php echo $this->_tpl_vars['View']['quantity']; ?>
" placeholder="Quantity" tabindex="20" autocomplete="off" onKeyUp="getvalue();">
                      </div>
					    <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="vat_percentage" name="vat_percentage" value="<?php echo $this->_tpl_vars['View']['vat_per']; ?>
" placeholder="Vat Percentage" onKeyUp="getvalue();numericFilter(this);" tabindex="22" autocomplete="off">
                      </div>
					    <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					   </div>
					   <div class="form-group">
