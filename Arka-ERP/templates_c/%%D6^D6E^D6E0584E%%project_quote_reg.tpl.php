<?php /* Smarty version 2.6.25, created on 2016-04-19 18:27:18
         compiled from project_quote_reg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'project_quote_reg.tpl', 623, false),)), $this); ?>
...
" placeholder="Project Quote No" tabindex="1" readonly="true">
                      </div>
...
" placeholder="Mobile No" tabindex="5"onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
...
" placeholder="Email Id" tabindex="7" onKeyUp="clear_err_email_id();" >
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
...
" placeholder="Address" tabindex="11">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
				<div class="form-group">
...
" placeholder="Pincode" tabindex="15" onBlur="chk_exist_pin(this)" maxlength="6" onKeyUp="numericFilter(this);" >
...
" onKeyUp="getvalue();numericFilter(this);" placeholder="Sqft" tabindex="17">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group" >
...
" onKeyUp="getvalue();numericFilter(this);" placeholder="material_value" tabindex="19">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					 <div class="form-group">
...
" onKeyUp="getvalue();numericFilter(this);"  placeholder="Material Tax Percentage" tabindex="21">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					    <div class="form-group" >
...
" placeholder="Labour" tabindex="23">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					    <div class="form-group">
...
" placeholder="Labour Tax Value" onKeyUp="getvalue();numericFilter(this);" tabindex="25">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
...
" placeholder="Total Labour" tabindex="27">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
...
" placeholder="Quote Date" tabindex="4" readonly="true">
                      </div>
					   &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="enquiry_reff_id" name="enquiry_reff_id" value="<?php echo $this->_supers['post']['enquiry_reff_id']; ?>
" placeholder="Enquiry Reff Id" tabindex="6" >
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					  </div>
					 	 <div class="form-group">
...
" placeholder="Area Code" tabindex="8" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="<?php echo $this->_supers['post']['phone_no']; ?>
" placeholder="Phone No" tabindex="9"onKeyUp="numericFilter(this);" autocomplete="off" >
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="<?php echo $this->_supers['post']['extension']; ?>
" placeholder="Extension" tabindex="10" onKeyUp="numericFilter(this);" autocomplete="off" >
                       </div>
...
" placeholder="Address1" tabindex="12" >
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font> 
					  </div>
					  <div class="form-group">
...
" placeholder="Product Description" tabindex="16" >
                      </div> &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font></div>
					  <div class="form-group" >
...
" onKeyUp="getvalue();numericFilter(this);" placeholder="Material" tabindex="18">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					    <div class="form-group">
...
" onKeyUp="getvalue();numericFilter(this);" placeholder="Material Tax Value" tabindex="20">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					    <div class="form-group" >
...
"  placeholder="Total Material" tabindex="22">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
...
"  placeholder="Total Labour Value" tabindex="24">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					    <div class="form-group">
...
" placeholder="Labour Tax Percentage" onKeyUp="getvalue();numericFilter(this);" tabindex="25">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					 	  <div class="form-group">
...
" placeholder="Remarks" tabindex="29"></textarea>
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
