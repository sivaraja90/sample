<?php /* Smarty version 2.6.25, created on 2017-11-30 17:24:26
         compiled from quote_reg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'quote_reg.tpl', 763, false),)), $this); ?>
...
">
                  ...
                  <div class="box-body">
				   ...
				   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_id" name="quote_id" value="<?php echo $this->_tpl_vars['qo_id']; ?>
" placeholder="Quote Id" tabindex="1" readonly="true">
                      </div>
                    </div>
...
" placeholder="Quote Date" onClick="doOnLoad();" tabindex="3" readonly="ture" autocomplete="off">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_company_name" name="supplier_company_name" value="<?php echo $this->_supers['post']['supplier_company_name']; ?>
" placeholder="Supplier Company Name" tabindex="5" autocomplete="off" onKeyUp="text_filter(this);">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
								   	<select id="contact_person" name="contact_person" class="form-control" onChange="split_cnt_dtls(this.value);" tabindex="7" value="<?php echo $this->_supers['post']['contact_person']; ?>
">
...
" placeholder="Area Code" tabindex="9" onKeyUp="numericFilter(this);" autocomplete="off"  readonly="true">
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="<?php echo $this->_supers['post']['phone_no']; ?>
" placeholder="Phone No" tabindex="10"onKeyUp="numericFilter(this);" autocomplete="off"  readonly="true" style="margin-left:-25px;">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="<?php echo $this->_supers['post']['extension']; ?>
" placeholder="Extension" tabindex="11" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true" style="margin-left:-45px;">
                       </div>
					   </div>
...
" placeholder="Address" tabindex="13" autocomplete="off" readonly="true">
                      </div>
                    </div>
...
" placeholder="Area" tabindex="15" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
...
" placeholder="City" tabindex="17"   autocomplete="off" readonly="true">
                      </div></div>
...
<div class="form-group">
                      <label class="col-sm-3 control-label">Quote Id</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_id" name="quote_id" value="<?php echo $this->_tpl_vars['master_dtls']['quote_id']; ?>
" placeholder="Quote Id" tabindex="1" autocomplete="off" readonly="true">
                      </div>
                    </div>
					 ...
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Quote Date</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_date" name="quote_date" value="<?php echo $this->_tpl_vars['master_dtls']['quote_date']; ?>
" placeholder="Quote Date" onClick="doOnLoad();" tabindex="3" readonly="ture" autocomplete="off">
                      </div>
					  <a href="#"><img id="calendar_icon1" src="codebase/calendar.png"></a>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Suplier Company</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_company_name" name="supplier_company_name" value="<?php echo $this->_tpl_vars['master_dtls']['supplier_company_name']; ?>
" placeholder="Supplier Company Name" tabindex="5" autocomplete="off" onKeyUp="text_filter(this);">
                      </div>
                    </div>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Contact Person</label>
                      <div class="col-sm-5">
								   	<input type="text" id="contact_person" name="contact_person" class="form-control" onChange="split_cnt_dtls(this.value);" tabindex="7" value="<?php echo $this->_tpl_vars['master_dtls']['contact_fname']; ?>
" onKeyUp="text_filter(this);">
				...
				<div class="form-group">
					 <label class="col-sm-3 control-label">Phone No</label>
					    <div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" value="<?php echo $this->_tpl_vars['master_dtls']['area_code']; ?>
" placeholder="Area Code" tabindex="9" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true">
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="<?php echo $this->_tpl_vars['master_dtls']['phone_no']; ?>
" placeholder="Phone No" tabindex="10"onKeyUp="numericFilter(this);" autocomplete="off" readonly="true" style="margin-left:-25px;">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="<?php echo $this->_tpl_vars['master_dtls']['extension']; ?>
" placeholder="Extension" tabindex="11" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true" readonly="true" style="margin-left:-45px;">
                       </div>
					   </div>
					 <div class="form-group" style=" margin-top:0px;">
                      <label class="col-sm-3 control-label">Address</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address" name="address" value="<?php echo $this->_tpl_vars['master_dtls']['address']; ?>
" placeholder="Address" tabindex="13" autocomplete="off" readonly="true">
                      </div>
                    </div>
                      ...
                      <label class="col-sm-3 control-label">Area</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" value="<?php echo $this->_tpl_vars['master_dtls']['area']; ?>
" placeholder="Area" tabindex="15" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">City</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="city" name="city" value="<?php echo $this->_tpl_vars['master_dtls']['city']; ?>
" placeholder="City" tabindex="17"   autocomplete="off" readonly="true">
                      </div>  </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="created_by" name="created_by" value="<?php echo $this->_supers['session']['UserName']; ?>
"  readonly="true" tabindex="22" autocomplete="off">
						<input type="hidden" class="form-control" id="created_date" name="created_date" value="<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
" placeholder="Date" >
						<input type="hidden" class="form-control" id="created_time" name="created_time" value="<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%I:%M:%S %p') : smarty_modifier_date_format($_tmp, '%I:%M:%S %p')); ?>
"  placeholder="Time">
...
"  placeholder="Timestamp Value">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
						<select id="item_type" name="item_type" class="form-control" tabindex="19" onChange="Event();" autocomplete="off" value="<?php echo $this->_supers['post']['item_type']; ?>
">
...
" placeholder="Item Code" tabindex="21" autocomplete="off" readonly="true">
                      </div>
					   </div>
...
" placeholder="Item Specification" tabindex="23" autocomplete="off">
                      </div>
					   </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="enquiry_refference_id" name="enquiry_refference_id" value="<?php echo $this->_supers['post']['enquiry_refference_id']; ?>
" placeholder="Enquiry refference Id" tabindex="2" autocomplete="off">
                      </div>
                    </div>
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Quote Status</label>
                      <div class="col-sm-5">
						<select id="quote_status" name="quote_status" class="form-control" tabindex="4" autocomplete="off" value="<?php echo $this->_supers['post']['quote_status']; ?>
">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_code" name="supplier_code" value="<?php echo $this->_supers['post']['supplier_code']; ?>
" placeholder="Supplier Code" tabindex="6" autocomplete="off" readonly="true">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" maxlength="10" value="<?php echo $this->_supers['post']['mobile_no']; ?>
" placeholder="Mobile No" tabindex="8" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off" readonly="true">
                      </div>
					  </div>
					  	<div class="form-group">
...
" placeholder="Email Id" tabindex="12" onKeyUp="clear_err_email_id();" autocomplete="off" readonly="true">
                      </div>
					   </div>
...
" placeholder="Address1" tabindex="14" autocomplete="off" readonly="true">
                      </div>
					  </div>
						 <div class="form-group">
                      <label class="col-sm-3 control-label">Landmark</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="landmark" name="landmark" value="<?php echo $this->_supers['post']['landmarks']; ?>
" placeholder="LandMark" tabindex="16" autocomplete="off" readonly="true">
                      </div>
					   </div>
...
" placeholder="Pincode" tabindex="18" onBlur="chk_exist_pin(this)" maxlength="6" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true">
...
?>
                      ...
                      <label class="col-sm-3 control-label">Enquiry refer Id</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="enquiry_refference_id" name="enquiry_refference_id" value="<?php echo $this->_tpl_vars['master_dtls']['enquiry_reff_id']; ?>
" placeholder="Enquiry refference Id" tabindex="2" autocomplete="off">
                      </div>
                    </div>
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Quote Status</label>
                      <div class="col-sm-5">
						<select id="quote_status" name="quote_status" class="form-control" tabindex="4" autocomplete="off" value="<?php echo $this->_tpl_vars['master_dtls']['quote_status']; ?>
">
					  <option id"<?php echo $this->_tpl_vars['master_dtls']['quote_status']; ?>
" value="<?php echo $this->_tpl_vars['master_dtls']['quote_status']; ?>
" selected="selected"><?php echo $this->_tpl_vars['master_dtls']['quote_status']; ?>
</option>
					  <option value="" >----Select----</option>
					  <option value="Pending">Pending</option>
					  <option value="Quote Received">Quote Received</option>
                      ...
                      <label class="col-sm-3 control-label">Supplier Code</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_code" name="supplier_code" value="<?php echo $this->_tpl_vars['master_dtls']['supplier_code']; ?>
" placeholder="Supplier Code" tabindex="6" autocomplete="off" readonly="true">
                      </div>
                    </div>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Mobile No </label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" maxlength="10" value="<?php echo $this->_tpl_vars['master_dtls']['mobile_no']; ?>
" placeholder="Mobile No" tabindex="8" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off" readonly="true">
                      </div>
					  </div>
					  	<div class="form-group">
                      <label class="col-sm-3 control-label">Email Id</label>
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="email" name="email" value="<?php echo $this->_tpl_vars['master_dtls']['email_id']; ?>
" placeholder="Email Id" tabindex="12" onKeyUp="clear_err_email_id();" autocomplete="off" readonly="true">
                      </div>
					   </div>
                      ...
                      <label class="col-sm-3 control-label">Address1</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" value="<?php echo $this->_tpl_vars['master_dtls']['address1']; ?>
" placeholder="Address1" tabindex="14" autocomplete="off" readonly="true">
                      </div>
					  </div>
						 <div class="form-group">
                      <label class="col-sm-3 control-label">Landmark</label>
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="landmark" name="landmark" value="<?php echo $this->_tpl_vars['master_dtls']['landmark']; ?>
" placeholder="LandMark" tabindex="16" onKeyUp="clear_err_email_id();" autocomplete="off" readonly="true">
                      </div>
					   </div>
                      ...
                      <label class="col-sm-3 control-label">Pincode</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pincode" name="pincode" value="<?php echo $this->_tpl_vars['master_dtls']['pincode']; ?>
" placeholder="Pincode" tabindex="18" onBlur="chk_exist_pin(this)" maxlength="6" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true">
                      </div>  </div>
                      ...
                      <div class="col-sm-5">
                       <input type="text" class="form-control" id="product_desc" name="product_desc" placeholder="Product Desc" onClick="Check();" value="<?php echo $this->_supers['post']['product_desc']; ?>
" tabindex="20" onKeyUp="text_filter(this);">
						<input type="text" class="form-control" id="material_name" name="material_name" placeholder="Material Name" onClick="Check();" value="<?php echo $this->_supers['post']['material_name']; ?>
...
" placeholder="Item Quantity" tabindex="22" autocomplete="off" onKeyUp="numericFilter(this);">
                      </div> </div>
...
" placeholder="Remarks" tabindex="24" autocomplete="off"></textarea>
                      </div>
                    </div>
					</div>
					</div>
