<?php /* Smarty version 2.6.25, created on 2017-11-30 18:21:46
         compiled from cus_address_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'cus_address_edit.tpl', 231, false),)), $this); ?>
...
?>
				   <input type="hidden" id="sNo" name="sNo" value="<?php echo $this->_tpl_vars['Contact']['sl_no']; ?>
" />
...
"/>
					<tr class="form-group">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="customer_id" value="<?php echo $this->_tpl_vars['Contact']['customer_id']; ?>
" name="customer_id" tabindex="1" placeholder="Customer Id" readonly="true" >
                      </td>
...
" name="created_by" tabindex="2" placeholder="Created By" readonly="true">
                      </td>
					  <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					</tr> 
                     <tr class="form-group">
...
" placeholder="Area" tabindex="5" onKeyUp="text_filter(this);" >
					      </td>
					   <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
...
" placeholder="Land Mark" tabindex="6" >
                   </td>
					 <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					</tr> 
					   <tr class="form-group" >
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="city" name="city" tabindex="7" value="<?php echo $this->_tpl_vars['Contact']['city']; ?>
" placeholder="City" >
                      </td>
					  <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
...
" placeholder="Pincode" tabindex="8" maxlength="6" onKeyUp="numericFilter(this);" onBlur="chk_exist_pin(this);">
                      </td>
					  <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					  </tr>
					<tr class="form-group">
                      ...
                      <td class="col-sm-6">
                        <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks" tabindex="9"><?php echo $this->_tpl_vars['Contact']['remarks']; ?>
</textarea>
                      					  </td>
										  <td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
                    </tr>
