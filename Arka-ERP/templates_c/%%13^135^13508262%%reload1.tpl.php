<?php /* Smarty version 2.6.25, created on 2016-08-09 16:37:23
         compiled from reload1.tpl */ ?>
...
function doOnLoad() 
  ...
  var ser_ord_no = btoa(document.getElementById(\'service_order_no\').value);
...
if(page == \'Original\')
	{ 
  window.location ="service_order_print.php?enquiry_id="+enq_id+"&service_order_no="+ser_ord_no+"&revised_version="+rev_no;
  //location.target = "_blank";
	}
else if(page == \'Duplicate\')
   {
  window.location ="service_order_print1.php?enquiry_id="+enq_id+"&service_order_no="+ser_ord_no+"&revised_version="+rev_no; target="_blank";
   }
else if(page == \'Triplicate\')
   {
  window.location ="service_order_print2.php?enquiry_id="+enq_id+"&service_order_no="+ser_ord_no+"&revised_version="+rev_no; target="_blank";
  }
else if(page == \'Quadruplicate\')
  {
  window.location ="service_order_print3.php?enquiry_id="+enq_id+"&service_order_no="+ser_ord_no+"&revised_version="+rev_no; 
  }
}
