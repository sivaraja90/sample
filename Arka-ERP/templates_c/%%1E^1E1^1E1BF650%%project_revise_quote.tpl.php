<?php /* Smarty version 2.6.25, created on 2016-08-05 18:51:42
         compiled from project_revise_quote.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'project_revise_quote.tpl', 281, false),)), $this); ?>
...
" readonly="true"  tabindex="1" placeholder="Project Quote No">  </td>	
						<?php $_from = $this->_tpl_vars['ProjectQuote']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" readonly="true" tabindex="2">
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="<?php echo $this->_tpl_vars['reviseMaster']['quote_date']; ?>
