<?php /* Smarty version 2.6.25, created on 2017-01-07 16:09:49
         compiled from user_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'user_edit.tpl', 585, false),)), $this); ?>
...
?>
				   <div class="col-md-6">
						...
						<input type="hidden" class="form-control" id="area" name="area" value="<?php echo $this->_supers['post']['area']; ?>
...
"  placeholder="Emp Id" autocomplete="off">
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Company Name</label>
						<div class="col-sm-5">
						<select id="company_name" name="company_name" class="form-control" value="<?php echo $this->_tpl_vars['View']['company_name']; ?>
" tabindex="1">
						<?php if ($this->_tpl_vars['View']['company_name'] == 'Asian Engineering'): ?>
						...
						<?php elseif ($this->_tpl_vars['View']['company_name'] == 'Universal Infrastructure Systems'): ?>
								<option value="Asian Engineering">Asian Engineering</option>
								<option selected="selected">Universal Infrastructure Systems</option>
								<option value="Arka Automaations LTD">Arka Automaations LTD</option>
								<option value="Adroit Solutionz">Adroit Solutionz</option>
								<option value="Vinotronix Solutions">Vinotronix Solutions</option>
						<?php elseif ($this->_tpl_vars['View']['company_name'] == 'Arka Automaations LTD'): ?>
								...
								<option value="Adroit Solutionz">Adroit Solutionz</option>
								<option value="Vinotronix Solutions">Vinotronix Solutions</option>
						<?php elseif ($this->_tpl_vars['View']['company_name'] == 'Adroit Solutionz'): ?>
								<option value="Asian Engineering" selected="selected">Asian Engineering</option>
								<option value="Universal Infrastructure Systems">Universal Infrastructure Systems</option>
								<option value="Arka Automaations LTD">Arka Automaations LTD</option>
								<option selected="selected">Adroit Solutionz</option>
								<option value="Vinotronix Solutions">Vinotronix Solutions</option>
						<?php elseif ($this->_tpl_vars['View']['company_name'] == 'Vinotronix Solutions'): ?>
								<option value="Asian Engineering" selected="selected">Asian Engineering</option>
								<option value="Universal Infrastructure Systems">Universal Infrastructure Systems</option>
								<option value="Arka Automaations LTD">Arka Automaations LTD</option>
								<option value="Adroit Solutionz">Adroit Solutionz</option>
					...
					<div class="form-group">
					  ...
					  <select id="salutation" name="salutation" class="form-control" value="<?php echo $this->_tpl_vars['View']['salutation']; ?>
" tabindex="3" autocomplete="0ff" >
					  <option>Mr</option>
					  <option>Mrs</option>
					  <option>Miss</option>
					  </select>
					  ...
					  <div class="form-group">
					  <div class="col-sm-3">
                        <input type="text" class="form-control" id="contact_fname" name="contact_fname" tabindex="4" placeholder="First name" value= "<?php echo $this->_tpl_vars['View']['contact_fname']; ?>
" tabindex="4" style="margin-left:-25px; width:142px;" onKeyUp="text_filter(this)"  autocomplete="Off">
					</div>
					<div class="col-sm-3" >
					<input type="text" class="form-control" id="contact_lname" name="contact_lname" tabindex="5" placeholder="Last name" value="<?php echo $this->_tpl_vars['View']['contact_lname']; ?>
"  tabindex="5" style="margin-left:-8px;width:130px;" onKeyUp="text_filter(this)"  autocomplete="Off">
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-5">
                       <input type="text" class="form-control" id="designation" name="designation" value="<?php echo $this->_tpl_vars['View']['designation']; ?>
" tabindex="7" placeholder="Designation" autocomplete="off" onKeyUp="text_filter(this);">
                      </div>
                    </div>
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Mobile No</label>
                      <div class="col-sm-5">
						 <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="<?php echo $this->_tpl_vars['View']['mobile']; ?>
" maxlength="10"  tabindex="9" placeholder="Mobile No" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"   onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
                    </div>
...
" maxlength="10" placeholder="Mobile No 3" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mail_id" name="mail_id" value="<?php echo $this->_tpl_vars['View']['email_id']; ?>
" tabindex="11" placeholder="mail_id" autocomplete="off">
                      </div>
					   </div>
					  <div class="form-group" id="hdn_email2" style="display:none">
                      <label class="col-sm-3 control-label">Email Id 2</label>
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="mail_id1" name="mail_id1" placeholder="Email Id 1" value="<?php echo $this->_tpl_vars['View']['email_id1']; ?>
" autocomplete="off">
                      </div>
					  </div>
					<div class="form-group" >
                      ...
                      <div class="col-sm-5">
                        <input type="password" class="form-control" id="password" name="password" value="<?php echo $this->_tpl_vars['View']['password']; ?>
" tabindex="15" placeholder="Password" autocomplete="off">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="password" class="form-control" id="re_password" name="re_password" value="<?php echo $this->_tpl_vars['View']['re_password']; ?>
" tabindex="17" placeholder="Re Password" autocomplete="off">
                      </div>
                    </div>
					</div>
					<!--**********************************************************-->
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="user_name" name="user_name" value="<?php echo $this->_tpl_vars['View']['username']; ?>
" tabindex="2" placeholder="User Name" autocomplete="off" onKeyUp="text_filter(this);">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="company_code" name="company_code" value="<?php echo $this->_tpl_vars['View']['company_code']; ?>
" tabindex="4" autocomplete="off">
					 ...
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Sex </label>
						...
						<?php if ($this->_tpl_vars['View']['sex'] == 'Male'): ?>
						 <option value="<?php echo $this->_tpl_vars['View']['sex']; ?>
"  selected="selected"><?php echo $this->_tpl_vars['View']['sex']; ?>
</option>
						   <option value="Female">Female</option>
						   <?php elseif ($this->_tpl_vars['View']['sex'] == 'Female'): ?>
						   <option value="<?php echo $this->_tpl_vars['View']['sex']; ?>
"  selected="selected"><?php echo $this->_tpl_vars['View']['sex']; ?>
</option>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
						 <input type="text" class="form-control" id="department" name="department"  value="<?php echo $this->_tpl_vars['View']['department']; ?>
" tabindex="8" placeholder="Department" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Profile Image</label>
                      <div class="col-sm-5" id="allow" style="display:none;">
						 <input type="file" id="image" value="<?php echo $this->_tpl_vars['View']['image']; ?>
" name="image" tabindex="12" autocomplete="off"></div>
						 <div class="col-sm-5" id="allow1">
						 <input type="text" id="image1" value="<?php echo $this->_tpl_vars['View']['image']; ?>
" name="image1" tabindex="12" autocomplete="off" size="18" readonly="true">&nbsp;&nbsp;<div class="fa fa-pencil-square-o" id="" onClick="image_hide();"> </div>
                      </div>
                    </div>
					<div class="form-group">
...
" placeholder="Area Code" maxlength="6" tabindex="12" onKeyUp="numericFilter(this);" autocomplete="off">
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="<?php echo $this->_tpl_vars['View']['phone']; ?>
" placeholder="Phone No" maxlength="7" tabindex="13" onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-23px;">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="<?php echo $this->_tpl_vars['View']['extension']; ?>
" placeholder="Extension" maxlength="3" tabindex="14" onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-45px;">
                       </div>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="user_group" name="user_group" value="<?php echo $this->_tpl_vars['View']['user_group']; ?>
" tabindex="16" placeholder="User Group" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Remarks</label>
                      <div class="col-sm-5">
                        <textarea class="form-control" id="remarks" name="remarks"  tabindex="18" placeholder="Remarks" autocomplete="off"><?php echo $this->_tpl_vars['View']['remarks']; ?>
</textarea>
                      </div>
                    </div>
					 <div class="form-group">
                        <input type="hidden" class="form-control" id="created_by" name="created_by"  value="<?php echo $this->_tpl_vars['View']['created_by']; ?>
" tabindex="22" readonly="true" autocomplete="off">
...
" tabindex="22" placeholder="Timestamp Value">
					                      </div>
                    </div>
					</div>
