<?php /* Smarty version 2.6.25, created on 2016-07-30 15:30:15
         compiled from project_mail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'project_mail.tpl', 134, false),)), $this); ?>
...
<div id="MailPro">
<form name="MailAdd" id="MailAdd" method="post" enctype="multipart/form-data">
...
"  readonly="true" autocomplete="off">
			...
			<?php $_from = $this->_tpl_vars['EnqPromailview']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['prodMail']):
?>
				<tr class="taglist2">
				<td>&nbsp;</td>
				<?php if ($this->_tpl_vars['prodMail']['mail_id'] != ""): ?>
				<td ><input type="checkbox" name="check1" id="check1" onClick="dynInput(this);" value="<?php echo $this->_tpl_vars['prodMail']['mail_id']; ?>
" /><?php echo $this->_tpl_vars['prodMail']['mail_id']; ?>
</td>
				<?php endif; ?>
				<?php if ($this->_tpl_vars['prodMail']['mail_id1'] != ""): ?>
				<td><input type="checkbox" name="check2" id="check2" onClick="dynInput(this);" value="<?php echo $this->_tpl_vars['prodMail']['mail_id1']; ?>
" /><?php echo $this->_tpl_vars['prodMail']['mail_id1']; ?>
</td>
				<?php endif; ?>
				</tr>
