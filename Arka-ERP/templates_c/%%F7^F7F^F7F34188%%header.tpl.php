...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'header.tpl', 292, false),)), $this); ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="label label-success"><?php echo $this->_tpl_vars['ACnt']['0']['accept']; ?>
</span>
                </a>
				<?php if ($this->_tpl_vars['ACnt']['0']['accept'] != 0): ?>

                <ul class="dropdown-menu">
                  <li class="header">You have <?php echo $this->_tpl_vars['ACnt']['0']['accept']; ?>
 messages</li>
                  <li>
					...
					'; ?>
                  		...
                  		<?php $_from = $this->_tpl_vars['Accept']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['Select']):
?>
				  		<input type="hidden" id="enquiry_id" name="enquiry_id" value="<?php echo $this->_tpl_vars['Select']['enquiry_id']; ?>
" />
						<a href ="javascript:EnqId()">
                          <i class="fa fa-users text-aqua"></i><?php echo $this->_tpl_vars['Select']['assign_to']; ?>
(<?php echo $this->_tpl_vars['Select']['enquiry_id']; ?>
)
                        </a>
              ...
              <li class="dropdown notifications-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="label label-warning"><?php echo $this->_tpl_vars['PendingCnt']['0']['count']; ?>
</span>
                </a>
                <ul class="dropdown-menu">
                  <li class="header">You have <?php echo $this->_tpl_vars['PendingCnt']['0']['count']; ?>
 notifications</li>
                  <li>
                    <!-- inner menu: contains the actual data -->
                    <ul class="menu">
					...
					'; ?>
                  		...
                  		<?php $_from = $this->_tpl_vars['Enquiry']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['Select']):
?>
				  		<input type="hidden" id="enquiry_id" name="enquiry_id" value="<?php echo $this->_tpl_vars['Select']['enquiry_id']; ?>
" />
						<a href ="javascript:EnqId()">
					  	<i class="fa fa-users text-aqua"></i><?php echo $this->_tpl_vars['Select']['company_name']; ?>
(<?php echo $this->_tpl_vars['Select']['enquiry_id']; ?>
)
                        </a>
						<?php endforeach; endif; unset($_from); ?>
...
<!--              <li class="dropdown tasks-menu">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?php if ($this->_supers['session']['Image'] != ''): ?>
				   		<img src="images/user/<?php echo $this->_supers['session']['Image']; ?>
" class="user-image" alt="User Image">
				  <?php else: ?>
				  		<?php if ($this->_supers['session']['Sex'] == 'Male'): ?>
				   			<img src="images/avatar5.png" class="user-image" alt="User Image">
						<?php else: ?>
							<img src="images/avatar3.png" class="user-image" alt="User Image">
						<?php endif; ?>
				  <?php endif; ?>
                  <span class="hidden-xs"><?php echo $this->_supers['session']['UserName']; ?>
</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
...
" class="img-circle" alt="User Image">
				  ...
				  <?php endif; ?>
                    <p>
                     <?php echo $this->_supers['session']['UserName']; ?>
- <?php echo $this->_supers['session']['DESIGNATION']; ?>

                      <small>Member since <?php echo ((is_array($_tmp=$this->_supers['session']['CDate'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</small>
                    </p>
                  </li>
                  <!-- Menu Footer-->
