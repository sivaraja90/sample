<?php /* Smarty version 2.6.25, created on 2016-04-23 12:36:38
         compiled from salesfollow_view.tpl */ ?>
...
">
                    ...
                    <tbody>
                     <?php $_from = $this->_tpl_vars['ListDetail1']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
>        
					            <td align="center"><a href="#" onClick="Javascript:viewCats('<?php echo $this->_tpl_vars['Contact']['sales_order_no']; ?>
