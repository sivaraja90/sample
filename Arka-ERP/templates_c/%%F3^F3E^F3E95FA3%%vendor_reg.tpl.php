<?php /* Smarty version 2.6.25, created on 2017-11-28 15:56:03
         compiled from vendor_reg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'vendor_reg.tpl', 698, false),)), $this); ?>
                  ...
                  <div class="box-body">
				   <div class="col-md-6">
                    <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="vendor_id" name="vendor_id" value="<?php echo $this->_tpl_vars['c_id']; ?>
"tabindex="1" placeholder="Vendor Id" readonly="true">
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
					  <div class="col-sm-3">
                        <input type="text" class="form-control" id="vendor_fname" name="vendor_fname" value="<?php echo $this->_supers['post']['vendor_fname']; ?>
" placeholder="First name" tabindex="4" style="margin-left:-25px; width:150px;" onKeyUp="text_filter(this)" autocomplete="off">
					</div>
					<div class="col-sm-3">
						<input type="text" class="form-control" id="vendor_lname" name="vendor_lname" value="<?php echo $this->_supers['post']['vendor_lname']; ?>
" placeholder="Last name" tabindex="5" style="margin-left:-10px;width:130px;" onKeyUp="text_filter(this)" autocomplete="off">
                      </div>
                    </div>
					</div>
...
" placeholder="Mobile No" maxlength="10" tabindex="7" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
...
" tabindex="11" placeholder="Address" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Area</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" tabindex="13" value="<?php echo $this->_supers['post']['area']; ?>
"  placeholder="Area" autocomplete="off" onKeyUp="text_filter(this);">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pincode" name="pincode" maxlength="6" tabindex="15" value="<?php echo $this->_supers['post']['pincode']; ?>
" placeholder="Pincode" onKeyUp="numericFilter(this);" onBlur="chk_exist_pin(this);" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
...
" tabindex="17" placeholder="Designation" onKeyUp="text_filter(this)" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Email Id</label>
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="mail_id" name="mail_id" value="<?php echo $this->_supers['post']['mail_id']; ?>
" placeholder="Email Id" tabindex="19" onKeyUp="clear_err_email_id();" autocomplete="off" >
                      </div>
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="mail_id1" name="mail_id1" value="<?php echo $this->_supers['post']['mail_id1']; ?>
" placeholder="Email Id 1"  onKeyUp="clear_err_email_id();"  autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="service_tax" name="service_tax" value="<?php echo $this->_supers['post']['service_tax']; ?>
" tabindex="21" placeholder="Service Tax" autocomplete="off">
                      </div>
                    </div>
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Tin No</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="tin_no" name="tin_no" value="<?php echo $this->_supers['post']['tin_no']; ?>
" tabindex="23" placeholder="Tin No" autocomplete="off">
                      </div>
                    </div>
					</div>
					<!--**********************************************************-->
...
" tabindex="2"  placeholder="Vendor Company Name" autocomplete="off" onKeyUp="clear_err_name_of_cmp();text_filter(this);" onBlur="chk_exist_cmp(this);">
                      </div>
                    </div>
					<div class="form-group">
...
"  placeholder="Date" onClick="doOnLoad();" tabindex="6" readonly="true"  autocomplete="Off">
                      </div>
...
" placeholder="Area Code" tabindex="8" onKeyUp="numericFilter(this);" autocomplete="off" maxlength="6">
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="<?php echo $this->_supers['post']['phone_no']; ?>
" placeholder="Phone No" tabindex="9"onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-23px;" maxlength="10" >
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="<?php echo $this->_supers['post']['extension']; ?>
" placeholder="Extension" tabindex="10" onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-46px;" maxlength="4">
                       </div>
...
" placeholder="Area Code 1"  onKeyUp="numericFilter(this);" autocomplete="off" maxlength="6" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no1" name="phone_no1" value="<?php echo $this->_supers['post']['phone_no1']; ?>
" placeholder="Phone No 1"  onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-23px;" maxlength="10">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension1" name="extension1" value="<?php echo $this->_supers['post']['extension1']; ?>
" placeholder="extension 1"  onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-46px;" maxlength="4">
                       </div>
					   </div>
					<div class="form-group">
...
" tabindex="12" placeholder="Address1" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
...
" tabindex="14" placeholder="City" onKeyUp="text_filter(this)" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
...
" tabindex="16" placeholder="Landmark" autocomplete="off">
                      </div>
                    </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="created_by" name="created_by" readonly="true" value="<?php echo $this->_supers['session']['UserName']; ?>
...
" tabindex="22" placeholder="Timestamp Value">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="cst_no" name="cst_no" value="<?php echo $this->_supers['post']['cst_no']; ?>
" tabindex="20" placeholder="Cst No" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
...
" tabindex="22" placeholder="Remarks" autocomplete="off"></textarea>
                      </div>
