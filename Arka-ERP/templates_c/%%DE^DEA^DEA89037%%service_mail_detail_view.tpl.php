<?php /* Smarty version 2.6.25, created on 2016-07-28 15:18:54
         compiled from service_mail_detail_view.tpl */ ?>
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
								<?php $_from = $this->_tpl_vars['ServiceMail']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
&nbsp;&nbsp;<?php echo $this->_tpl_vars['View']['created_time']; ?>
									...
									<td>Modified:<?php echo $this->_tpl_vars['View']['timestamp_value']; ?>
</td>
									</tr>
									</table>
