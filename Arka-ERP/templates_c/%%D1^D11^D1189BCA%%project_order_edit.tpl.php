<?php /* Smarty version 2.6.25, created on 2016-04-05 16:56:29
         compiled from project_order_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'project_order_edit.tpl', 658, false),)), $this); ?>
...
?>
				   ...
				   <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="project_quote_no" name="project_quote_no" value="<?php echo $this->_tpl_vars['View']['project_quote_no']; ?>
" placeholder="Project Quote No" tabindex="1" autocomplete="off" readonly="true" autocomplete="off">
                      </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="revised_version" name="revised_version" value="<?php echo $this->_tpl_vars['View']['revised_version']; ?>
" placeholder="Revised Version"  tabindex="3" autocomplete="off" >
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
...
" placeholder="Customer Id" tabindex="5" autocomplete="off" >
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
...
" placeholder="Enquiry Id" tabindex="5" autocomplete="off" >
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" maxlength="10" value="<?php echo $this->_tpl_vars['View']['mobile_no']; ?>
" placeholder="Mobile No" tabindex="7"onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="email_id" name="email_id" value="<?php echo $this->_tpl_vars['View']['email_id']; ?>
" placeholder="Email Id" tabindex="9" onKeyUp="clear_err_email_id();" autocomplete="off" >
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="email_id1" name="email_id1" value="<?php echo $this->_tpl_vars['View']['email_id1']; ?>
" placeholder="Email Id 1"  onKeyUp="clear_err_email_id();" autocomplete="off" >
					...
					<div class="form-group" style=" margin-top:0px;">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address" name="address" value="<?php echo $this->_tpl_vars['View']['address1']; ?>
" placeholder="Address" tabindex="13" autocomplete="off">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" value="<?php echo $this->_tpl_vars['View']['address2']; ?>
" placeholder="Address1" tabindex="14" autocomplete="off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font> 
					  </div>
					  <div class="form-group">
...
" placeholder="Area" onKeyUp="text_filter(this);" tabindex="15" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					  <div class="form-group">
...
" placeholder="City" tabindex="16" autocomplete="off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font> 
					  </div>
					  <!--<div class="form-group">
...
" placeholder="Landmark" tabindex="16" autocomplete="off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font> 
					  </div>-->
...
" placeholder="Pincode" tabindex="17" onBlur="chk_exist_pin(this)" maxlength="6" onKeyUp="numericFilter(this);" autocomplete="off" >
...
" placeholder="material_tax_per" tabindex="17"  maxlength="6" onKeyUp="numericFilter(this);getvalue1();" autocomplete="off" >
						
						  <input type="hidden" class="form-control" id="material_tax_value" name="material_tax_value" value="<?php echo $this->_tpl_vars['View']['material_tax_value']; ?>
" placeholder="material_tax_value" tabindex="17"  maxlength="6" onKeyUp="numericFilter(this);" autocomplete="off" >
                      </div>  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font></div>
					 <div class="form-group">
...
" placeholder="labour_tax_per" tabindex="17"  maxlength="6" onKeyUp="numericFilter(this);getvalue2();" autocomplete="off" >
						<input type="hidden" class="form-control" id="labour_tax_value" name="labour_tax_value" value="<?php echo $this->_tpl_vars['View']['labour_tax_value']; ?>
" placeholder="labour_tax_value" tabindex="17"  maxlength="6" onKeyUp="numericFilter(this);" autocomplete="off" >
                      </div>  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font></div>
					  
					  <div class="form-group">
                      <label class="col-sm-3 control-label">Created By</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="created_by" name="created_by" tabindex="25" placeholder="Created By" value="<?php echo $this->_supers['session']['UserName']; ?>
...
"  placeholder="Timestamp Value">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <textarea class="form-control" id="remarks" name="remarks"  placeholder="Remarks" tabindex="26" autocomplete="off"><?php echo $this->_tpl_vars['View']['remark']; ?>
</textarea>
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					...
					<!--**********************************************************-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="project_order_no" name="project_order_no" value="<?php echo $this->_tpl_vars['View']['project_order_no']; ?>
" placeholder="Project Order No" tabindex="2" autocomplete="off" readonly="true">
                      </div>
					   &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					       </div>
...
" placeholder="Quote Date" tabindex="2" autocomplete="off" readonly="true">
                      </div>
					   &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
...
" placeholder="Customer Name" tabindex="4" autocomplete="off" >
                  ...
                  <div class="col-sm-5">
						<input type="text" class="form-control" id="contact_name" name="contact_name" placeholder="Contact Name" value="<?php echo $this->_tpl_vars['View']['contact_person']; ?>
" tabindex="6" onKeyUp="text_filter(this);" autocomplete="off">
                      </div>
                  ...
                  <div class="col-sm-5">
						<input type="text" class="form-control" id="project_order_date" name="project_order_date" placeholder="Po Date" value="<?php echo $this->_tpl_vars['View']['project_order_date']; ?>
" tabindex="6" autocomplete="off" readonly="true">
                      </div>
  					  <!--<input type="button" class="btn btn-danger btn-xs" value="ADD Contact" data-toggle="modal" data-target="#Contact">-->
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
...
" placeholder="Phone No" tabindex="11"onKeyUp="numericFilter(this);" autocomplete="off">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="<?php echo $this->_tpl_vars['View']['extension']; ?>
" placeholder="Extension" tabindex="12" onKeyUp="numericFilter(this);" autocomplete="off" >
                       </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					 ...
					 <!-- <div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code1" name="area_code1" value="<?php echo $this->_tpl_vars['View']['area_code1']; ?>
...
" placeholder="Phone No 1" onKeyUp="numericFilter(this);" >
                      ...
                      <!--<div class="col-sm-2">
                        <input type="text" class="form-control" id="extension1" name="extension1" value="<?php echo $this->_tpl_vars['View']['extension1']; ?>
" placeholder="extension 1" onKeyUp="numericFilter(this);" autocomplete="off" >
					 ...
					 <!-- <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <!--<input type="text" class="form-control" id="product_description" name="product_description" value="<?php echo $this->_tpl_vars['View']['item_description']; ?>
" placeholder="Product Description" tabindex="18" autocomplete="off" >-->
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="product_description" name="product_description" value="<?php echo $this->_tpl_vars['View']['item_description']; ?>
" placeholder="Product Description" tabindex="18" autocomplete="off" >
						<!--<input type="text" class="form-control" id="product_desc" name="product_desc" placeholder="Product Desc" value="<?php echo $this->_tpl_vars['View']['item_description']; ?>
" onChange="split_cnt_dtls(this.value);"  tabindex="4" onKeyUp="text_filter(this);">
						
						<input type="text" class="form-control" id="material_name" name="material_name" placeholder="Material Name" value="<?php echo $this->_tpl_vars['View']['item_description']; ?>
" onChange="split_cnt_dtls1(this.value);"  tabindex="4" onKeyUp="text_filter(this);" style="display:none">
                      </div> &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					  </div>-->
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="item_code" name="item_code" value="<?php echo $this->_tpl_vars['View']['item_code']; ?>
" placeholder="Item Code" tabindex="19" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   -->
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="unit_basic" name="unit_basic" value="<?php echo $this->_tpl_vars['View']['unit_basic']; ?>
" placeholder="Unit Basic" tabindex="19" autocomplete="off" onKeyUp="getvalue();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>-->
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="tax_value" name="tax_value" value="<?php echo $this->_tpl_vars['View']['tax_value']; ?>
" placeholder="Tax Value"  onKeyUp="numericFilter(this);" tabindex="21" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
...
" placeholder="Description" tabindex="20" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					  <div class="form-group">
...
" placeholder="Sqft" tabindex="20" autocomplete="off" onKeyUp="getvalue();getvalue3();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
...
" placeholder="Material" tabindex="20" autocomplete="off" onKeyUp="getvalue();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
...
" placeholder="Labour" tabindex="20" autocomplete="off" onKeyUp="getvalue();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
...
" placeholder="Total Material" tabindex="20" autocomplete="off" onKeyUp="getvalue();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
...
" placeholder="Total Labour" tabindex="20" autocomplete="off" onKeyUp="getvalue();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sub_total" name="sub_total" value="<?php echo $this->_tpl_vars['View']['sub_total']; ?>
" placeholder="Sub Total" tabindex="23" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					  </div>
...
" placeholder="Total" tabindex="24" autocomplete="off">
                      </div> &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					  </div>
