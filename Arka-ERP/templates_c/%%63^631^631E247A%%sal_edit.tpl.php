<?php /* Smarty version 2.6.25, created on 2016-04-22 18:26:54
         compiled from sal_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sal_edit.tpl', 618, false),)), $this); ?>
...
" />
				   <input type="hidden" id="c_name" name="c_name" value="<?php echo $this->_tpl_vars['Contact']['customer_id']; ?>
"/>
					<tr class="form-group">
                      <th class="col-sm-4 control-th">Sales Order No</th>
                      <td class="col-sm-2">
					   <input type="text" class="form-control" id="sales_order_no" name="sales_order_no" placeholder="Sales Order No" value="<?php echo $this->_supers['get']['sales_order_no']; ?>
" maxlength="10" tabindex="7" style="width:150;" >
					  
					  </td>
					  <th class="col-sm-4 control-th">Sales Quote No</th>
                      <td class="col-sm-2">
					   <input type="text" class="form-control" id="sales_quote_no" name="sales_quote_no" placeholder="Sales Quote No" value="<?php echo $this->_tpl_vars['Contact']['sales_quote_no']; ?>
" maxlength="10" tabindex="7" style="width:150;" >
					   </td>
					   </tr>
					  <tr class="form-group">
...
" readonly="true">
					...
					<th class="col-sm-4 control-th" >Closed Time</th>
						<td class="col-sm-2">
						<input type="text" class="form-control" id="closed_hours" name="closed_hours"  placeholder="Hours"   value="<?php echo $this->_tpl_vars['Contact']['closed_hours']; ?>
" onKeyUp="HourFilter(this);" style="width:68px;" autocomplete="OFF" >
						 </td>
						 <td class="col-sm-2" >
