<?php /* Smarty version 2.6.25, created on 2016-07-02 16:40:39
         compiled from service_invoice.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'service_invoice.tpl', 196, false),)), $this); ?>
...
" placeholder="Invoice Number" tabindex="1" autocomplete="off" readonly="true">
				...
				<th class="col-sm-2 control-th">Service Order Number</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="service_order_no" name="service_order_no" value="<?php echo $this->_supers['get']['service_order_no']; ?>
