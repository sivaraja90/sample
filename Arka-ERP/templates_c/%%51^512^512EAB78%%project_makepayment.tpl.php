<?php /* Smarty version 2.6.25, created on 2016-07-08 16:26:31
         compiled from project_makepayment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'project_makepayment.tpl', 414, false),)), $this); ?>
...
">	
				<input type="hidden" id="quote_date" name="quote_date" value="<?php echo $this->_tpl_vars['View']['quote_date']; ?>
">
...
">
						<input type="hidden"  id="revise_version" name="revise_version" value="<?php echo $this->_tpl_vars['View']['revise_version']; ?>
" >
...
" ><?php echo $this->_tpl_vars['No']['invoice_no']; ?>
				...
				<th class="col-sm-2 control-th" >Invoice Amount</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="invoice_amount" name="invoice_amount" placeholder="Invoice Amount" tabindex="2" value="<?php echo $this->_supers['post']['invoice_amount']; ?>
" readonly="true">
						</td>
						<?php $_from = $this->_tpl_vars['invoice1']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['No']):
?>
						<input type="hidden" id="calculation" value="<?php echo $this->_tpl_vars['No']['invoice_amount']; ?>
">
						<?php endforeach; endif; unset($_from); ?> 
...
" tabindex="4" onKeyUp="calc();status_change();numericFilter(this);" autocomplete="Off">
						 </td>
		  </tr>
...
" tabindex="6" onChange="payment_modechange();">
						<option>----Select-----</option>
