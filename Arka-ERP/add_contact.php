<?php
  require('includes/common.php');
	...
	include_once $config['SiteClassPath']."class.Addcontact.php";
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	$ObjAddcontact	= new AddcontactReg();
//	$ObjDashboard->RolesLists();
// $ObjDashboard->myCurl($objArray);

  $objSmarty->assign('IncludeTpl', 'add_contact.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Add Contact');
