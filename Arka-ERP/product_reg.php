<?php
  require('includes/common.php');
	...
	{
	$ObjProductReg->InsertProduct($_POST,$_FILES);
	}
	if(isset($_GET['succs_msg_for_insert']))
         {
          $objSmarty->assign('SuccessMessage', 'New Product Added Successfully');
         }
		 $ObjProductReg->ItemCode($_POST,$_FILES);

//	$ObjDashboard->RolesLists();
	// $ObjDashboard->myCurl($objArray);

  $objSmarty->assign('IncludeTpl', 'product_reg.tpl');
