...
<?php
  require('includes/common.php');
	...
	{
	$ObjProjectOrder->InsertProjectInvoice($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
         {
          $objSmarty->assign('SuccessMessage', 'New Invoice Added Successfully');
         } 

  $objSmarty->assign('IncludeTpl', 'project_invoice.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- GenerateInvoice');
