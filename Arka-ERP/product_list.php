<?php
  require('includes/common.php');
	...
	$ObjProductReg->ListProduct();
	$objStaff->RolesLists($objArray);

if(isset($_GET['item_code']))
{
	$ObjProductReg->DeleteProduct($_GET['item_code']);
}
if(isset($_GET['succs_msg_for_del']))
{
	$objSmarty->assign('SuccessMessage', 'Product Deleted Successfully');
} 
	$objSmarty->assign('IncludeTpl', 'product_list.tpl');
	$objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Product List');
