<?php
  require('includes/common.php');
	...
	if(isset($_GET['slno']) && ($_GET['enquiry_id']))
	{ 
  	$ObjMailMgmt-> DeleteMail();
	}
	$ObjMailMgmt->SerDetailMail();
  $objSmarty->assign('IncludeTpl', 'service_mail_detail.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Enquiry Mail');
