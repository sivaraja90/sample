<?php
  require('includes/common.php');
	...
	$objStaff->RolesLists();
	$ObjUsergroupReg->ListGroup($objArray);
	if(isset($_GET['group_id']))
	{
			$ObjUsergroupReg->DeleteMaster($_GET['group_id']);
	}
	if(isset($_GET['succs_msg_for_del']))
         {
		           $objSmarty->assign('SuccessMessage', 'User Group Deleted Successfully');
         } 
	
  $objSmarty->assign('IncludeTpl', 'user_group_list.tpl');
