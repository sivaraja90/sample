...
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	{
		$objFollowUpReg->EditFollowUp($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
	{
		$objSmarty->assign('SuccessMessage', 'FollowUp Updated Successfully');
	}
	if(isset($_GET['sl_no']))
	{
	
		$objFollowUpReg->EditContact($_GET['sl_no']);
	}
	$objFollowUpReg->ViewEnquirymaster1($objArray);

  $objSmarty->assign('IncludeTpl', 'cus_edit.tpl');
