<?php
  require('includes/common.php');
	...
	include_once $config['SiteClassPath']."class.UserroleReg.php";
	...
	$ObjUserroleReg= new UserroleReg();
	$ObjUserroleReg->ListRole();
	if(isset($_GET['role_id']))
	{
		$ObjUserroleReg->DeleteMaster($_GET['role_id']);
	}
	if(isset($_GET['succs_msg_for_del']))
         {
          $objSmarty->assign('SuccessMessage', 'Role Deleted Successfully');
         } 

  $objSmarty->assign('IncludeTpl', 'user_role_list.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- UserRoleList');
