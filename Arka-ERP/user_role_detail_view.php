<?php
  require('includes/common.php');
	...
	{
	$ObjUserroleReg->ListMaster($_GET['role_id']);
	}
	$ObjUserroleReg->DateStamp();
	$ObjUserroleReg->TimeStamp();
  $objSmarty->assign('IncludeTpl', 'user_role_detail_view.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- UserroleReg');
