<?php
  require('includes/common.php');
	...
	$ObjQuoteReg->GetQuoteView($objArray);
if(isset($_POST['hdAction']))
	{
	$ObjQuoteReg->InsertQuote($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
         {
          $objSmarty->assign('SuccessMessage', 'New Quote Added Successfully');
         } 
		 
  $objSmarty->assign('IncludeTpl', 'quote_reg.tpl');
