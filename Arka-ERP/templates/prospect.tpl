      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		 ...
		 {/if}
                  <div class="box-body">
				   <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="prospect_id" name="prospect_id" value="{$p_id}" placeholder="Prospect Id" readonly="true"  autocomplete="off" tabindex="1">
                      </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="contact_person" name="contact_person" value="{$smarty.post.contact_person}" placeholder="Contact Person" tabindex="8" onKeyUp="text_filter(this);" autocomplete="off">
					...
					<p id="error_cmp_name" align="center" style="color: #FF0000;"></p>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="cmpny_name" name="cmpny_name" value="{$smarty.post.company_name}" placeholder="Company Name" tabindex="2" autocomplete="off" onKeyUp="clear_err_name_of_cmp();text_filter(this);" onBlur="chk_exist_cmp(this);">
                      </div>
					  <font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Contact No" maxlength="10" value="{$smarty.post.mobile_no}" tabindex="11" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
					  </div>
				...
				<div class="col-sm-5">
				<input type="email" class="form-control" id="mail_id" name="mail_id" placeholder="Email Id" onKeyup="validateForm();" value="{$smarty.post.mail_id}"  >
