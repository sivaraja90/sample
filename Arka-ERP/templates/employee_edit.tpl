...
-->			       {if $SuccessMessage neq ""}
				...
				{/if}
				   ...
				   <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="emp_id" name="emp_id" value="{$EditList.emp_id}" tabindex="1" placeholder="Employee Id" autocomplete="off">
                      </div>
                    </div>
					 <div class="form-group">
					  ...
					  <div class="form-group">
					  <div class="col-sm-3">
                        <input type="text" class="form-control" id="emp_first_name" name="emp_first_name" placeholder="First name" value="{$EditList.emp_first_name}" tabindex="4" style="margin-left:-25px; width:142px;" onKeyUp="text_filter(this)" autocomplete="off">
					</div>
					<div class="col-sm-3">
						<input type="text" class="form-control" id="emp_last_name" name="emp_last_name" placeholder="Last name" value="{$EditList.emp_last_name}" tabindex="5" style="width:130px;margin-left:-8px;" onKeyUp="text_filter(this)" autocomplete="off">
                      </div>
                    </div>
					</div>
				<div class="form-group" style=" margin-top:-15px;">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="father_name" name="father_name" value="{$EditList.father_name}" tabindex="7" placeholder="Father Name" onKeyUp="text_filter(this)" autocomplete="off">
                      </div>
                    </div>
					  <div class="form-group">
                      <label class="col-sm-3 control-label">DOB</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="d_o_b" name="d_o_b" value="{$EditList.d_o_b}" placeholder="Date" tabindex="9"   readonly="true" autocomplete="off" >
                      </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile" name="mobile" value="{$EditList.mobile}" placeholder="Mobile No" maxlength="10" tabindex="11" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Qualification</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="qualification" name="qualification" value="{$EditList.qualification}" tabindex="13" placeholder="Qualification" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Department</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="department" name="department" value="{$EditList.department}" tabindex="17" placeholder="Department" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Joining Date</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="joining_date" name="joining_date" value="{$EditList.joining_date}" tabindex="19" placeholder="Date" readonly="true" autocomplete="off">
                      </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" value="{$EditList.address1}" tabindex="21" placeholder="Address1" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Area</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" value="{$EditList.area}" tabindex="23" placeholder="Area" onKeyUp="text_filter(this)" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Personal Mail</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="personal_mail" name="personal_mail" value="{$EditList.personal_mail}" tabindex="25" placeholder="Personal Mail" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">No of year Exper</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="no_of_year_exp" name="no_of_year_exp" value="{$EditList.no_of_year_exp}" tabindex="27" placeholder="Experience" autocomplete="off">
                      </div>
                    </div>
					...
					<!--<div class="form-group">
                      ...
                      <div class="col-sm-5" >
                      <textarea class="form-control" id="remarks" name="remarks" tabindex="29" placeholder="remarks" value="" autocomplete="off" >{$EditList.remarks}</textarea>
                      </div>
                    </div>-->
					</div>
					<!--**********************************************************-->
					 ...
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Company Name</label>
						<div class="col-sm-5">
						<select id="company_name" name="company_name" class="form-control" value="{$EditList.comapany_name}" tabindex="2">
						{if $EditList.company_name eq "Asian Engineering"}
						...
						{elseif $EditList.company_name eq "Arka Automaations LTD"}
								...
								<option value="Adroit Solutionz">Adroit Solutionz</option>
								<option value="Vinotronix Solutions">Vinotronix Solutions</option>
						{elseif $EditList.company_name eq "Adroit Solutionz"}
								<option value="Asian Engineering" selected="selected">Asian Engineering</option>
								<option value="Universal Infrastructure Systems">Universal Infrastructure Systems</option>
								<option value="Arka Automaations LTD">Arka Automaations LTD</option>
								<option selected="selected">Adroit Solutionz</option>
								<option value="Vinotronix Solutions">Vinotronix Solutions</option>
						{elseif $EditList.company_name eq "Vinotronix Solutions"}
								<option value="Asian Engineering" selected="selected">Asian Engineering</option>
								<option value="Universal Infrastructure Systems">Universal Infrastructure Systems</option>
								<option value="Arka Automaations LTD">Arka Automaations LTD</option>
								<option value="Adroit Solutionz">Adroit Solutionz</option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="company_code"  name="company_code" value="{$EditList.company_code}" tabindex="6" placeholder="Company Code" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Mother Name</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mother_name" name="mother_name" value="{$EditList.mother_name}" tabindex="8" placeholder="Mother Name" onKeyUp="text_filter(this)" autocomplete="off">
                      </div>
                    </div>
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Sex </label>
						<div class="col-sm-5">
						  <select id="sex" name="sex" class="form-control" tabindex="10" value="{$EditList.sex}" >
						<option id"{$EditList.sex}" value="{$EditList.sex}" selected="selected">{$EditList.sex}</option>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5" id="allow" style="display:none;">
						 <input type="file" id="image1" value="{$EditList.image}" name="image1" tabindex="12" autocomplete="off"></div>
						 <div class="col-sm-5" id="allow1">
						 <input type="text" id="image" value="{$EditList.image}" name="image" tabindex="12" autocomplete="off" size="18" readonly="true">&nbsp;&nbsp;<div class="fa fa-pencil-square-o" id="" onClick="image_hide();"> </div>
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Phone No</label>
					    <div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" value="{$EditList.area_code}" placeholder="Area Code" maxlength="6" tabindex="14" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone1" name="phone1" value="{$EditList.phone1}" placeholder="Phone No" maxlength="10" tabindex="15"onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-23px;">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="{$EditList.extension}" placeholder="Extension" maxlength="4" tabindex="16" onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-45px;">
                       </div>
					   </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Designation</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="designation" name="designation" value="{$EditList.designation}" tabindex="18" placeholder="Designation" autocomplete="off"   >
                      </div>
                    </div>
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Residence Mobile</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="residence_mobile" name="residence_mobile" maxlength="10" value="{$EditList.residence_mobile}" tabindex="20" placeholder="Residence Mibile"  onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                       <input type="text" class="form-control" id="address2" name="address2" value="{$EditList.address2}"  tabindex="22" placeholder="Address2" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Pincode</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pincode" name="pincode" maxlength="6" value="{$EditList.pincode}" tabindex="24" placeholder="Pincode" onKeyUp="numericFilter(this);" onBlur="chk_exist_pin(this);" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Company Mail</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="company_mail" name="company_mail" value="{$EditList.company_mail}" tabindex="26" placeholder="Company Mail" onKeyUp="clear_err_email_id();" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Created By</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="created_by" name="created_by" value="{$EditList.created_by}" tabindex="28" readonly="true">
						<input type="hidden" class="form-control" id="created_time" name="created_time"  placeholder="Time" Value="{$EditList.created_time}">
						<input type="hidden" class="form-control" id="created_date" name="created_date"  placeholder="Date" value="{$EditList.created_date}" >
                      </div>
                    </div>
					</div>
					</div>
