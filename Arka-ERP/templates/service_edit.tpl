	...
	<td class="col-sm-3">
		...
		<tr class="form-group">	
				<th class="col-sm-2 control-th">Service Quote No </th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="service_quote_no" name="service_quote_no"  value="{$smarty.get.service_quote_no}" readonly="true"  tabindex="1" placeholder="Service Quote No">  	
				...
				<th class="col-sm-2 control-th">Quote Date</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="{$LDList2.0.service_quote_date}" placeholder="Quote Date" onClick="doOnLoad();" tabindex="2" readonly="true">
						</td>
						<td class="col-sm-5">
				...
				<form name="ServiceList" id="ServiceList" method="post">
                  <table id="example2" class="table table-bordered table-striped" style="font-size:13px; font-family:'Times New Roman', Times, serif;">
					...
					<tr id="{$i++}">  
							...
							<td class="center">&nbsp;&nbsp; &nbsp;&nbsp;<a href="#" onClick="Javascript:deleteCat('{$Contact.sl_no}','{$smarty.get.service_quote_no}','{$Contact.revised_version}','{$Contact.total}','{$Contact.sub_total}')"><i class="fa fa-trash"></i></a></td>	 
