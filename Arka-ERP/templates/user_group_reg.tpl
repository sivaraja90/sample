                  ...
                  <div class="box-body ">
				   <div class="col-md-6">
                    <div class="form-group">			 
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="group_id" name="group_id" value="{$g_id}" readonly="true" tabindex="1" placeholder="Group Id" readonly="true">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="group_name" name="group_name" tabindex="2" value="{$smarty.post.group_name}" placeholder="Group Name" autocomplete="Off" onKeyUp="textFilter(this);">
                      </div>
                    </div>
					 <div class="form-group">			 
                      <label class="col-sm-4 control-label">Description</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="description" name="description" tabindex="3" value="{$smarty.post.description}" placeholder="Desription" autocomplete="Off" onKeyUp="textFilter(this);">
                      </div>
                    </div>
				  </div>
				  <div class="form-group">
					...
					<select class="form-control input-lg" multiple="multiple" name="exam16[]" id="exam16" size="15" value="{$exam16}" autocomplete="Off" tabindex="4">
													{foreach from=$RoleList item=ListDet}
