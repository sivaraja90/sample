  ...
  <body class="hold-transition skin-blue sidebar-mini" onLoad="doOnLoad();">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		List Service</label></i></a></small>&ensp;&ensp;&ensp;
		<small><a href="service_quote_reg.php"><i class="fa fa-user-plus"> <label style="font-family:Arial, Helvetica, sans-serif">
		Create Service</label></i></a></small>
		</h4>
				...
				{/if}
				   ...
				   <div class="col-md-6">
                    <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="service_quote_no" name=" service_quote_no" value="{$service_quote_no}" tabindex="1" placeholder="Service Quote No" autocomplete="0ff" readonly="true">
                      </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
					  <input type="text" id="revised_no" name="revised_no" class="form-control" value="{$smarty.post.revised_no}"  tabindex="3" placeholder="Revised Number" autocomplete="0ff">
					  </div>		 
				</div>
				<div class="form-group" style=" margin-top:0px;">
                      <label class="col-sm-3 control-label">Customer Id </label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="customer_id" name="customer_id" value="{$smarty.post.customer_id}" tabindex="7" placeholder="Customer Id" autocomplete="0ff">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Mobile No </label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="{$smarty.post.mobile_no}" placeholder="Mobile No" maxlength="10" tabindex="9" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="Off">
                      </div>
					&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" value="{$smarty.post.address1}"  placeholder="Address1" autocomplete="0ff">
                      </div>
                    </div>
					  <div class="form-group">
                      <label class="col-sm-3 control-label">City</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="city" name="city" value="{$smarty.post.city}" placeholder="City" tabindex="11" autocomplete="0ff" >
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					 </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Phone No</label>
					    <div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" value="{$smarty.post.area_code}" placeholder="Area Code" tabindex="13" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="{$smarty.post.phone_no}" placeholder="Phone No" tabindex="14"onKeyUp="numericFilter(this);" autocomplete="off" >
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="{$smarty.post.extension}" placeholder="Extension" tabindex="15" onKeyUp="numericFilter(this);" autocomplete="off" >
                       </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sqft" name="sqft" value="{$smarty.post.sqft}" placeholder="Sqft" tabindex="17">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total_material" name="total_material" value="{$smarty.post.total_material}" placeholder="Total Material" tabindex="23">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material_value" name="material_value" value="{$smarty.post.material_value}" placeholder="Material Value"  tabindex="21">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material_estimate" name="material_estimate" value="{$smarty.post.material_estimate}" placeholder="Material Estimate" tabindex="18">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour" name="labour" value="{$smarty.post.labour}" placeholder="Labour" tabindex="22">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour_tax_per" name="labour_tax_per" value="{$smarty.post.labour_tax_per}" placeholder="Labour Tax Percentage" onKeyUp="getvalue1();numericFilter(this);" tabindex="27">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour_tax_value" name="labour_tax_value" value="{$smarty.post.labour_tax_value}" placeholder="Labour Tax Value" tabindex="26">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total_labour_cost" name="total_labour_cost" value="{$smarty.post.total_labour_cost}" placeholder="Total Labour Cost" tabindex="29">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="created_by" name="created_by" readonly="true" tabindex="31" placeholder="Created By" value="{$smarty.session.UserName}" >
					...
					<!--**********************************************************-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_date" name="quote_date" value="{$smarty.post.quote_date}" placeholder="Quote Date" onClick="doOnLoad();" tabindex="2" readonly="true" >
                      </div>
					   &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="revised_version"  name="revised_version" value="{$smarty.post.revised_version}" tabindex="4" placeholder="Revised Version" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="company_name" name="company_name" value="{$smarty.post.company_name}" tabindex="6" placeholder="Company Name" autocomplete="0ff">
                      </div>
                    </div> 
					<div class="form-group">
                      <label class="col-sm-3 control-label">Address</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address" name="address" value="{$smarty.post.address}" tabindex="8" placeholder="Address" autocomplete="0ff">
                      </div> 
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" value="{$smarty.post.area}" tabindex="10" placeholder="Area" onKeyUp="text_filter(this)" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pincode" name="pincode" maxlength="6" value="{$smarty.post.pincode}" tabindex="12" placeholder="Pincode" onKeyUp="numericFilter(this);" onBlur="chk_exist_pin(this);" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="email" name="email" value="{$smarty.post.email}" placeholder="Email Id" tabindex="14" onKeyUp="clear_err_email_id();" autocomplete="Off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					...
					<div class="form-group" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material" name="material" value="{$smarty.post.material}" placeholder="Material" tabindex="16">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material_tax_per" name="material_tax_per" value="{$smarty.post.material_tax_per}" placeholder="Material Tax Percentage" onKeyUp="getvalue();numericFilter(this);" tabindex="19">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material_tax_value" name="material_tax_value" value="{$smarty.post.material_tax_value}" placeholder="Material Tax Value" tabindex="20">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total_material_cost" name="total_material_cost" value="{$smarty.post.total_material_cost}" placeholder="Total Material Cost" tabindex="23">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					    <div class="form-group" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total_labour" name="total_labour" value="{$smarty.post.total_labour}" placeholder="Total Labour" tabindex="23">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour_value" name="labour_value" value="{$smarty.post.labour_value}" placeholder="Labour Value" tabindex="25">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour_estimate" name="labour_estimate" value="{$smarty.post.labour_estimate}" placeholder="Labour Estimate"  tabindex="24">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total" name="total" value="{$smarty.post.total}" placeholder="Total" tabindex="28">
                      </div> &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font></div>  
					  
					  <div class="form-group">
                      <label class="col-sm-3 control-label">Remarks</label>
                      <div class="col-sm-5">
                        <textarea class="form-control" id="remarks" name="remarks" value="{$smarty.post.remarks}" placeholder="Remarks" tabindex="30"></textarea>
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>				  				
