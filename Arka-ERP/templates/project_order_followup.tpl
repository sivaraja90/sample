...
{/literal}
		...
		<form class="form-horizontal" name="add_address"><body onLoad="doOnLoad();">
			...
			<input type="hidden" id="enquiry_id" name="enquiry_id" value="{$View.enquiry_id}">
				...
				<input type="hidden" id="project_quote_date" name="project_quote_date" value="{$View.quote_date}">
					<input type="hidden" id="project_order_no" name="project_order_no" value="{$View.project_order_no}">
						...
						<input type="hidden" class="form-control" id="revised_no" name="revised_no" value="{$View.revised_version}" >
	...
	<td class="col-sm-3">
		...
		<tr class="form-group">	
					<th class="col-sm-2 control-th" >Enquiry Id</th>
						<td class="col-sm-5" >
            <input type="text" class="form-control" id="enquiry_id" name="enquiry_id" placeholder="enquiry_id" tabindex="1" value="{$View.enquiry_id}" readonly="true"><td></td>
						</td>
