	...
	<td class="col-sm-3">
		<tr class="form-group">	
				<th class="col-sm-2 control-th">Service Quote No </th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="service_quote_no" name="service_quote_no"  value="{$smarty.get.service_quote_no}" readonly="true"  tabindex="1" placeholder="Service Quote No">  </td>	
						{foreach from=$ServiceQuote item=reviseMaster}
					<input type="hidden" class="form-control" id="customer_name" name="customer_name" value="{$reviseMaster.customer_name}"  >
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="{$reviseMaster.service_quote_date}" placeholder="Quote Date" onClick="doOnLoad();" tabindex="3" readonly="">
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" placeholder="ex :  50%" id="payment" name="payment" value="{$RevTerm.0.payment}"  tabindex="3" autocomplete="Off">
					...
					<tr class="form-group" >
						...
						<td class="col-sm-5">
						 <input type="text" class="form-control" placeholder="ex : 2 to 3 Weeks" id="delivery" name="delivery" value="{$RevTerm.0.delivery}" tabindex="4" autocomplete="Off">
						<td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						<th class="col-sm-2 control-th">Validity</th>
						<td class="col-sm-5">
					<select id="validity" name="validity" class="form-control" value="{$RevTerm.0.validity}" tabindex="5" >
				...
				<form name="ServiceList" id="ServiceList" method="post">
                  <table id="example2" class="table table-bordered table-striped" style="font-size:13px; font-family:'Times New Roman', Times, serif;">
					...
					<tr id="{$i++}">        
							...
							<td align="center"> &nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onClick="Javascript:deleteCat('{$Contact.sl_no}','{$smarty.get.revised_version}','{$smarty.get.service_quote_no}','{$Contact.total}','{$Contact.sub_total}')"><i class="fa fa-trash"></i></a></td>	 
