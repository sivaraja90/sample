...
<table class="col-md-6" >
		...
		<tr class="form-group">	
				<th class="col-sm-2 control-th">Quote No</th>
						...
						<input type="hidden" id="enquiry_id" name="enquiry_id" value="{$RevDetail.0.enquiry_id}"/>
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" placeholder="Quote Date" value="{$LDList2.0.quote_date}" tabindex="2" readonly="true" autocomplete="Off"/>
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="payment" name="payment"  value="{$SaleTerm.0.payment}" tabindex="3" autocomplete="Off"/>					
						</td>
						<td class="col-sm-5">
						</td>	
						<th class="col-sm-2 control-th">Delivery</th>
						<td class="col-sm-5">
						<input type="text"  class="form-control" id="delivery" name="delivery" value="{$SaleTerm.0.delivery}" tabindex="4" autocomplete="Off"/>					
						</td>
						<td class="col-sm-5">
						</td>
						</tr>
						...
						<td class="col-sm-5">
						<input type="text"  class="form-control" id="validity" name="validity" value="{$SaleTerm.0.validity}" tabindex="5" autocomplete="Off"/>					
						</td>
						<td class="col-sm-5">
						</td>
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="item_code" name="item_code" placeholder="Item Code" tabindex="9" readonly="true" value="{$smarty.post.item_code}" onKeyUp="text_filter(this);" >
						<td><!--<font class="error" color="#f56954"><b>*</b></font>--></td>
						</td>
						</tr>
						<tr class="form-group">
				...
				<input type="hidden" id="sNo" name="sNo" value="{$sl_no}">
                  <table id="example2" class="table table-bordered table-striped" style="font-size:13px;, Times, serif;">
					...
					<input type="hidden" value="{$details_list.sales_quote_no}">
								...
								<td align="center"><a href="#" onClick="Javascript:viewCats('{$details_list.customer_id}')">{if $details_list.product_description neq ""}{$details_list.product_description}{else}{$details_list.material_description}{/if}</a></td>
								...
								<td class="center">&nbsp;&nbsp; &nbsp;&nbsp;<a href="#" onClick="Javascript:deleteCat('{$details_list.sl_no}','{$smarty.get.sales_quote_no}','{$smarty.get.revised_version}','{$details_list.enquiry_id}','{$details_list.total}','{$details_list.sub_total}','{$details_list.profit_per}')"><i class="fa fa-trash"></i></a></td>
