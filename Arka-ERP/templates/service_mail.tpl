...
<form name="ServiceMailAdd" id="ServiceMailAdd" method="post" enctype="multipart/form-data">
		<input type="hidden" name="hdAction">
			...
			<table  class="table table-bordered table-striped">
				{foreach from=$EnqSermailview item=serMail}
				<tr class="taglist2">
				<td >&nbsp;</td>
				{if $serMail.mail_id neq "" }
				<td><input type="checkbox" name="check2" id="check2" onClick="dynInput(this);" value="{$serMail.mail_id}" />&nbsp;&nbsp;{$serMail.mail_id}&nbsp;&nbsp;{/if}&nbsp;&nbsp;{if $serMail.mail_id1 neq "" }
				<input type="checkbox" name="check1" id="check1" onClick="dynInput(this);" value="{$serMail.mail_id1}" />&nbsp;&nbsp;{$serMail.mail_id1}</td>
				{/if}
				</tr>
				{/foreach}
				<tr>
				<th>To</th>			
				<td><textarea id="mail_id2" name="mail_id2" style="width:530px;" value="{$smarty.post.mail_id2}">{$smarty.post.mail_id2}</textarea></td>
				</tr>
				<tr>
				<th>cc</th>
				...
				<tr>
				<th>Subject</th>
				<td><textarea id="subject" name="subject" style="width:530px;" value="{$smarty.post.subject}" >{$smarty.post.subject}</textarea></td>
				</tr>
				<tr>
				<th>Message</th>
				<td><textarea class="ckeditor" id="message" name="message" style="width:545px;">{$smarty.post.message}</textarea></td>
				</tr>
				<tr>
				<th>Attachment 1</th>
