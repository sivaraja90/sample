...
<h4><center>View Followup Detail</center></h4>
		<form class="form-horizontal" name="Followup">
			...
			<input type="hidden" id="customer_id" name="customer_id"  value="{$smarty.get.customer_id}"  >
                    ...
                    <tbody>
                     {foreach from=$ListDetail1 item=Contact}
					 <input type="hidden" value="{$Contact.sales_order_no}"/>
					<tr {$i++}>        
					            <td align="center"><a href="#" onClick="Javascript:viewCats('{$Contact.sales_order_no}')">{$i}</a></td>
								<td align="center"><a href="#" onClick="Javascript:viewCats('{$Contact.sales_order_no}')">{$Contact.enquiry_id}</a></td>
								...
								<td align="center"><a href="#" onClick="Javascript:viewCats('{$Contact.sales_order_no}')">{$Contact.company_name}</a></td>	
								<td align="center"><a href="#" onClick="Javascript:viewCats('{$Contact.sales_order_no}')">{$Contact.customer_id}</a></td>
								<td align="center"><a href="#" onClick="Javascript:viewCats('{$Contact.sales_order_no}')">{$Contact.quantity}</a></td>
								<td align="center"><a href="#" onClick="Javascript:viewCats('{$Contact.sales_order_no}')">{$Contact.vat_per}</a></td>
								<td align="center"><a href="#" onClick="Javascript:viewCats('{$Contact.sales_order_no}')">{$Contact.total}</a></td>	
								<!-- <td align="center">&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onClick="Javascript:deleteCat('{$Contact.sl_no}','{$Contact.sales_order_no}')"><i class="fa fa-trash"></i></a></td>-->
