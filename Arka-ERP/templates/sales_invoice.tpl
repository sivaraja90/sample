	...
	<td class="col-sm-3">
		<tr class="form-group">	
				...
				<th class="col-sm-2 control-th">Invoice Number</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="invoice_no" name="invoice_no" value="{$c_id}" placeholder="Invoice Number" tabindex="1" readonly="true">
						</td>
						<td class="col-sm-5">
						</td>
				...
				<th class="col-sm-2 control-th">Sales Order Number</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="sales_order_no" name="sales_order_no" value="{$smarty.get.sales_order_no}" tabindex="2" readonly="true">
						</td><td></td>
			...
			<tr class="form-group">
					<th class="col-sm-2 control-th" >Invoice Amount</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="invoice_amount" name="invoice_amount" placeholder="Invoice Amount" tabindex="3" value="{$smarty.post.invoice_amount}" onKeyUp="numericFilter(this);" autocomplete="Off">
						</td>
				    <td class="col-sm-5">
						</td>
