...
<script>
       function validate_fields()
        {
		var fields=["salutation","customer_fname","customer_lname","designation","area","mail_id"];
		...
		<form class="form-horizontal" name="add_contact">
			...
			<input type="hidden" id="customer_id" name="customer_id"  value="{$smarty.get.customer_id}"  >
				   ...
				   <tr class="form-group">
                      ...
                      <td class="col-sm-2">
					  <select id="salutation" name="salutation"  class="form-control" tabindex="1" value="{$smarty.post.salutation}" style="width:70px;" autocomplete="off" >
					  <option>Mr</option>
					  <option>Mrs</option>
					  <option>Miss</option>
					  </select>
					  ...
					  <td class="col-sm-3">
                        <input type="text" class="form-control" id="customer_fname" name="customer_fname" placeholder="First name" value="{$smarty.post.customer_fname}" tabindex="2" style="margin-left:-108px; width:150px;" onKeyUp="text_filter(this);" autocomplete="off">
					  </td>
					  <td class="col-sm-3">
						<input type="text" class="form-control" id="customer_lname" name="customer_lname" placeholder="Last name" value="{$smarty.post.customer_lname}" style="margin-left:-28px; width:150px;" tabindex="3" onKeyUp="text_filter(this);" autocomplete="off"><td><!--<font class="error" color="#f56954"><b>*</b>&nbsp;</font>&nbsp;&nbsp;--></td>
                      </td>
				 ...
				 <tr class="form-group">
					...
					<tr class="form-group" id="hdn_mobile3" style="display:none;">
					 ...
					 <tr class="form-group">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="created_by" value="{$smarty.session.UserName}" name="created_by" readonly="true" tabindex="5">
                      </td>
					</tr>
					<tr class="form-group">
                      <th class="col-sm-4 control-th">Designation</th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="designation" name="designation" value="{$smarty.post.designation}" placeholder="Designation" tabindex="6" onKeyUp="text_filter(this);" autocomplete="off">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="area" value="{$smarty.post.area}" name="area" placeholder="Area" tabindex="7" autocomplete="off" onKeyUp="text_filter(this);"><td><!--<input type="button" class="btn btn-danger btn-xs" value="ADD Address"  onClick="add_address();" style="margin-right:-100px;">--><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>&nbsp;&nbsp;--></td>
                     </td>
					...
					<!--<tr class="form-group" id="hdn_address2" style="display:none;">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="address2" name="address2" maxlength="10" placeholder="Address" value="{$smarty.post.address2}" autocomplete="off">
                      </td>
                    </tr>
					<tr class="form-group" id="hdn_address3" style="display:none;">
                      <th class="col-sm-4 control-th">Address 2 </th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="address3" name="address3" maxlength="10" placeholder="Address" value="{$smarty.post.address3}" autocomplete="off">
                      </td>
                    </tr>-->
					 <tr class="form-group">
                      <th class="col-sm-4 control-th">Phone No</th>
					    <td class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" maxlength="6" value="{$smarty.post.area_code}" placeholder="Area Code" tabindex="8" style="width:75px;" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" maxlength="10" value="{$smarty.post.phone_no}" placeholder="Phone No" maxlength="9" style="width:100px; margin-left:-100px;" tabindex="8"onKeyUp="numericFilter(this);" autocomplete="off" >
                      </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" maxlength="4" placeholder="Extension" value="{$smarty.post.extension}" tabindex="10" style="width:100px; margin-left:-70px;" onKeyUp="numericFilter(this);" autocomplete="off"></td>
					  ...
					  <td class="col-sm-2">
					    <input type="text" class="form-control" id="area_code1" name="area_code1" maxlength="6" value="{$smarty.post.area_code1}" placeholder="Area Code 1" style="width:75px;" onKeyUp="numericFilter(this);" autocomplete="off">
					  </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no1" name="phone_no1" maxlength="10" value="{$smarty.post.phone_no1}" placeholder="Phone No 1" style="width:100px; margin-left:-100px;" onKeyUp="numericFilter(this);" autocomplete="off">
                      </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="extension1" name="extension1" maxlength="4" value="{$smarty.post.extension1}" placeholder="extension 1" style="width:100px; margin-left:-70px;" onKeyUp="numericFilter(this);" autocomplete="off">
                       </td>
					   </tr>
					   <tr class="form-group">
                      <th class="col-sm-4 control-th">Email Id</th>
                      <td class="col-sm-6">
                        <input type="email" class="form-control" id="mail_id" name="mail_id" value="{$smarty.post.mail_id}" placeholder="Email Id" tabindex="11" onKeyUp="clear_err_email_id();" autocomplete="off" onBlur="chk_exist_email(this);">
                      ...
                      <td class="col-sm-6">
                        <input type="email" class="form-control" id="mail_id1" name="mail_id1" value="{$smarty.post.mail_id1}" placeholder="Email Id 1"  onKeyUp="clear_err_email_id();" autocomplete="off" onBlur="chk_exist_email(this);">
                      </td>
					  </tr>
					<tr class="form-group">
                      <th class="col-sm-4 control-th">Remarks</th>
                      <td class="col-sm-6">
                        <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks" value="{$smarty.post.remarks}" tabindex="12" autocomplete="off"></textarea>
                      <td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					  </td>
                    </tr>
					</table>
					...
					<input type="button" class="btn btn-info pull-center" value="SUBMIT" tabindex="13"  onClick="validate_fields();" data-dismiss="modal">&nbsp;&nbsp;
					</center>
                  </div>
				  </div>
				  </body>
