...
<tr class="form-group">
	<td class="col-sm-3">
		<tr class="form-group">	
				<th class="col-sm-2 control-th">Quote No</th>
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="sales_quote_no" name="sales_quote_no" value="{$s_quote}" placeholder="Sales Quote No" readonly="true" tabindex="1"/>                  {if $Revise.0.revised_version eq ""}
						<input type="hidden" class="form-control" id="revised_version" name="revised_version" value="{$r_version}"  >
						{else $Revise.0.revised_version neq ""}
			...
			<input type="text" class="form-control" id="quote_date" name="quote_date" placeholder="Quote Date" value="{$LDList2.0.quote_date}" tabindex="2" readonly="true" />
						...
						<td class="col-sm-5"><input type="text" class="form-control" id="delivery" name="delivery"  placeholder="ex : 2 to 3 Weeks" autocomplete="off" value="{$SaleTerm.0.delivery}" tabindex="4" />
						...
						<td class="col-sm-5">
					<select id="validity" name="validity" class="form-control" value="{$SaleTerm.0.validity}" tabindex="5" >
  ...
  FormName.action= "sales.php?sl_no="+CatIdent+"&sales_quote_no="+CusIdent+"&revised_version="+Rev+"&enquiry_id="+Enq+"&total="+Total+"&sub_total="+Sub+"&pro="+Pro;
  FormName.submit();
 }
 }
