...
<form name="PoMailAdd" id="PoMailAdd" method="post" enctype="multipart/form-data">
		...
		{/if}
			...
			<table  class="table table-bordered table-striped">
				...
				{foreach from=$EnqpoMailview item=poMail}
				<tr class="taglist2">
				<td >&nbsp;</td>
				{if $poMail.mail_id neq "" }
				<td><input type="checkbox" name="check2" id="check2" onClick="dynInput(this);" value="{$poMail.mail_id}" />&nbsp;&nbsp;{$poMail.mail_id}&nbsp;&nbsp;{/if}&nbsp;&nbsp;{if $poMail.mail_id1 neq "" }
				<input type="checkbox" name="check1" id="check1" onClick="dynInput(this);" value="{$poMail.mail_id1}" />&nbsp;&nbsp;{$poMail.mail_id1}</td>
				{/if}
				</tr>
				{/foreach}
				<tr>
