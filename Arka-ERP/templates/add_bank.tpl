...
function validate_phone(data)
{
       ...
       function validate_fields()
		...
		var fields=["address","area","landmark","city","pincode","remark"];
...
<table class="col-md-6" cellpadding="10">
				...
				<tr class="form-group">
					<th class="col-sm-5 control-th" style="margin-bottom:-30px;">Account No</th>
						<td>
						<input type="text" class="form-control" id="address" name="address" placeholder="Address" tabindex="7"><td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
				
					<th class="col-sm-5 control-th">Address1</th>
						<td>
						<input type="text" class="form-control" id="address1" name="address1" placeholder="Address1" tabindex="8"> <td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
				...
				<tr class="form-group">
					<th class="col-sm-5 control-th">Area</th>
						<td>
						<input type="text" class="form-control" id="area" name="area" placeholder="Area" tabindex="9" onKeyUp="text_filter(this);"><td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
				
				
					<th class="col-sm-5 control-th">Land Mark</th>
						<td>
						<input type="text" class="form-control" id="landmark" name="landmark" placeholder="Land Mark" tabindex="10"><td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
				...
				<tr class="form-group">
					<th class="col-sm-5 control-th">City</th>
						<td>
						<input type="text" class="form-control" id="city" name="city" placeholder="City" tabindex="11" onKeyUp="text_filter(this);">
						</td><td>&nbsp;</td>
				
				<th class="col-sm-5 control-th" style="margin-bottom:-30px;">Pincode</th>
						<td>
						<input type="text" class="form-control" id="pincode" name="pincode" placeholder="Pincode" maxlength="6" onBlur="chk_exist_pin(this)" onKeyUp="numericFilter(this);" tabindex="12" ><td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
				...
				<tr class="form-group">
					<th class="col-sm-5 control-th">Remarks</th>
						<td>
						<textarea class="form-control" id="remark" name="remark" placeholder="Remarks" tabindex="13"></textarea><td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						
				
				
					<th class="col-sm-5 control-th" style="margin-bottom:-30px;">Created By</th>
						<td>
						<input type="text" class="form-control" id="created_by" name="created_by" value="{$smarty.session.UserName}" placeholder="Created By" tabindex="6" readonly="true"><td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
				</tr>
