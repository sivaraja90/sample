...
function validate_phone(data)
{
       ...
       function validate_fields()
		...
		var fields=["payment","delivery","validity","materialDescription","sqft","material","labour","total_material","total_labour","total"];
...
{/literal}
	...
	<div id="Project">
		...
		<form class="form-horizontal" name="add_contact">
			...
			<input type="hidden" id="project_quote_no" name="project_quote_no"  value="{$smarty.get.project_quote_no}"  >
				   ...
				   <input type="hidden" id="c_name" name="c_name" value="{$Contact.project_quote_no}"/>
					<tr class="form-group">
                      <th class="col-sm-4 control-th">Material Description</th>
                      <td class="col-sm-2">
	 <input type="text" name="materialDescription" id="materialDescription" class="form-control" tabindex="3" value="{$Contact.product_description}" placeholder="Material Description" style="width:170" >
					  </td><td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
                    </tr>
				 <tr class="form-group">
                      <th class="col-sm-4 control-th">Sqft </th>
                      <td class="col-sm-2">
           <input type="text" class="form-control" id="sqft" name="sqft" placeholder="Sqft" value="{$Contact.sqft}" maxlength="10" tabindex="7" style="width:170"></td><td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
                    
                    </tr>
					<tr class="form-group" >
                      <th class="col-sm-4 control-th">Material </th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="material" name="material" maxlength="10" placeholder="Material " value="{$Contact.material}"  onKeyUp="numericFilter(this);"  onBlur="chk_exist_mob(this);">
                      </td><td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
                    </tr>
					<tr class="form-group" id="hdn_mobile3" style="display:none;">
                      <th class="col-sm-4 control-th">Labour</th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="labour" name="labour" value="{$Contact.labour}" maxlength="10" placeholder="Labour" onKeyUp="numericFilter(this);"  onBlur="chk_exist_mob(this);">
                      </td>
                    </tr>
					 <tr class="form-group">
                      <th class="col-sm-4 control-th">Total Material </th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="total_material" value="{$Contact.total_material}" name="total_material" placeholder="Total Material" readonly="true">
                      </td><td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					</tr> 
                     <tr class="form-group">
                      <th class="col-sm-4 control-th">Total Labour</th>
                      <td class="col-sm-4">
                        <input type="text" class="form-control" id="total_labour" name="total_labour"  placeholder="Total Labour" tabindex="9" value="{$Contact.total_labour}"  autocomplete="off" readonly="true"></td>
					...
					<tr class="form-group">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="total" name="total" value="{$Contact.total}" placeholder="Total" tabindex="12" onKeyUp="text_filter(this);">
					  ...
					  <th class="col-sm-2 control-th">Remarks</th>
						<td class="col-sm-5">
					 <textarea class="form-control" id="remarks" name="remarks" value="{$Contact.remarks}" placeholder="Remarks" tabindex="22" autocomplete="off"></textarea> 
						</td>
						<td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
		    </tr> 
					{/foreach}
