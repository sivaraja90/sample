				...
				{/if}
				   ...
				   <div class="col-md-6">
                    <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="service_quote_no" name=" service_quote_no" value="{$View.service_quote_no}" tabindex="1" placeholder="Service Quote No" autocomplete="0ff">
                      </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
					  <input type="text" id="revised_no" name="revised_no" class="form-control" value="{$View.service_quote_revise_no}"  tabindex="3" placeholder="Revised Number" autocomplete="0ff" >
					  </div>		 
				</div>
				<div class="form-group" style=" margin-top:0px;">
                      <label class="col-sm-3 control-label">Customer Id </label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="customer_id" name="customer_id" value="{$View.customer_id}" tabindex="7" placeholder="Customer Id" autocomplete="0ff">
                      </div>
                    </div>
					...
					<div class="form-group" style=" margin-top:0px;">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="enquiry_id" name="enquiry_id" value="{$View.enquiry_id}" tabindex="7" placeholder="Enquiry Id" autocomplete="0ff">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Mobile No </label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="{$View.mobile_no}" placeholder="Mobile No" maxlength="10" tabindex="11" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);">
                      </div>
					&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" value="{$View.address1}" tabindex="21" placeholder="Address1" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address2" name="address2" value="{$View.address2}"  placeholder="Address2" autocomplete="0ff">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" value="{$View.area}" tabindex="23" placeholder="Area" onKeyUp="text_filter(this)" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pincode" name="pincode" maxlength="6" value="{$View.pincode}" tabindex="24" placeholder="Pincode" onKeyUp="numericFilter(this);" onBlur="chk_exist_pin(this);" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Phone No</label>
					    <!--<div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" value="{$View.area}" placeholder="Area Code" tabindex="13" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </div>-->
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="{$View.phone_no}" placeholder="Phone No" tabindex="14"onKeyUp="numericFilter(this);" autocomplete="off" >
                      </div>
                      <!--<div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="{$View.extension}" placeholder="Extension" tabindex="15" onKeyUp="numericFilter(this);" autocomplete="off" >
                       </div>-->
					  ...
					  <!--<div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code1" name="area_code1" value="{$View.service_quote_no}" placeholder="Area Code 1" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </div>-->
                      <div class="col-sm-5">
                      ...
                      <!--<div class="col-sm-2">
                        <input type="text" class="form-control" id="extension1" name="extension1" value="{$View.service_quote_no}" placeholder="extension 1" onKeyUp="numericFilter(this);" autocomplete="off" >
                       </div>-->
					   </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material_tax_per" name="material_tax_per" value="{$View.material_tax_per}" placeholder="Material Tax Percentage" onKeyUp="getvalue1();numericFilter(this);" tabindex="21">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total_material" name="total_material" value="{$View.total_material}" placeholder="Total Material" tabindex="23" onKeyUp="getvalue();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour_value" name="labour_value" value="{$View.labour_value}" placeholder="Labour Value" onKeyUp="numericFilter(this);" tabindex="25">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour_tax_per" name="labour_tax_per" value="{$View.labour_tax_per}" placeholder="Labour Tax Percentage" onKeyUp="getvalue2();numericFilter(this);" tabindex="27">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total_labour" name="total_labour" value="{$View.total_labour}" placeholder="Total Labour" tabindex="29" onKeyUp="getvalue();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="created_by" name="created_by" tabindex="31" placeholder="Created By" value="{$smarty.session.UserName}" >
					...
					<!--**********************************************************-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="service_order_no" name="service_order_no" value="{$View.service_order_no}" placeholder="Service Order No"  tabindex="2">
                      </div>
					   &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_date" name="quote_date" value="{$View.service_order_date}" placeholder="Service Order Date" onClick="doOnLoad();" tabindex="2">
                      </div>
					   &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    ...
                    <!--<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="revised_version"  name="revised_version" value="{$View.service_quote_revise_no}" tabindex="6" placeholder="Revised Version" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>-->
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="company_name" name="company_name" value="{$View.company_name}" tabindex="8" placeholder="Company Name" autocomplete="0ff">
                      </div>
                    </div> 
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="description" name="description" value="{$View.description}" tabindex="8" placeholder="Description" autocomplete="0ff">
                      </div>
                    </div> 
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="email" name="email" value="{$View.email_id}" placeholder="Email Id" tabindex="9" onKeyUp="clear_err_email_id();" autocomplete="0ff">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="email1" name="email1" value="{$View.email_id1}" placeholder="Email Id 1"  onKeyUp="clear_err_email_id();" autocomplete="0ff">
                      </div>
					  </div>
					...
					<div class="form-group" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sqft" name="sqft" value="{$View.sqft}" placeholder="Sqft" tabindex="17" onKeyUp="getvalue();getvalue3();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					...
					<div class="form-group" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material" name="material" value="{$View.material}" placeholder="Material" tabindex="18" autocomplete="0ff" onKeyUp="getvalue();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour" name="labour" value="{$View.labour}" placeholder="Labour" tabindex="22" autocomplete="0ff" onKeyUp="getvalue();">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material_value" name="material_value" value="{$View.material_value}" placeholder="Material Value" onKeyUp="numericFilter(this);" tabindex="19">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material_estimate" name="material_estimate" value="{$View.material_estimate}" placeholder="Material Estimate" onKeyUp="numericFilter(this);" tabindex="20" autocomplete="0ff">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="material_tax_value" name="material_tax_value" value="{$View.material_tax_value}" placeholder="Material Tax Value" onKeyUp="numericFilter(this);" tabindex="20" autocomplete="0ff">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour_estimate" name="labour_estimate" value="{$View.labour_estimate}" placeholder="Labour Estimate" onKeyUp="numericFilter(this);" tabindex="20" autocomplete="0ff">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="labour_tax_value" name="labour_tax_value" value="{$View.labour_tax_value}" placeholder="Labour Tax Value" onKeyUp="numericFilter(this);" tabindex="24" autocomplete="0ff">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total" name="total" value="{$View.total}" placeholder="Total" tabindex="26" autocomplete="0ff">
                      </div> &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font></div>
					  
					  <div class="form-group">
                      <label class="col-sm-3 control-label">Remarks</label>
                      <div class="col-sm-5">
                        <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks" tabindex="28" autocomplete="0ff">{$View.remark}</textarea>
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
