		...
		<form class="form-horizontal" >
			...
			<input type="hidden" id="customer_id" name="customer_id"  value="{$smarty.get.customer_id}"  >
				  ...
				  <table class="col-md-6">
					...
					<input type="hidden" id="project_quote_no" name="project_quote_no" value="{$Edit.project_quote_no}"/>
				   {foreach from=$ProjectList3 item=Edit}
				  <tr class="form-group">
                      <th class="col-sm-4 control-th" style="font-weight:bold;">Project Quote No </th>
                      <td class="col-sm-2">
                       {$Edit.project_quote_no}
                     </td>
...
<br>
                    ...
                    <tbody>
                      ...
                      {foreach from=$ProjectList2 item=Contact}
					<tr id="{$i++}">        
