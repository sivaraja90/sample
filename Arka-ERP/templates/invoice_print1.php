<?php
  require('includes/common.php');
	...
	$ObjEnquiryReg->ViewService($_GET['enquiry_id']);
	}
	...
	if(isset($_GET['enquiry_id']))
	{
		$ObjEnquiryReg->SelectMaster($_GET);
	}
	$ObjEnquiryReg->DateStamp();
	$ObjEnquiryReg->TimeStamp();*/
//	$ObjDashboard->RolesLists();
	// $ObjDashboard->myCurl($objArray);

  $objSmarty->assign('IncludeTpl', 'invoice_print1.tpl');
