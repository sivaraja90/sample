	...
	<td class="col-sm-3">
		<tr class="form-group">	
				<th class="col-sm-2 control-th">Project Quote No </th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="project_quote_no" name="project_quote_no"  value="{$p_quote}" readonly="true"  tabindex="1" placeholder="Project Quote No">  	
...
{/if}
				...
				<th class="col-sm-2 control-th">Quote Date</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="{$ServiceIn.0.quote_date}" placeholder="Quote Date" onClick="doOnLoad();" tabindex="2" readonly="true">
						</td>
						<td class="col-sm-5">
                  ...
                  <table id="example2" class="table table-bordered table-striped" style="font-size:13px; font-family:'Times New Roman', Times, serif;">
					...
					<tr {$i++}>        
								...
								<td align="center"><a href="#" onClick="Javascript:viewCats('{$Contact.customer_id}')">{$Contact.total}</a></td>
								 ...
								 <td class="center">&nbsp;&nbsp; &nbsp;&nbsp;<a href="#" onClick="Javascript:deleteCat('{$Contact.sl_no}','{$smarty.get.project_quote_no}','{$smarty.get.revised_version}','{$Contact.enquiry_id}','{$Contact.total}','{$Contact.sub_total}')"><i class="fa fa-trash"></i></a></td>
