        ...
        <section class="content">
          ...
          <div class="box box-info">
			...
			<input type="hidden" name="hdAction" />
					...
					<input type="hidden" id="hdn_customer_type" name="hdn_customer_type" value="{$smarty.post.customer_type}">
				{foreach from=$Comtype1 item=View}					
					<input type="hidden" id="company_name" name="company_name" value="{$View.company_name}">
					<input type="hidden" id="del_address" name="address" value="{$View.del_address}">
					<input type="hidden" id="del_address1" name="address1" value="{$View.del_address1}">
					<input type="hidden" id="del_area" name="area" value="{$View.del_area}">
					<input type="hidden" id="del_city" name="city" value="{$View.del_city}">
					<input type="hidden" id="del_pincode" name="pincode" value="{$View.del_pincode}">
			{/foreach}
		 ...
		 {/if}
                  ...
                  <div class="box-body">
				   ...
				   {if $LDList2 eq ""}
                    <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="po_no" name="po_no" tabindex="1" value="{$po_no}" placeholder="PO No" autocomplete="off" readonly="true">
                      </div>
                    </div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_company" name="supplier_company" placeholder="Supplier company" value="{$smarty.post.supplier_fname}" tabindex="3"  onKeyUp="text_filter(this);" autocomplete="off">
					</div>
                    </div>
					 ...
					 <div class="col-sm-5">
								   	<select id="contact_person" name="contact_person" class="form-control" onChange="split_cnt_dtls(this.value);" tabindex="5" value="{$smarty.post.contact_person}">
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-5">
						<select id="po_status" name="po_status"  class="form-control" tabindex="7" value="{$smarty.post.po_status}" autocomplete="off" >
				...
				<div class="form-group"  >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_ref_id" name="quote_ref_id" tabindex="9" value="{$smarty.post.quote_ref_id}" placeholder="Quote Reference Id" autocomplete="off">					<input type="hidden" class="form-control" id="timestamp" name="timestamp" value="{$smarty.now|date_format:'%Y-%m-%d &amp; %I:%M:%S %p'}">
					...
					<div class="form-group" >
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No" value="{$smarty.post.mobile_no}" maxlength="10" tabindex="13" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off" readonly="true">
                      </div>
                    </div>
					  	<div class="form-group">
                      <label class="col-sm-3 control-label">Address</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address" name="address" value="{$smarty.post.address}" tabindex="15" placeholder="Address" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Area</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" value="{$smarty.post.area}" tabindex="17" placeholder="Area" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Delivered To</label>
                      <div class="col-sm-5">
						<select id="deliver_to" name="deliver_to"  class="form-control" tabindex="19" value="{$smarty.post.deliver_to}" autocomplete="off" >
					  <option value="">---Select---</option>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                     <input type="text" class="form-control" id="city" name="city" tabindex="21" value="{$smarty.post.city}" placeholder="City" autocomplete="off" readonly="true">
                      </div>
                    </div>
					...
					<div class="form-group" style="border-bottom: 1px solid #d6d2d2;"></div>
                      ...
                      <div class="col-sm-5">
                   <input type="text" class="form-control" id="created_by" name="created_by" tabindex="23" value="{$smarty.session.UserName}" readonly="true" autocomplete="off" >
                      </div>
                    </div>
					{/if}
				{if $LDList2 neq ""}
				{foreach from=$LDList2 item=master}
					<div class="form-group">			 
                      <label class="col-sm-3 control-label">PO No</label>
                      <div class="col-sm-5">
                      <input type="text" class="form-control" id="po_no" name="po_no" tabindex="1" value="{$master.po_no}" placeholder="PO No" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">SupplierCompany</label>
					  <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_company" name="supplier_company" placeholder="Supplier company" value="{$master.supplier_company_name}" tabindex="3"  onKeyUp="text_filter(this);" autocomplete="off">
					</div>
                    </div>
					 ...
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Contact Person</label>
					  <div class="col-sm-5">
                        <input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="Contact Person" value="{$master.contact_person}" tabindex="5"  onKeyUp="text_filter(this);" autocomplete="off">
					</div>
                    </div>
				...
				<div class="form-group">
                      <label class="col-sm-3 control-label">PO Status</label>
                      <div class="col-sm-5">
						<select id="po_status" name="po_status" class="form-control" tabindex="7" value="{$master.po_status}" >
						<option id"{$master.po_status}" value="{$master.po_status}" selected="selected">{$master.po_status}</option>
						<option value="">----Select------</option>
						<option value="Pending">Pending</option>
					  <option value="Mail Sent">Mail Sent</option>
					  <option value="Order Placed">Order Placed</option>
				...
				<div class="form-group"  >
                      <label class="col-sm-3 control-label">Quote Refer Id</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_ref_id" name="quote_ref_id" tabindex="9" value="{$master.quote_ref_id}" placeholder="Quote Reference Id" autocomplete="off">					<input type="hidden" class="form-control" id="timestamp" name="timestamp" value="{$smarty.now|date_format:'%Y-%m-%d &amp; %I:%M:%S %p'}">
						<input type="hidden" class="form-control" id="created_date" name="created_date" value="{$smarty.now|date_format:'%Y-%m-%d'}">
						<input type="hidden" class="form-control" id="created_time" name="created_time" value="{$smarty.now|date_format:'%I:%M:%S %p'}">
                      </div>
					  </div>
					...
					<div class="form-group" >
                      <label class="col-sm-3 control-label">Mobile No </label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No" value="{$master.supplier_mobile_no}" maxlength="10" tabindex="13" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off" readonly="true">
                      </div>
                    </div>
                      ...
                      <label class="col-sm-3 control-label">Address</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address" name="address" value="{$master.supplier_address}" tabindex="15" placeholder="Address" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Area</label>
                      <div class="col-sm-5">
                       <input type="text" class="form-control" id="area" name="area" value="{$master.area}" tabindex="17" placeholder="Area" autocomplete="off" readonly="true">  
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Delivered To</label>
                      <div class="col-sm-5">
						<select id="deliver_to" name="deliver_to" class="form-control" tabindex="19" value="{$master.deliver_to}" >
						<option id"{$master.deliver_to}" value="{$master.deliver_to}" selected="selected">{$master.deliver_to}</option>
					  <option value="">---Select---</option>
					  <option value="Asian Engineering">Asian Engineering</option>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">City</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="city" name="city" tabindex="21" value="{$master.city}" placeholder="City" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group" style="border-bottom: 1px solid #d6d2d2;"></div>
                      ...
                      <label class="col-sm-3 control-label">Created By</label>
                      <div class="col-sm-5">
                    <input type="text" class="form-control" id="created_by" name="created_by" tabindex="21" value="{$smarty.session.UserName}" readonly="true" autocomplete="off" >
                      </div>
                    </div>
					{/foreach}
					{/if}
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                      <select id="item_type" name="item_type" class="form-control" tabindex="22" onChange="Event();" autocomplete="off" value="{$smarty.post.item_type}">
					  <option value="" >----Select----</option>
					...
					<!--**********************************************************-->
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="po_date" name="po_date"  placeholder="PO Date" tabindex="2" value="{$smarty.post.po_date}" onClick="doOnLoad();"  readonly="true" autocomplete="off"/>
                      </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_code" name="supplier_code" tabindex="4" value="{$smarty.post.supplier_code}" placeholder="Supplier Code" autocomplete="off" readonly="true">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
						<select id="payment_status" name="payment_status"  class="form-control" tabindex="6" value="{$smarty.post.payment_status}" autocomplete="off"placeholder="Payment Status">
					  <option value="">---Select---</option>
					  <option value="Pending">Pending</option>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Quote Date</label>
                       <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_date" name="quote_date"  placeholder="Quote Date" tabindex="8" value="{$smarty.post.quote_date}" onClick="doOnLoad();" readonly="true" autocomplete="off"/>
                      </div>
					...
					<div class="form-group"> <label class="col-sm-3 control-label">Phone No</label>
					    <div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" value="{$smarty.post.area_code}" placeholder="Area Code" tabindex="10" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true">
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="{$smarty.post.phone_no}" placeholder="Phone No" tabindex="11"onKeyUp="numericFilter(this);" autocomplete="off" readonly="true" style="margin-left:-25px;">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="{$smarty.post.extension}" placeholder="Extension" tabindex="12" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true" style="margin-left:-45px;">
                       </div>
                    </div>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Supplier Mail Id</label>
                        <div class="col-sm-5">
                  <input type="email" class="form-control" id="supplier_mail" name="supplier_mail" placeholder="Supplier Mail Id" tabindex="14" value="{$smarty.post.supplier_mail}"  onKeyUp="clear_err_email_id();" autocomplete="off"  readonly="true">
                      </div>
					   </div> 
					   <div class="form-group" id="hdn_email2" style="display:none">
                      <label class="col-sm-3 control-label">Supplier Mail Id</label>
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="supplier_mail1" name="supplier_mail1" placeholder="Supplier Mail Id"  value="{$smarty.post.supplier_mail1}"  onKeyUp="clear_err_email_id();" autocomplete="off"  readonly="true">
                      </div>
					  </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Address1</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" tabindex="16" value="{$smarty.post.address1}" placeholder="Address1" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Landmark</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="landmark" name="landmark" tabindex="18" value="{$smarty.post.landmark}" placeholder="Landmark" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Pincode</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pincode" name="pincode" value="{$smarty.post.pincode}" tabindex="20" placeholder="Pincode" autocomplete="off" maxlength="6" onKeyUp="numericFilter(this);" readonly="true"/>
                      </div>
                    </div>
				...
				{foreach from=$LDList2 item=master}
					<div class="form-group">
                      <label class="col-sm-3 control-label">PO Date</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="po_date" name="po_date"  placeholder="PO Date" tabindex="1" value="{$master.po_date}" onClick="doOnLoad();"  readonly="true" autocomplete="off"/>
                      </div>
					  <a href="#"><img id="calendar_icon1" src="codebase/calendar.png"></a>
                    </div>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Supplier Code</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="supplier_code" name="supplier_code" tabindex="3" value="{$master.supplier_code}" placeholder="Supplier Code" autocomplete="off">
                      </div>
                    </div>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Payment Status</label>
                      <div class="col-sm-5">
						 <select id="payment_status" name="payment_status" class="form-control" tabindex="12" value="{$master.payment_status}" >
						<option id"{$master.payment_status}" value="{$master.payment_status}" selected="selected">{$master.payment_status}</option>
						<option value="">----Select------</option>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Quote Date</label>
                       <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_date" name="quote_date"  placeholder="quote_date" tabindex="9" value="{$master.quote_date}" onClick="doOnLoad();" readonly="true" autocomplete="off"/>
                      </div>
					  <a href="#"><img id="calendar_icon2" src="codebase/calendar.png"></a>
                    </div>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Phone No</label>
                       <div class="col-sm-2">
                        <input type="text" class="form-control" id="area_code" name="area_code" value="{$master.area_code}" placeholder="Area Code" tabindex="13" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="{$master.phone_no}" placeholder="Phone No" tabindex="14"onKeyUp="numericFilter(this);" autocomplete="off"  readonly="true" style="margin-left:-25px;">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="{$master.extension}" placeholder="Extension" tabindex="15" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true"  style="margin-left:-45px;">
                      </div>
                    </div>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Supplier Mail Id</label>
                        <div class="col-sm-5">
                  <input type="email" class="form-control" id="supplier_mail" name="supplier_mail" placeholder="Supplier Mail Id" tabindex="11" value="{$master.supplier_email}"  onKeyUp="clear_err_email_id();" autocomplete="off"  readonly="true">
                      </div>
					   </div> 
					   <div class="form-group" id="hdn_email2" style="display:none">
                      <label class="col-sm-3 control-label">Supplier Mail Id</label>
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="supplier_mail1" name="supplier_mail1" placeholder="Supplier Mail Id"  value="{$master.supplier_email}"  onKeyUp="clear_err_email_id();" autocomplete="off" readonly="true">
                      </div>
					  </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Address1</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" tabindex="13" value="{$master.supplier_address1}" placeholder="Address1" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Landmark</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="landmark" name="landmark" tabindex="15" value="{$master.landmark}" placeholder="Landmark" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Pincode</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pincode" name="pincode" value="{$master.pincode}" tabindex="16" placeholder="Pincode" autocomplete="off" maxlength="6" readonly="true">
                      </div>
                    </div>
					<div class="form-group"></div><div class="form-group"></div><div class="form-group"></div>
					{/foreach}
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                       <input type="text" class="form-control" id="product_desc" name="product_desc" placeholder="Product Desc" value="{$smarty.post.product_desc}" tabindex="23" onKeyUp="text_filter(this);">
						<input type="text" class="form-control" id="material_name" name="material_name" placeholder="Material Name" value="{$smarty.post.material_name}" tabindex="4" onKeyUp="text_filter(this);" style="display:none">
                      </div>
                    </div>
					<div class="form-group">
