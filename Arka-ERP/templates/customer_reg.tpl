        ...
        <section class="content">
		 ...
		 {/if}
                  <div class="box-body">
				   <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="customer_id" name="customer_id" value="{$c_id}" placeholder="Customer Id" readonly="true"  autocomplete="off" tabindex="1">
                      </div>
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
					  <div class="col-sm-3 ">
                        <input type="text" class="form-control" id="customer_fname" name="customer_fname" placeholder="First name" value="{$smarty.post.customer_fname}" tabindex="3" style="margin-left:-25px; width:130px;" onKeyUp="text_filter(this);" autocomplete="off">
					</div>
					<div class="col-sm-3 ">
						<input type="text" class="form-control" id="customer_lname" name="customer_lname" placeholder="Last name" value="{$smarty.post.customer_lname}" style="width:130px; margin-left:-30px;" tabindex="4" onKeyUp="text_filter(this);" autocomplete="off">
                      </div>
				...
				<div class="form-group" style=" margin-top:-15px;">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="place_type" name="place_type" value="{$smarty.post.place_type}" placeholder="Place Type" tabindex="6"  data-toggle="modal" data-target="#Place_Type"  autocomplete="off" >
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                      </div>
					  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="designation" name="designation" value="{$smarty.post.designation}" placeholder="Designation" tabindex="8" onKeyUp="text_filter(this);" autocomplete="off">
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="mail_id" name="mail_id" placeholder="Email Id" tabindex="10" value="{$smarty.post.mail_id}" onKeyUp="clear_err_email_id();" autocomplete="off" >
                      </div>
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="mail_id1" name="mail_id1" placeholder="Email Id 1" value="{$smarty.post.mail_id1}"  onKeyUp="clear_err_email_id();" autocomplete="off" >
                      </div>
					  </div>
					 ...
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Phone No</label>
					    <div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" placeholder="Area Code" maxlength="6" value="{$smarty.post.area_code}" tabindex="14" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="Phone No" maxlength="10" value="{$smarty.post.phone_no}" style="margin-left:-24px;" tabindex="15"onKeyUp="numericFilter(this);" autocomplete="off" >
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" placeholder="Extension" maxlength="4" value="{$smarty.post.extension}" tabindex="16" onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-46px;">
                       </div>
					...
					<div class="form-group" id="hdn_phone2" style="display:none;">
					  ...
					  <div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code1" name="area_code1" maxlength="6" value="{$smarty.post.area_code1}" placeholder="Area Code 1"  onKeyUp="numericFilter(this);" autocomplete="off" >
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no1" name="phone_no1" maxlength="10" value="{$smarty.post.phone_no1}" placeholder="Phone No 1"  onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-24px;">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension1" name="extension1" maxlength="4" value="{$smarty.post.extension1}" placeholder="extension 1"  onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-46px;" >
                       </div>
					   </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address" name="address" placeholder="Address" value="{$smarty.post.address}" tabindex="18" autocomplete="off">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" placeholder="Area" value="{$smarty.post.area}" tabindex="20" onKeyUp="text_filter(this);" autocomplete="off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="city" name="city" placeholder="City" value="{$smarty.post.city}" tabindex="22" onKeyUp="text_filter(this);" autocomplete="off">
					...
					<p id="error_cmp_name" align="center" style="color: #FF0000;"></p>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="company_name" name="company_name" value="{$smarty.post.company_name}" placeholder="Company Name" tabindex="2" autocomplete="off" onKeyUp="clear_err_name_of_cmp();text_filter(this);" onBlur="chk_exist_cmp(this);">
                      </div>
					  <font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="enquiry_through" name="enquiry_through" value="{$smarty.post.enquiry_through}" placeholder="Enquiry Through" value="TESTING" tabindex="5" data-toggle="modal" data-target="#Enquiry_Through" autocomplete="off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="reference" name="reference" value="{$smarty.post.reference}" placeholder="Reference" tabindex="7" autocomplete="off">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="d_o_b" name="d_o_b"  placeholder="Date" tabindex="9" value="{$smarty.post.d_o_b}" readonly="true" onClick="doOnLoad();"  autocomplete="off" >
                      </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No" maxlength="10" value="{$smarty.post.mobile_no}" tabindex="11" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
					...
					<div class="form-group" id="hdn_mobile2" style="display:none;">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no1" name="mobile_no1" maxlength="10" value="{$smarty.post.mobile_no2}" placeholder="Mobile No 2"  onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group" id="hdn_mobile3" style="display:none;">
                      <label class="col-sm-3 control-label">Mobile No 3</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no2" name="mobile_no2" maxlength="10" value="{$smarty.post.mobile_no3}" placeholder="Mobile No 3" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
                    </div>
					...
					<div class="form-group" style="display:none">
                      ...
                      <div class="col-sm-5">
                     <input type="text" class="form-control" id="address1" name="address1" value="{$smarty.post.address1}" placeholder="Address1" tabindex="17" autocomplete="off">
                      </div>
					  </div>
					  <div class="form-group">
                      <label class="col-sm-3 control-label">Land Mark</label>
                      <div class="col-sm-5">
                    <input type="text" class="form-control" id="landmark" name="landmark" value="{$smarty.post.landmark}" placeholder="Land Mark" tabindex="19" autocomplete="off">
                      </div>
                    </div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-5">
					   <input type="text" class="form-control" id="pincode" name="pincode" placeholder="Pincode" value="{$smarty.post.pincode}" tabindex="21" maxlength="6" onBlur="chk_exist_pin(this)" onKeyUp="numericFilter(this);" autocomplete="off">
					  </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					  </div>
						<div class="form-group">
...
<table class="table table-bordered table-striped">
                    ...
                    {foreach from=$EnqThru item=Enq}
                      <tr>
                        <td align="center"><a id="enqid"  href="#." onClick="closeit('{$Enq.description}');" data-dismiss="modal">{$Enq.description}</a></td>
					   </tr>
					     {foreachelse}
						<tr>
