...
<div id="vendor">
		<form class="form-horizontal" name="add_contact">
			...
			<input type="hidden" id="vendor_id" name="vendor_id"  value="{$smarty.get.vendor_id}"  >
				   ...
				   {foreach from=$EditContact item=Contact}
				   <input type="hidden" id="sl_no" name="sl_no" value="{$Contact.sl_no}" />
				   <input type="hidden" id="v_name" name="v_name" value="{$Contact.vendor_id}"/>
					<tr class="form-group">
                      <th class="col-sm-4 control-th">Contact Person</th>
                      <td class="col-sm-2">
					  <select name="salutation" id="salutation" class="form-control" tabindex="3" value="{$Contact.salutation}" style="width:70px;" >
					  <option>Mr</option>
					  <option>Mrs</option>
					  <option>Miss</option>
					  </select>
					  ...
					  <td class="col-sm-3">
                        <input type="text" class="form-control" id="customer_fname" name="customer_fname" placeholder="First name" value="{$Contact.vendor_contact_person_fname}" tabindex="4" style="margin-left:-105px; width:150px;" onKeyUp="text_filter(this);">
					  </td>
					  <td class="col-sm-3">
						<input type="text" class="form-control" id="customer_lname" name="customer_lname" placeholder="Last name" value="{$Contact.vendor_contact_person_lname}" style="margin-left:-25px; width:150px;" tabindex="5" onKeyUp="text_filter(this);"><td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>&nbsp;&nbsp;--></td>
                      </td>
                    </tr>
				 <tr class="form-group">
					...
					<tr class="form-group" id="hdn_mobile2" style="display:none;">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="mobile_no2" name="mobile_no2" maxlength="10" placeholder="Mobile No 2" value="{$Contact.mobile_no2}"  onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);">
                      </td>
                    </tr>
					<tr class="form-group" id="hdn_mobile3" style="display:none;">
                      <th class="col-sm-4 control-th">Mobile No 3</th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="mobile_no3" name="mobile_no3" value="{$Contact.mobile_no3}" maxlength="10" placeholder="Mobile No 3" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);">
                      </td>
                    </tr>
					 <tr class="form-group">
                      <th class="col-sm-4 control-th">Created By</th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="created_by" value="{$Contact.created_by}" name="created_by" placeholder="Created By" readonly="true" tabindex="7">
                      </td>
					</tr> 
                     <tr class="form-group">
                      <th class="col-sm-4 control-th">D O B</th>
                      <td class="col-sm-4">
                        <input type="text" class="form-control" id="d_o_b" name="d_o_b"  placeholder="Date" tabindex="8" value="{$Contact.d_o_b}" onClick="doOnLoad();"  autocomplete="off" ></td>
					...
					<tr class="form-group">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="designation" name="designation" value="{$Contact.designation}" placeholder="Designation" tabindex="9" onKeyUp="text_filter(this);">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="area" name="area" value="{$Contact.area}" placeholder="Area" tabindex="10">
               			<td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
                      </tr> 
					 <tr class="form-group">
                      <th class="col-sm-4 control-th">Phone No</th>
					    <td class="col-sm-3">
					    <input type="text" class="form-control" id="area_code" name="area_code" value="{$Contact.area_code}" placeholder="Area Code" tabindex="11" style="width:75px;" onKeyUp="numericFilter(this);" ></td>
                        <td class="col-sm-2"><input type="text" class="form-control" id="phone_no" name="phone_no" value="{$Contact.phone_no}" placeholder="Phone No" maxlength="10" style="width:100px; margin-left:-100px;" tabindex="12"onKeyUp="numericFilter(this);" ></td>
                     <td class="col-sm-2"><input type="text" class="form-control" id="extension" name="extension" placeholder="Extension" value="{$Contact.extension}" tabindex="13" style="width:100px; margin-left:-70px;" onKeyUp="numericFilter(this);" ></td>
					  ...
					  <td class="col-sm-2">
					    <input type="text" class="form-control" id="area_code1" name="area_code1" value="{$Contact.area_code1}" placeholder="Area Code 1" style="width:75px;" onKeyUp="numericFilter(this);" >
					  </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no1" name="phone_no1" value="{$Contact.phone_no1}" placeholder="Phone No 1" style="width:100px; margin-left:-100px;" onKeyUp="numericFilter(this);" >
                      </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="extension1" name="extension1" value="{$Contact.extension1}" placeholder="extension 1" style="width:100px; margin-left:-70px;" onKeyUp="numericFilter(this);" >
                       </td>
					   </tr>
					   <tr class="form-group">
                      <th class="col-sm-4 control-th">Email Id</th>
                      <td class="col-sm-6">
                        <input type="email" class="form-control" id="mail_id" name="mail_id" value="{$Contact.mail_id}" placeholder="Email Id" tabindex="14" onKeyUp="clear_err_email_id();" >
                      ...
                      <td class="col-sm-6">
                     <input type="email" class="form-control" id="mail_id1" name="mail_id1" value="{$Contact.mail_id1}" placeholder="Email Id 1"  onKeyUp="clear_err_email_id();" >
                      </td>
					  </tr>
					<tr class="form-group">
                      <th class="col-sm-4 control-th">Remarks</th>
                      <td class="col-sm-6">
                        <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks" tabindex="15">{$Contact.remarks}</textarea>
                      <td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					  </td>
                    </tr>
					{/foreach}
