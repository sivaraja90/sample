...
{foreach from=$EditBank item=Bank}
		<input type="hidden" id="vendor_id" name="vendor_id" value="{$Bank.vendor_id}">
				<tr class="form-group">
					<th class="col-sm-5 control-th" style="margin-bottom:-30px;">Account No</th>
						<td><input type="text" class="form-control" id="account_no" name="account_no" onKeyUp="numericFilter(this);" autocomplete="off" value="{$Bank.account_no}" placeholder="Account No" tabindex="1"><td></td>
						</td>
					<th class="col-sm-5 control-th">Holder Name</th>
						<td><input type="text" class="form-control" id="acc_holder" name="acc_holder" autocomplete="off" value="{$Bank.account_holder_name}"placeholder="Account Holder Name" onKeyUp="text_filter(this);" tabindex="2"> <td></td>
					</td>
				</tr> 
				<tr class="form-group">
					<th class="col-sm-5 control-th">Bank Name</th>
						<td><input type="text" class="form-control" id="bank_name" name="bank_name" autocomplete="off" value="{$Bank.bank_name}" onKeyUp="text_filter(this);" placeholder="Bank Name" tabindex="3"><td></td>
						</td>
						<th class="col-sm-5 control-th">Branch</th>
						<td>
<input type="text" class="form-control" id="branch" name="branch" autocomplete="off" value="{$Bank.branch}" onKeyUp="text_filter(this);" placeholder="Branch" tabindex="4"><td></td>
				</td>
				</tr>
				<tr class="form-group">
				<th class="col-sm-5 control-th">Area</th>
				<td>
		<input type="text" class="form-control" id="area" name="area" autocomplete="off" placeholder="Area" value="{$Bank.area}" tabindex="5" onKeyUp="text_filter(this);"><td></td>
				</td>
				<th class="col-sm-5 control-th" style="margin-bottom:-30px;">Pincode</th>
				<td><input type="text" class="form-control" id="pincode" name="pincode" autocomplete="off" placeholder="Pincode" value="{$Bank.pincode}" maxlength="6" onKeyUp="numericFilter(this);" tabindex="6" ><td></td>
				</td>
				</tr>
				<tr class="form-group">
				<th class="col-sm-5 control-th">IFSC Code</th>
						<td>
						<input type="text" class="form-control" id="ifsc_code" name="ifsc_code" autocomplete="off" placeholder="IFSC Code" value="{$Bank.ifsc_code}" tabindex="7">
						</td><td>&nbsp;</td>
					<th class="col-sm-5 control-th">Remarks</th>
						<td>
						<textarea class="form-control" id="remark" name="remark" placeholder="Remarks" tabindex="8">{$Bank.remarks}</textarea></td><td></td>
				</tr>
{/foreach}
</table>
