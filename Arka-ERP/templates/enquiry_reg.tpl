    ...
    <div class="wrapper">
      <div class="content-wrapper">
        ...
        <section class="content">
		 ...
		 {/if}		<input type="hidden" id="hdn_customer_type" name="hdn_customer_type" value="{$smarty.post.customer_type}">
                  ...
                  <div class="box-body">
				   <div class="col-md-6">
				    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="enquiry_id" name="enquiry_id" placeholder="Enquiry Id" value="{$e_id}" value="test" readonly="true" tabindex="1">
                      </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="customer_id" name="customer_id" value="{$smarty.post.customer_id}" placeholder="Customer Id" readonly="true">
						<input type="hidden" class="form-control" id="salutation" name="salutation" value="{$smarty.post.salutation}" placeholder="Salutation" readonly="true">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">
                  ...
                  <div class="col-sm-5">
					<select id="customer_name" name="customer_name" class="form-control" onChange="split_cnt_dtls(this.value);" tabindex="3" value="{$smarty.post.customer_name}">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No" readonly="true" value="{$smarty.post.mobile_no}" maxlength="10" onKeyUp = "numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);">
                      </div>
					<!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
				...
				<div class="col-sm-5">
				<input type="email" class="form-control" id="mail_id" name="mail_id" placeholder="Email Id" readonly="true" value="{$smarty.post.mail_id}" onKeyUp="clear_err_email_id();" >
				...
				<div class="col-sm-5">
				<input type="email" class="form-control" id="mail_id1" name="mail_id1" placeholder="Email Id 1" value="{$smarty.post.mail_id1}" onKeyUp="clear_err_email_id();" >
				</div>
				</div>
					...
					<div class="form-group" id="closedDate" style="display:none">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="closed_date" name="closed_date"  placeholder ="Closed Date" value="{$smarty.post.closed_date}" onClick="doOnLoad();" readonly="true">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address" name="address" placeholder="Address" value="{$smarty.post.address}" readonly="true">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" placeholder="Address1" value="{$smarty.post.address1}" readonly="true">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					  </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" placeholder="Area" value="{$smarty.post.area}" onKeyUp="text_filter(this);" readonly="true">
                      </div>
					 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                      <input type="text" class="form-control" id="landmark" name="landmark" placeholder="Land Mark" value="{$smarty.post.landmark}" readonly="true">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="city" name="city" placeholder="City" value="{$smarty.post.city}" onKeyUp="text_filter(this);" readonly="true">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					  </div>
					...
					<div class="col-sm-5">
					<input type="text" class="form-control" id="pincode" name="pincode" placeholder="Pincode" value="{$smarty.post.pincode}" maxlength="6" onBlur="chk_exist_pin(this)" onKeyUp="numericFilter(this);" readonly="true">
					</div>
					<!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					</div>
                      ...
                      <div class="col-sm-5">
                   <select id="pg" name="pg" class="form-control" value="{$smarty.post.pg}"  tabindex="11" onChange="pg_select();">
					...
					<!--**********************************************************-->
                     <div class="col-md-6">
                      ...
                      <div class="col-sm-5">
                      <input type="text" class="form-control" id="company_name" name="company_name" value="{$smarty.post.company_name}" placeholder="Company Name" tabindex="2" onKeyUp="text_filter(this);">
                      </div>
					  <!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="designation" name="designation" placeholder="Designation" readonly="true" value="{$smarty.post.designation}" onKeyUp="text_filter(this);">
					...
					<div class="col-sm-2">
					<input type="text" class="form-control" id="closed_hours" name="closed_time"  placeholder="Hours" value="{$smarty.post.closed_hours}" onKeyUp="HourFilter(this);" onClick="doOnLoad();" autocomplete="OFF" >
					</div>
					<div class="col-sm-2">
					<input type="text" class="form-control" id="closed_minutes" name="closed_minutes" placeholder="Minutes"  value="{$smarty.post.closed_minutes}" style="margin-left:-25px;" onKeyUp="MinuteFilter(this);" autocomplete="OFF" >
					</div>
					<div class="col-sm-2">
                      ...
                      <div class="col-sm-5">
						...
						<option value="Defered" >Defered</option>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-5">
																	<select id="arka_group" name="arka_group" class="form-control" value="{$smarty.post.arka_group}" tabindex="4">
																	<option value="">----Select------</option>
															...
															<div class="col-sm-5">
															<select id="enquiry_type" name="enquiry_type" class="form-control" value="{$smarty.post.enquiry_type}"  tabindex="5">
															<option value="">----Select------</option>
														...
														<!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
																			...
																			<div class="form-group" id="snzDate">
																										...
																										<div class="col-sm-5">
																											<input type="text" class="form-control" id="snooze_date" name="snooze_date" placeholder ="Snooze Date" onClick="doOnLoad();" value="{$smarty.post.snooze_date}" tabindex="6" readonly="true">
																										</div>
																				 <!-- &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>-->
					...
					<div class="form-group" id="PoNo" style="display:none">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="po_no" name="po_no" placeholder="Po No" value="{$smarty.post.po_no}" onClick="doOnLoad();" value="HH-MM-SS" tabindex="11">
                      </div>
                    </div>
					   ...
					   <div class="form-group">
						  ...
						  <div class="col-sm-5">
							<input type="text" class="form-control" id="enquiry_through" name="enquiry_through" value="{$smarty.post.enquiry_through}" placeholder="Enquiry Through" value="TESTING" tabindex="6" data-toggle="modal" data-target="#Enquiry_Through" autocomplete="Off">
						  </div>
						</div>
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Reference Id</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="reference_id" name="reference_id" placeholder="Reference Id" value="{$smarty.post.reference_id}" tabindex="7" value="TESTING" autocomplete="Off">
                      </div>
					 ...
					 <div class="form-group">
					  ...
					  <select id="assign_to" name="assign_to" class="form-control" onBlur="Assign();" value="{$smarty.post.assign_to}" tabindex="8" >
					...
					{/foreach}
						...
						<div class="col-sm-5">
						<input type="text" class="form-control" id="requirement" name="requirement" value="{$smarty.post.requirement}" autocomplete="off" placeholder="requirement"  tabindex="9"  data-toggle="modal" data-target="#Requirement" autocomplete="Off">
						</div>
						</div>
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="branch" name="branch" placeholder="Branch" value="{$smarty.post.branch}" tabindex="10">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks" value="{$smarty.post.remarks}" tabindex="12"></textarea>
                      </div>
                    </div>
