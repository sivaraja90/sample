			...
			<input type="hidden" id="vendor_id" name="vendor_id"  value="{$smarty.get.vendor_id}"  >
				   ...
				   <table class="col-md-6">
					<tr class="form-group">
                      ...
                      <td class="col-sm-2">
					  <select id="salutation" name="salutation"  class="form-control" tabindex="3" value="{$smarty.post.salutation}" style="width:70px;" autocomplete="off" >
					  <option>Mr</option>
					  <option>Mrs</option>
					  <option>Miss</option>
					  </select>
					  ...
					  <td class="col-sm-3">
                        <input type="text" class="form-control" id="customer_fname" name="customer_fname" placeholder="First name" value="{$smarty.post.customer_fname}" tabindex="4" style="margin-left:-105px; width:150px;" onKeyUp="text_filter(this);" autocomplete="off">
					  </td>
					  <td class="col-sm-3">
						<input type="text" class="form-control" id="customer_lname" name="customer_lname" placeholder="Last name" value="{$smarty.post.customer_lname}" style="margin-left:-25px; width:150px;" tabindex="5" onKeyUp="text_filter(this);" autocomplete="off"><td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>&nbsp;&nbsp;--></td>
                      </td>
                    </tr>
 <tr class="form-group">
                      <th class="col-sm-4 control-th">DOB</th>
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="d_o_b" name="d_o_b" value="{$smarty.post.d_o_b}"  placeholder="Date" onClick="doOnLoad();" tabindex="6" readonly="true"  autocomplete="Off"></td><td>
				 ...
				 <tr class="form-group">
					...
					<tr class="form-group">
                      ...
                      <td class="col-sm-6">
                        <input type="text" class="form-control" id="area" name="area" value="{$smarty.post.area}" placeholder="Area" tabindex="9" autocomplete="off" onKeyUp="text_filter(this);">
               			<td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
                      </tr> 
					 <tr class="form-group">
                      <th class="col-sm-4 control-th">Phone No</th>
					    <td class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" value="{$smarty.post.area_code}" placeholder="Area Code" tabindex="10" style="width:75px;" onKeyUp="numericFilter(this);" autocomplete="off" >
					  </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="{$smarty.post.phone_no}" placeholder="Phone No" style="width:100px; margin-left:-100px;" tabindex="11"onKeyUp="numericFilter(this);" autocomplete="off" >
                      </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" placeholder="Extension" value="{$smarty.post.extension}" tabindex="12" style="width:100px; margin-left:-70px;" onKeyUp="numericFilter(this);" autocomplete="off">
						</td>
   					   <td class="col-sm-2">&nbsp;&nbsp;<input type="button" class="btn btn-danger btn-xs" value="ADD PHONE" style="margin-left:-120px;" onClick="add_more_phone();"><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					  ...
					  <td class="col-sm-2">
					    <input type="text" class="form-control" id="area_code1" name="area_code1" value="{$smarty.post.area_code1}" placeholder="Area Code 1" style="width:75px;" onKeyUp="numericFilter(this);" autocomplete="off">
					  </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no1" name="phone_no1" value="{$smarty.post.phone_no1}" placeholder="Phone No 1" style="width:100px; margin-left:-100px;" onKeyUp="numericFilter(this);" autocomplete="off">
                      </td>
                      <td class="col-sm-2">
                        <input type="text" class="form-control" id="extension1" name="extension1" value="{$smarty.post.extension1}" placeholder="extension 1" style="width:100px; margin-left:-70px;" onKeyUp="numericFilter(this);" autocomplete="off">
                       </td>
					   </tr>
					   <tr class="form-group">
                      <th class="col-sm-4 control-th">Email Id</th>
                      <td class="col-sm-6">
                        <input type="email" class="form-control" id="mail_id" name="mail_id" value="{$smarty.post.mail_id}" placeholder="Email Id" tabindex="13" onKeyUp="clear_err_email_id();" autocomplete="off">
					...
					<tr class="form-group">
                      ...
                      <td class="col-sm-6">
                        <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks" value="{$smarty.post.remarks}" tabindex="14" autocomplete="off"></textarea>
                      <td><!--&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
					  </td>
                    </tr>
					</table>
