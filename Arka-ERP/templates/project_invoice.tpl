			...
			<input type="hidden" id="enquiry_id" name="enquiry_id" value="{$View.enquiry_id}">
				...
				<input type="hidden" id="quote_date" name="quote_date" value="{$View.quote_date}">
					<input type="hidden" id="project_order_no" name="project_order_no" value="{$View.project_order_no}">
						...
						<input type="hidden"  id="revised_version" name="revised_version" value="{$View.revised_version}" >
	...
	<td class="col-sm-3">
		<tr class="form-group">	
				...
				<th class="col-sm-2 control-th">Project Order Number</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="project_order_no" name="project_order_no" value="{$smarty.get.project_order_no}" tabindex="2" readonly="true">
