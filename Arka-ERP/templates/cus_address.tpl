	...
	<td class="col-sm-3">
				...
				<tr class="form-group">
					...
					<th class="col-sm-5 control-th" >Created By</th>
						<td>
						<input type="text" class="form-control" id="created_by" name="created_by" value="{$smarty.session.UserName}" placeholder="Created By" tabindex="8" readonly="true"><td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
				</tr>
</td>
</tr>
