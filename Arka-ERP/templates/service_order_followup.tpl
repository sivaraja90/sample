...
{/literal}
		...
		<form class="form-horizontal" name="add_address"><body onLoad="doOnLoad();">
			...
			<input type="hidden" id="enquiry_id" name="enquiry_id" value="{$View.enquiry_id}">
				...
				<input type="hidden" id="service_quote_date" name="service_quote_date" value="{$View.service_quote_date}">
					<input type="hidden" id="service_order_no" name="service_order_no" value="{$View.service_order_no}">
						...
						<input type="hidden" class="form-control" id="revised_no" name="revised_no" value="{$View.service_quote_revise_no}" >
...
<tr class="form-group">
	<td class="col-sm-3">
		<tr class="form-group">	
					...
					<th class="col-sm-2 control-th" >Enquiry Id</th>
						<td class="col-sm-5" >
					<input type="text" class="form-control" id="enquiry_id" name="enquiry_id" placeholder="Enquiry Id  " tabindex="1" value="{$smarty.get.enquiry_id}" readonly="true">
	...
	<input type="text" class="form-control" id="closed_date" name="closed_date" placeholder="closed date" tabindex="7" value="{$smarty.post.closed_date}" readonly="true"></td>
					...
					<th class="col-sm-2 control-th">Remarks</th>
						<td class="col-sm-5">
					 <textarea class="form-control" id="remarks"  name="remarks" value="{$smarty.post.remarks}" placeholder="Remarks" tabindex="12" autocomplete="off" value="{$smarty.post.remarks}"></textarea> 
						</td>
		    </tr> 
	</td>
	</tr>
