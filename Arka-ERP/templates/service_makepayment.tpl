...
{/literal}
		...
		<form class="form-horizontal" name="make_payment"><body>
			...
			<input type="hidden" id="customer_id" name="customer_id"  value="{$smarty.get.customer_id}"  >
					...
					<input type="hidden" id="service_order_no" name="service_order_no" value="{$smarty.get.service_order_no}">
...
<select id="invoice_no" name="invoice_no" class="form-control"  value="{$smarty.post.invoice_no}" tabindex="1" onChange="Fill_Name_of_Clr();">
				...
				<th class="col-sm-2 control-th" >Invoice Amount</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="invoice_amount" name="invoice_amount"  tabindex="2" value="{$smarty.post.invoice_amount}" readonly="true" autocomplete="Off" Placeholder="Invoice Amount">
						</td>
			...
			<tr class="form-group">
					<th class="col-sm-2 control-th" >Pending Amount</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="pending_amount" name="pending_amount" placeholder="Pending Amount" tabindex="3" value="{$smarty.post.pending_amount}" readonly="true" autocomplete="Off">
					...
					<th class="col-sm-2 control-th" >Paid Amount</th>
						<td class="col-sm-2">
						<input type="text" class="form-control" id="paid_amount" name="paid_amount" placeholder="Paid Amount" value="{$smarty.post.paid_amount}" tabindex="4" autocomplete="Off" onKeyUp="numericFilter(this);calc();status_change();">
						 </td>
		            </tr>
		  ...
		  <th class="col-sm-2 control-th">Payment Reference</th>
						<td class="col-sm-5">
					 <input type="text" class="form-control" id="payment_ref"  name="payment_ref" placeholder="Payment Ref" value="{$smarty.post.payment_mode}" tabindex="7" autocomplete="off">
						</td>
						 <td class="col-sm-5">
						</td>
