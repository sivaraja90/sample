...
List Enquiry Mail</label></i></a></small>&ensp;&ensp;&ensp;
          </h4>
         </section>
        <!-- Main content -->
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-info">
				...
				<br><br>
				   <div class="box-body">
				  {foreach from=$enqMailDetail item=enqMail}	
				  	<div class="col-md-6">
