	...
	<td class="col-sm-3">
		<tr class="form-group">	
				<th class="col-sm-2 control-th">Project Quote No </th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="project_quote_no" name="project_quote_no"  value="{$smarty.get.project_quote_no}" readonly="true"  tabindex="1" placeholder="Project Quote No">  </td>	
						{foreach from=$ProjectQuote item=reviseMaster}
					<input type="hidden" class="form-control" id="customer_name" name="customer_name" value="{$reviseMaster.customer_name}"  >
						<input type="hidden" class="form-control" id="company_name" name="company_name" value="{$reviseMaster.company_name}"  >
						<input type="hidden" class="form-control" id="salutation" name="salutation" value="{$reviseMaster.salutation}"  >
						<input type="hidden" class="form-control" id="enquiry_id" name="enquiry_id"value="{$reviseMaster.enquiry_id}" >
						<input type="hidden" class="form-control" id="customer_id" name="customer_id" value="{$reviseMaster.customer_id}" readonly="true">
						<input type="hidden" class="form-control" id="revised_version" name="revised_version" value="{$r_version}"/>
						<input type="hidden" class="form-control" id="mobile_no" name="mobile_no" value="{$reviseMaster.mobile_no}">
						<input type="hidden" class="form-control" id="address" name="address" value="{$reviseMaster.address}">
						<input type="hidden" class="form-control" id="address1" name="address1" value="{$reviseMaster.address1}">
						<input type="hidden" class="form-control" id="city" name="city" value="{$reviseMaster.city}">
						<input type="hidden" class="form-control" id="area_code" name="area_code" value="{$reviseMaster.area_code}">
						<input type="hidden" class="form-control" id="phone_no" name="phone_no" value="{$reviseMaster.phone_no}" >
						<input type="hidden" class="form-control" id="extension" name="extension" value="{$reviseMaster.extension}">
						<input type="hidden" class="form-control" id="created_by" name="created_by" tabindex="25"  value="{$smarty.session.UserName}"/>
						<input type="hidden" class="form-control" id="company_name" name="company_name" value="{$reviseMaster.company_name}">
						<input type="hidden" class="form-control" id="area" name="area" value="{$reviseMaster.area}" >
						<input type="hidden" class="form-control" id="pincode" name="pincode" maxlength="6" value="{$reviseMaster.pincode}">
						<input type="hidden" class="form-control" id="email" name="email" value="{$reviseMaster.email}">
						<input type="hidden" class="form-control" id="email1" name="email1" value="{$reviseMaster.email1}" />
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="{$reviseMaster.quote_date}" placeholder="Quote Date" onClick="doOnLoad();" tabindex="3" readonly="">
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" placeholder="ex :  50%" id="payment" name="payment" value="{$ProjectTerm.0.payment}"  tabindex="3" autocomplete="Off">
					...
					<tr class="form-group" >
						...
						<td class="col-sm-5">
						 <input type="text" class="form-control" placeholder="ex : 2 to 3 Weeks" id="delivery" name="delivery" value="{$ProjectTerm.0.delivery}" tabindex="4" autocomplete="Off">
						<td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						<th class="col-sm-2 control-th">Validity</th>
						<td class="col-sm-5">
					<select id="validity" name="validity" class="form-control" value="{$ProjectTerm.0.validity}" tabindex="5" >
		  ...
		  <tr class="form-group">
				...
				<tr class="form-group">
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="total" name="total"  tabindex="21" value="{$smarty.post.total}" onKeyUp="numericFilter(this);" autocomplete="Off">
						<td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>				
				...
				<form name="ProjectList" id="ProjectList" method="post">
                  <table id="example2" class="table table-bordered table-striped" style="font-size:13px; font-family:'Times New Roman', Times, serif;">
					...
					<tr id="{$i++}">        
								...
								<td align="center"><a href="#" onClick="Javascript:viewCats('{$Contact.customer_id}')">{$Contact.product_description}</a></td>
							...
							<td align="center"> &nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onClick="Javascript:deleteCat('{$Contact.sl_no}','{$smarty.get.revised_version}','{$smarty.get.project_quote_no}','{$Contact.total}','{$Contact.sub_total}')"><i class="fa fa-trash"></i></a></td>	 
...
function deleteCat(CatIdent,CusIdent,Project,Total,Sub){
  if(confirm("Are you sure to Delete this Content?")){
  FormName	= document.ProjectList;
   FormName.action= "project_revise_quote.php?sl_no="+CatIdent+"&revised_version="+CusIdent+"&project_quote_no="+Project+"&total="+Total+"&sub_total="+Sub;
    FormName.submit();
 }
 }
     </script>
