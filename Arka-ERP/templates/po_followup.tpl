...
<input type="hidden" class="form-control" id="po_date" name="po_date" placeholder="Po Date" tabindex="9" onClick="doOnload();" value="{$View.po_date}" readonly="true">
{/foreach}
				<th class="col-sm-2 control-th">Po No</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="po_no" name="po_no" value="{$smarty.post.po_no}"  tabindex="1"/ readonly="true">
						<input type="hidden" class="form-control" id="po_nos" name="po_nos" value="{$smarty.get.po_no}"  tabindex="1"/ readonly="true">
						</td>
						<td class="col-sm-5">
						</td>
				...
				<th class="col-sm-2 control-th"> Po Status</th>
				 ...
				 <tr class="form-group">
					<th class="col-sm-2 control-th">Remarks</th>
						<td class="col-sm-5">
					 <textarea class="form-control" id="remarks"  name="remarks" value="{$smarty.post.remarks}" placeholder="Remarks" tabindex="26" autocomplete="off" value="{$smarty.post.remarks}"></textarea> 
						</td>
		    </tr> 
