...
function validate_phone(data)
{
       ...
       function validate_fields()
		...
		var fields=["salutation","customer_fname","customer_lname","mobile_no","d_o_b","designation","area_code","phone_no","mail_id"];
	...
	<body class="hold-transition skin-blue sidebar-mini" onLoad="doOnLoad();">
		...
		<form class="form-horizontal" name="add_contact">
			...
			<input type="hidden" id="customer_id" name="customer_id"  value="{$smarty.get.customer_id}"  >
				   ...
				   <input type="hidden" id="s_no" name="s_no" value="{$Contact.sl_no}" />
				   <input type="hidden" id="c_name" name="c_name" value="{$Contact.customer_id}"/>
					<tr class="form-group">
                      <th class="col-sm-4 control-th">Sales Order No</th>
                      <td class="col-sm-2">
					   <input type="text" class="form-control" id="sales_order_no" name="sales_order_no" placeholder="Sales Order No" value="{$smarty.get.sales_order_no}" maxlength="10" tabindex="7" style="width:150;" >
					  
					  </td>
					  <th class="col-sm-4 control-th">Sales Quote No</th>
                      <td class="col-sm-2">
					   <input type="text" class="form-control" id="sales_quote_no" name="sales_quote_no" placeholder="Sales Quote No" value="{$Contact.sales_quote_no}" maxlength="10" tabindex="7" style="width:150;" >
					   </td>
					   </tr>
					  <tr class="form-group">
					  <th class="col-sm-4 control-th">Enquiry ID</th>
						<td class="col-sm-2">
						<input type="text" class="form-control" id="enquiry_id" name="enquiry_id" value="{$Contact.enquiry_id}"  tabindex="1"/ readonly="true">
						</td>
						
				<th class="col-sm-4 control-th"> Enquiry Status</th>
						<td class="col-sm-2" >
						<!--<input type="text" class="form-control" id="enquriy_status" name="enquriy_status" placeholder="Enquriy Status " tabindex="2"/>-->
						<select id="enquiry_status" name="enquiry_status" class="form-control"  value="{$Contact.enquiry_status}" tabindex="2" onChange="enquiryStatus();">
					...
					<th class="col-sm-4 control-th" >Snooze Date</th>
						<td class="col-sm-2" >
			<input type="text" class="form-control" id="snooze_date" name="snooze_date" placeholder="snooze date " tabindex="9" value="{$Contact.snooze_date}" readonly="true">
			<a href="#"><img id="calendar_icon1" src="codebase/calendar.png"></a></td>
						
				
					<th class="col-sm-4 control-th" >Snooze Time</th>
						<td class="col-sm-2">
						<input type="text"  class="form-control" id="snooze_hours" name="snooze_hours" placeholder="Hours"  value="{$Contact.snooze_hours}"  onKeyUp="HourFilter(this);" style="width:68px;" tabindex="11" autocomplete="OFF" >
						 </td>
						 <td class="col-sm-2" >
						 <input type="text" class="form-control" id="snooze_minutes" name="snooze_minutes" placeholder="minutes"  value="{$Contact.snooze_minutes}" tabindex="8" style="width:68px; margin-left:-115px;" onKeyUp="MinuteFilter(this);" autocomplete="OFF" >
						 </td>
						 <td class="col-sm-2" >
						  <input type="text" class="form-control" id="snooze_seconds" name="snooze_seconds" placeholder="Seconds" value="{$Contact.snooze_seconds}"tabindex="9" style="width:68px; margin-left:-65px;" onKeyUp="SecondFilter(this);" autocomplete="OFF" >
						</td>
		  </tr>
		  
		    <tr class="form-group" id="PoNo" style="display:none" >
											<th class="col-sm-4 control-th" >PO Date</th>
						<td class="col-sm-2" >
						<input type="text" class="form-control" id="po_date" name="po_date" placeholder="Po Date"  onClick="doOnLoad();" value="{$Contact.po_date}">					
						<td ><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--><a href="#"><img id="calendar_icon3" src="codebase/calendar.png"></a></td>
						</td>
				

						<th class="col-sm-4 control-th" >PO No</th>
						<td class="col-sm-2" >
						 <input type="text"  class="form-control" id="po_no" name="po_no" placeholder="Po No" value="{$Contact.po_no}" onClick="doOnLoad();" value="HH-MM-SS" tabindex="11" >
						<td ><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
		  </tr>  
		         <tr class="form-group" id="closedDate" style="display:none" >
					<th class="col-sm-4 control-th" >Closed Date</th>
						<td class="col-sm-2" >
						<input type="text" class="form-control" id="closed_date" name="closed_date" placeholder="closed date" tabindex="9" value="{$Contact.closed_date}" readonly="true">
						<td ><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--><a href="#"><img id="calendar_icon2" src="codebase/calendar.png"></a></td>
						</td>
				
					<th class="col-sm-4 control-th" >Closed Time</th>
						<td class="col-sm-2">
						<input type="text" class="form-control" id="closed_hours" name="closed_hours"  placeholder="Hours"   value="{$Contact.closed_hours}" onKeyUp="HourFilter(this);" style="width:68px;" autocomplete="OFF" >
						 </td>
						 <td class="col-sm-2" >
						 <input type="text" class="form-control" id="closed_minutes" name="closed_minutes" placeholder="Minutes"  value="{$Contact.closed_minutes}" tabindex="8" style="width:68px; margin-left:-115px;" onKeyUp="MinuteFilter(this);" autocomplete="OFF" >
						 </td>
						 <td class="col-sm-2" >
						  <input type="text" class="form-control" id="closed_seconds" name="closed_seconds" placeholder="Seconds" value="{$Contact.closed_seconds}" tabindex="9" style="width:68px; margin-left:-65px;" onKeyUp="SecondFilter(this);" autocomplete="OFF" >
						<td ><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
		  </tr>  
