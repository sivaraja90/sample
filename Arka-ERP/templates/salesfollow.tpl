...
{/literal}
		...
		<form class="form-horizontal" name="add_address"><body onLoad="doOnLoad();">
			...
			<input type="hidden" id="enquiry_id" name="enquiry_id" value="{$View.enquiry_id}">
				<input type="hidden" id="sales_quote_no" name="sales_quote_no" value="{$View.sales_quote_no}">	
				<input type="hidden" id="sales_quote_date" name="sales_quote_date" value="{$View.quote_date}">
					<input type="hidden" id="sales_order_no" name="sales_order_no" value="{$View.sales_order_no}">
						<input type="hidden" id="sales_order_date" name="sales_order_date" value="{$View.sales_order_date}">
						<input type="hidden" id="po_no" name="po_no" value="{$View.po_no}">
						<input type="hidden" id="po_date" name="po_date" value="{$View.po_date}">
						<input type="hidden"  id="revised_no" name="revised_no" value="{$View.sales_quote_revise_no}" >
...
<tr class="form-group">
	<td class="col-sm-3">
		<tr class="form-group">	
				...
				<th class="col-sm-2 control-th">Enquiry Id</th>
						<td class="col-sm-5">
						<input type="hidden" class="form-control" id="sales_order_no" name="sales_order_no" value="{$smarty.get.sales_order_no}"  readonly="true">
						<input type="text" class="form-control" id="enquiry_id" name="enquiry_id" value="{$smarty.get.enquiry_id}"  readonly="true" tabindex="1">
						</td>
						<td class="col-sm-5">
				...
				<th class="col-sm-2 control-th"> Order Status</th>
						...
						<select id="order_status" name="order_status" class="form-control"  value="{$smarty.post.order_status}" tabindex="2" onChange="orderStatus();">
			...
			<th class="col-sm-2 control-th" >PO Date</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="po_date" name="po_date" placeholder="Po Date"  onClick="doOnLoad();" value="{$AddressView.0.po_date}">					
						...
						<td class="col-sm-5" >
						 <input type="text"  class="form-control" id="po_no" name="po_no" placeholder="Po No" value="{$AddressView.0.po_no}" tabindex="" onClick="doOnLoad();">
			...
			<tr class="form-group">
					<th class="col-sm-2 control-th" >Snooze Date</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="snooze_date" name="snooze_date" placeholder="snooze date " tabindex="3" value="{$smarty.post.snooze_date}" readonly="true">
						...
						<td class="col-sm-5">
						<input type="text" class="form-control" id="created_by" name="created_by" placeholder=" created by" tabindex="11" onKeyUp="text_filter(this);" value="{$smarty.session.UserName}" readonly="true">
						<td><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
	...
	<input type="text" class="form-control" id="closed_date" name="closed_date" placeholder="closed date" tabindex="7" value="{$smarty.post.closed_date}" readonly="true"></td>
					...
					<th class="col-sm-2 control-th">Remarks</th>
						<td class="col-sm-5">
					 <textarea class="form-control" id="remarks"  name="remarks" value="{$smarty.post.remarks}" placeholder="Remarks" tabindex="12" autocomplete="off"></textarea> 
						</td>
		    </tr> 
