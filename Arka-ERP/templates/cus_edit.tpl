...
{/literal}
	...
	<body class="hold-transition skin-blue sidebar-mini" onLoad="doOnLoad();">
		...
		<form class="form-horizontal" name="add_address">
			...
			<input type="hidden" id="sl_no" name="sl_no" value="{$View.sl_no}">
	...
	<td class="col-sm-3">
		<tr class="form-group">	
				...
				<th class="col-sm-2 control-th"> Enquiry Status</th>
						...
						{if $Contact.enquiry_status eq "Pending" }
					...
					<th class="col-sm-2 control-th" >Snooze Time</th>
						...
						<input type="text"  class="form-control" id="snooze_hours" name="snooze_hours" placeholder="Hours"  value="{$Contact.snooze_hours}"  onKeyUp="HourFilter(this);" style="width:68px;" tabindex="11" autocomplete="OFF" >
						 ...
						 <td class="col-sm-2" >
						 <input type="text" class="form-control" id="snooze_minutes" name="snooze_minutes" placeholder="minutes"  value="{$Contact.snooze_minutes}" tabindex="8" style="width:68px; margin-left:-100px;" onKeyUp="MinuteFilter(this);" autocomplete="OFF" >
						 </td>
						 <td class="col-sm-2" >
						  <input type="text" class="form-control" id="snooze_seconds" name="snooze_seconds" placeholder="Seconds" value="{$Contact.snooze_seconds}"tabindex="9" style="width:68px; margin-left:-60px;" onKeyUp="SecondFilter(this);" autocomplete="OFF" >
			...
			<th class="col-sm-2 control-th" >PO Date</th>
						...
						<td class="col-sm-5" >
						 <input type="text"  class="form-control" id="po_no" name="po_no" placeholder="Po No" value="{$Contact.po_no}" tabindex="20" onClick="doOnLoad();" value="HH-MM-SS" tabindex="11">
						<td ><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
		  </tr>  
		         ...
		         <tr class="form-group" id="closedDate" style="display:none" >
					...
					<th class="col-sm-2 control-th" >Closed Time</th>
						<td class="col-sm-2">
						<input type="text" class="form-control" id="closed_hours" name="closed_hours"  placeholder="Hours"  tabindex="16" value="{$Contact.closed_hours}" onKeyUp="HourFilter(this);" style="width:68px;" onClick="doOnLoad();" autocomplete="OFF" >
						 </td>
						 <td class="col-sm-2" >
						 <input type="text" class="form-control" id="closed_minutes" name="closed_minutes" placeholder="Minutes"  value="{$Contact.closed_minutes}" tabindex="8" style="width:68px; margin-left:-100px;" onKeyUp="MinuteFilter(this);" autocomplete="OFF" >
						 </td>
						 <td class="col-sm-2" >
						  <input type="text" class="form-control" id="closed_seconds" name="closed_seconds" placeholder="Seconds" value="{$Contact.closed_seconds}" tabindex="9" style="width:68px; margin-left:-60px;" onKeyUp="SecondFilter(this);" autocomplete="OFF" >
						<td ><!--&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>--></td>
						</td>
		  </tr>  
		   ...
		   <tr class="form-group">
					...
					<th class="col-sm-2 control-th">Remarks</th>
						<td class="col-sm-5">
					 <textarea class="form-control" id="remarks"  name="remarks" value="{$Contact.remarks}" placeholder="Remarks" tabindex="26" autocomplete="off"></textarea> 
						</td>
		    </tr> 
