...
<form name="MailAdd" id="MailAdd" method="post" enctype="multipart/form-data">
		<input type="hidden" name="hdAction">
			...
			{foreach from=$EnqPromailview item=prodMail}
				<tr class="taglist2">
				<td>&nbsp;</td>
				{if $prodMail.mail_id neq "" }
				<td ><input type="checkbox" name="check1" id="check1" onClick="dynInput(this);" value="{$prodMail.mail_id}" />{$prodMail.mail_id}</td>
				{/if}
				{if $prodMail.mail_id1 neq "" }
				<td><input type="checkbox" name="check2" id="check2" onClick="dynInput(this);" value="{$prodMail.mail_id1}" />{$prodMail.mail_id1}</td>
				{/if}
				</tr>
				{/foreach}
				<tr>
