        ...
        <section class="content">
          ...
          <div class="box box-info">
			...
			<form class="form-horizontal" name="add_user" enctype="multipart/form-data">
			 ...
			 <input type="hidden" id="test" name="test" value="123">
					...
					<input type="hidden" id="hdn_salutation" name="hdn_salutation" value="{$smarty.post.hdn_salutation}">
					...
					<input type="hidden" id="salutation" name="salutation" value="{$smarty.post.salutation}">
					<input type="hidden" id="emp_first_name" name="emp_first_name" value="{$smarty.post.emp_first_name}">
					<input type="hidden" id="emp_last_name" name="emp_last_name" value="{$smarty.post.emp_last_name}">
		 ...
		 {/if}
                  <div class="box-body">
				   <div class="col-md-6">
                    <!--<div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="user_id" name="user_id" value="{$smarty.post.user_id}" tabindex="1" placeholder="User Id" autocomplete="off">
                      </div>
                    </div>-->
					<div class="form-group">
                      <label class="col-sm-3 control-label">Company Name </label>
						<div class="col-sm-5">
						<select id="company_name" name="company_name" class="form-control" onChange="Fill_Name_of_Clr();" value="{$smarty.post.company_name}"  tabindex="1">
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-5">
                       <input type="text" class="form-control" id="designation" name="designation" value="{$smarty.post.designation}" tabindex="5" placeholder="Designation" autocomplete="off" onKeyUp="text_filter(this);" readonly="true">
                      </div>
                    </div>
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Mobile No</label>
                      <div class="col-sm-5">
						 <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="{$smarty.post.mobile_no}" maxlength="10"  tabindex="7" placeholder="Mobile No" onKeyUp="numericFilter(this);clear_err_mobile(this.id);"   onBlur="chk_exist_mob(this);" autocomplete="off" readonly="true">
                      </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mail_id" name="mail_id" value="{$smarty.post.mail_id}" tabindex="9" placeholder="Email_id" autocomplete="off" readonly="true">
                      </div> 
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
					    <input type="text" class="form-control" id="user_group" name="user_group" value="{$smarty.post.user_group}" tabindex="11" placeholder="User Group" autocomplete="off"><input type="hidden" class="form-control" id="area" name="area" value="{$smarty.post.area}" tabindex="1" placeholder="Area" autocomplete="off">
						<input type="hidden" class="form-control" id="emp_id" name="emp_id" value="{$smarty.post.emp_id}" tabindex="1" placeholder="Emp Id" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group" >
                      <label class="col-sm-3 control-label">Password</label>
                      <div class="col-sm-5">
                        <input type="password" class="form-control" id="password" name="password" value="{$smarty.post.password}" tabindex="15" placeholder="Password" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Remarks</label>
                      <div class="col-sm-5">
                        <textarea class="form-control" id="remarks" name="remarks" tabindex="17" placeholder="Remarks" autocomplete="off">{$smarty.post.remarks}</textarea>
                      </div>
                    </div>
   					  </div>
					<!--**********************************************************-->
                    ...
                    <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="user_name" name="user_name" value="{$smarty.post.user_name}" tabindex="2" placeholder="User Name" autocomplete="off" onKeyUp="text_filter(this);">
                      </div>
                    </div>
					 <div class="form-group">
                      <label class="col-sm-3 control-label">Company Code </label>
						<div class="col-sm-5">
						<input type="type"  class="form-control" id="company_code" name="company_code"  value="{$smarty.post.company_code}" tabindex="4" placeholder="Company Code" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Sex</label>
                      <div class="col-sm-5">
						<select id="sex" name="sex" class="form-control" value="{$smarty.post.sex}"  tabindex="6">
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
						 <input type="text" class="form-control" id="department" name="department"  value="{$smarty.post.department}" tabindex="8" placeholder="Department" autocomplete="off" readonly="true">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Profile Image</label>
                      <div class="col-sm-5">
						 <input type="file" id="image" name="image" tabindex="10" value="{$smarty.post.image}" autocomplete="off">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-3 control-label">Phone No</label>
					    <div class="col-sm-2">
					    <input type="text" class="form-control" id="area_code" name="area_code" value="{$smarty.post.area_code}" placeholder="Area Code" tabindex="12" onKeyUp="numericFilter(this);" autocomplete="off" readonly="true">
					  </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="phone_no" name="phone_no" value="{$smarty.post.phone_no}" placeholder="Phone No" tabindex="13"onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-24px;" readonly="true">
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="extension" name="extension" value="{$smarty.post.extension}" placeholder="Extension" tabindex="14" onKeyUp="numericFilter(this);" autocomplete="off" style="margin-left:-45px;" readonly="true">
                       </div>
					   <div class="col-sm-2">
                      ...
                      <div class="col-sm-5">
                 	<input type="text" class="form-control" id="created_by" name="created_by" value="{$smarty.session.UserName}" readonly="true" autocomplete="off" tabindex="16">
				 <input type="hidden" class="form-control" id="created_date" name="created_date" value="{$smarty.now|date_format:'%Y-%m-%d'}">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="password" class="form-control" id="re_password" name="re_password" value="{$smarty.post.re_password}" tabindex="18" placeholder="Re Password" autocomplete="off">
                      </div>
                    </div>
				</div>
                    </div>
