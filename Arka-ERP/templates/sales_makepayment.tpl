...
<input type="text" class="form-control" id="invoice_amount" name="invoice_amount" onKeyUp="numericFilter(this);" placeholder="Invoice Amount" tabindex="2" value="" readonly="true">
						...
						<input type="hidden" class="form-control" id="enquiry_type" name="enquiry_type" value="{$smarty.post.enquiry_type}" readonly="true">
						</tr>
			<tr class="form-group">
				   		<th class="col-sm-2 control-th">Pending Amount</th>
						<td class="col-sm-5" >
						<input type="text" class="form-control" id="pending_amount" name="pending_amount" placeholder="Pending Amount" onKeyUp="numericFilter(this);" tabindex="3" value="{$smarty.post.pending_amount}" readonly="true">
						...
						<td class="col-sm-2">
						<input type="text" class="form-control" id="paid_amount" name="paid_amount" placeholder="Paid Amount" onKeyUp="numericFilter(this);calc(this);status_change(this);" value="{$smarty.post.paid_amount}" tabindex="4" autocomplete="Off">
						 </td>
		                 </tr>
		  <tr class="form-group">
		  <th class="col-sm-2 control-th">Payment Status</th>
					 ...
					 <input type="text" class="form-control" id="payment_status"  name="payment_status"    value="" tabindex="5" autocomplete="off" readonly="true">
						...
						<td class="col-sm-2">
						<select id="payment_mode" name="payment_mode" class="form-control"  value="{$smarty.post.payment_mode}" tabindex="6" onChange="txt();">
						<option>----Select-----</option>
