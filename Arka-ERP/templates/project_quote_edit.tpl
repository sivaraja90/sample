	...
	<td class="col-sm-3">
		...
		<tr class="form-group">	
				<th class="col-sm-2 control-th">Project Quote No </th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="project_quote_no" name="project_quote_no"  value="{$smarty.get.project_quote_no}" readonly="true"  tabindex="1" placeholder="Project Quote No">  	
						<input type="hidden" class="form-control" id="revised_version" name=" revised_version"  value="{$smarty.get.revised_version}" readonly="true" tabindex="1" placeholder="revised_version" autocomplete="Off">
						<input type="hidden" class="form-control" id="enquiry_id" name=" enquiry_id"  value="{$RevDetail.0.enquiry_id}" readonly="true" tabindex="1" placeholder="enquiry_id" autocomplete="Off">
						<input type="hidden" id="created_by" name="created_by" value="{$LDList2.0.created_by}"/>
						</td>
						<!--<td class="col-sm-5">
				...
				<th class="col-sm-2 control-th">Quote Date</th>
						<td class="col-sm-5">
						<input type="text" class="form-control" id="quote_date" name="quote_date" value="{$LDList2.0.quote_date}" placeholder="Quote Date" onClick="doOnLoad();" tabindex="2" readonly="true">
						</td>
						<td class="col-sm-5">
		   ...
		   <th class="col-sm-2 control-th">Mat Tax %</th>
				...
				<form name="ProjectList" id="ProjectList" method="post">
                  <table id="example2" class="table table-bordered table-striped" style="font-size:13px; font-family:'Times New Roman', Times, serif;">
                    ...
                    <tbody>
                     {foreach from=$Revise item=Contact}
					<tr id="{$i++}">  
							...
							<td class="center">&nbsp;&nbsp; &nbsp;&nbsp;<a href="#" onClick="Javascript:deleteCat('{$Contact.sl_no}','{$smarty.get.project_quote_no}','{$Contact.revised_version}','{$Contact.total}','{$Contact.sub_total}')"><i class="fa fa-trash"></i></a></td>	 
