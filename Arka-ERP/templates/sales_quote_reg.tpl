...
function validate_phone(data)
{
       ...
       function validate_fields()
		...
		var fields=["sales_quote_no","quote_date","revised_version","company_name","customer_id","contact_name","mobile_no","profile_image","email","area_code","phone_no","extension","address","area","city","pincode","product_description","unit_basic","quantity","vat_value","vat_percentage","sub_total","total","remarks"];
...
{					var quantity = document.getElementById('quantity').value;
					var price = document.getElementById('unit_basic').value;
    ...
    <div class="wrapper">
      <div class="content-wrapper">
        ...
        <section class="content-header">
		 ...
		 List Sales Quote</label></i></a></small>&ensp;&ensp;&ensp;
         <small class="active"><a href="sales_quote_reg.php"><i class="fa fa-user-plus"> <label style="font-family:Arial, Helvetica, sans-serif">
		 Create Sales Quote</label></i></a></small>
		 </h4>
<!--          <ol class="breadcrumb">
			...
			<input type="hidden" name="hdAction" />
                  ...
                  <div class="box-body">
				   ...
				   <div class="form-group">			 
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sales_quote_no" name="sales_quote_no" value="{$s_quote}" placeholder="Sales Quote No" tabindex="1" readonly="true" autocomplete="off">
                      </div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="revised_version" name="revised_version" value="{$r_version}" placeholder="Revised Version"  tabindex="3" autocomplete="off" readonly="true" >
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="customer_id" name="customer_id" value="{$smarty.post.customer_id}" placeholder="Customer Id" tabindex="5" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
				<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="mobile_no" name="mobile_no" maxlength="10" value="{$smarty.post.mobile_no}" placeholder="Mobile No" tabindex="7"onKeyUp="numericFilter(this);clear_err_mobile(this.id);"  onBlur="chk_exist_mob(this);" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="email" name="email" value="{$smarty.post.email}" placeholder="Email Id" tabindex="9" onKeyUp="clear_err_email_id();" autocomplete="off" >
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                      ...
                      <div class="col-sm-5">
                        <input type="email" class="form-control" id="email1" name="email1" value="{$smarty.post.email1}" placeholder="Email Id 1"  onKeyUp="clear_err_email_id();" autocomplete="off" >
                      </div>
					  </div>
					<div class="form-group" style=" margin-top:0px;">
                      <label class="col-sm-3 control-label">Address</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address" name="address" value="{$smarty.post.address}" placeholder="Address" tabindex="13" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
				<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="area" name="area" value="{$smarty.post.area}" placeholder="Area" onKeyUp="text_filter(this);" tabindex="15" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
                    </div>
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="pincode" name="pincode" value="{$smarty.post.pincode}" placeholder="Pincode" tabindex="17" onBlur="chk_exist_pin(this)" maxlength="6" onKeyUp="numericFilter(this);"  autocomplete="off">
                      </div>  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font></div>
					   <div class="form-group" >
                      <label class="col-sm-3 control-label">Unit Basic</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="unit_basic" name="unit_basic" value="{$smarty.post.unit_basic}" placeholder="Unit Basic" tabindex="19" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="vat_value" name="vat_value" value="{$smarty.post.vat_value}" placeholder="Vat Value"  onKeyUp="getvalue();numericFilter(this);" tabindex="21" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sub_total" name="sub_total" value="{$smarty.post.sub_total}" placeholder="Sub Total" tabindex="23" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					  </div>
					  <div class="form-group">
					...
					<!--**********************************************************-->
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quote_date" name="quote_date" value="{$smarty.post.quote_date}" placeholder="Quote Date" tabindex="2" autocomplete="off" readonly="true">
                      </div>
					   &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="company_name" name="company_name" value="{$smarty.post.company_name}" placeholder="Company Name" tabindex="4" autocomplete="off" >
                      </div>
					  </div>
					  <div class="form-group">
                      <label class="col-sm-3 control-label">Contact Person</label>
                  <div class="col-sm-5">
						<input type="text" class="form-control" id="contact_name" name="contact_name" placeholder="Contact Name" value="{$smarty.post.contact_name}" tabindex="6" onKeyUp="text_filter(this);" autocomplete="off">
                      </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="file"  id="profile_image" name="profile_image" maxlength="25" value="{$smarty.post.profile_image}" placeholder="Profile Image" tabindex="8" autocomplete="off">
                      </div>
					&nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					  </div>
					  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="address1" name="address1" value="{$smarty.post.address1}" placeholder="Address1" tabindex="14" autocomplete="off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font> 
					  </div>
					  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="city" name="city" value="{$smarty.post.city}" placeholder="City" tabindex="16" autocomplete="off">
                      </div>
					  &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font> 
					  </div>
					  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="product_description" name="product_description" value="{$smarty.post.product_description}" placeholder="Product Description" tabindex="18" autocomplete="off" >
                      </div> &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font></div>
					   <div class="form-group" style=" margin-top:-15px;" >
                      <label class="col-sm-3 control-label">Quantity</label>
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="quantity" name="quantity" value="{$smarty.post.quantity}" placeholder="Quantity" tabindex="20" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="vat_percentage" name="vat_percentage" value="{$smarty.post.vat_percentage}" placeholder="Vat Percentage" onKeyUp="getvalue();numericFilter(this);" tabindex="22" autocomplete="off">
                      </div>
					    &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font>
					   </div>
					   <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="total" name="total" value="{$smarty.post.total}" placeholder="Total" tabindex="24" autocomplete="off">
                      </div> &nbsp;&nbsp;<font class="error" color="#f56954"><b>*</b>&nbsp;</font></div>
					  <div class="form-group">
