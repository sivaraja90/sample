<?php
  require('includes/common.php');
	...
	{
	$ObjProjectOrder->EditProjectOrder($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
	 {
	 	  $objSmarty->assign('SuccessMessage', 'Project Order Updated Successfully');
	 } 

  $objSmarty->assign('IncludeTpl','project_order_edit.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- ProjectOrder edit');
