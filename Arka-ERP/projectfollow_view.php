<?php
  require('includes/common.php');
	...
	{
	$objServiceOrder->ViewServiceOrderQuote($_GET['service_order_no']);
	}
	if((isset($_GET['service_order_no'])) && isset($_GET['sl_no']))
	{
	$objServiceOrder->ViewServiceOrderQuote($_GET['service_order_no']);
	}
...
//	$ObjDashboard->RolesLists();
  ...
  $objSmarty->assign('IncludeTpl', 'projectfollow_view.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- View Service');
