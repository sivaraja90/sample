...
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	{
		$objProjectOrder->EditDetails($_POST);
	}
	...
	if(isset($_GET['sl_no']))
	{
		...
		$objProjectOrder->EditContact($_GET['sl_no']);
	}
	if(isset($_GET['customer_id']))
	{
		$objProjectOrder->ListContact1($_GET['customer_id']);
	}
...
//	$ObjDashboard->RolesLists();
  ...
  $objSmarty->assign('IncludeTpl', 'pro_edit.tpl');
