<?php
  require('includes/common.php');
	...
	$objServiceQuoteReg->SelectServiceDetail1($_GET['revised_version'],$_GET['service_quote_no']);
	$objServiceQuoteReg->ListService($_GET['revised_version'],$_GET['service_quote_no']);

	
  $objSmarty->assign('IncludeTpl', 'service_view.tpl');
