...
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	{
		$objServiceOrder->EditDetails($_POST);
	}
	...
	if(isset($_GET['sl_no']))
	{
		...
		$objServiceOrder->EditContact($_GET['sl_no']);
	}
	if(isset($_GET['customer_id']))
	{
		$objServiceOrder->ListContact1($_GET['customer_id']);
	}
...
//	$ObjDashboard->RolesLists();
  ...
  $objSmarty->assign('IncludeTpl', 'ser_edit.tpl');
