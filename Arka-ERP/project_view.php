<?php
  require('includes/common.php');
	...
	$objProjectQuoteReg->SelectProjectDetail($_GET['revised_version'],$_GET['project_quote_no']);
	$objProjectQuoteReg->ListProjectViewDetail($_GET['revised_version'],$_GET['project_quote_no']);
	
  $objSmarty->assign('IncludeTpl', 'project_view.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- View Sales');
