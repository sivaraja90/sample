<?php
  require('includes/common.php');
	...
	if(isset($_GET['enquiry_id']) || isset($_GET['service_quote_no']) || isset($_GET['enquiry_type']) || isset($_GET['revised_version']))
	{
	$ObjServiceQuoteReg->ServicePrint($_GET['enquiry_id']);
	$ObjServiceQuoteReg->ServiceToAddress($_GET['service_quote_no']); 
	$ObjServiceQuoteReg->ServiceTerm($_GET['service_quote_no']);
	$ObjServiceQuoteReg->pro_enq_Type($_GET['enquiry_id']);
	$ObjServiceQuoteReg->Terms_enq($_GET['enquiry_type']);
	$ObjServiceQuoteReg->ServiceInvoice($_GET['service_quote_no']);
}
  $objSmarty->assign('IncludeTpl', 'service_print.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Service Quote');
