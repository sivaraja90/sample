<?php
  require('includes/common.php');
	...
	$ObjUserMgmt->GetUserProfile();
	if(isset($_POST['hdAction']))
	{
		$ObjUserMgmt->GetUpdateProfile($objArray);
	}
	
		if(isset($_GET['succs_msg_for_update']))
         {
          $objSmarty->assign('SuccessMessage', 'User Profile Updated Successfully');
         } 
  $objSmarty->assign('IncludeTpl', 'profile.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- User Profile');
