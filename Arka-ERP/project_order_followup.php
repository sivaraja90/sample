<?php
  require('includes/common.php');
	...
	{
	$ObjProjectOrder	->ToAddress2($_GET["project_order_no"]);
	}
if(isset($_POST['hdAction']))
	{
	$ObjProjectOrder->InsertProjectOrderFollowUp($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
         {
          $objSmarty->assign('SuccessMessage', 'New FollowUp Added Successfully');
         }  
		  $objSmarty->assign('IncludeTpl', 'project_order_followup.tpl');
