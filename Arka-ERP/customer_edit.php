<?php
  require('includes/common.php');
	...
	$ObjCustomerMgmt->placetype();	
	$ObjCustomerMgmt->Enquirythrough();
	...
	{
	$ObjCustomerMgmt->ViewEdit($_GET['customer_id']);
	}
	if(isset($_GET['succs_msg_for_insert']))
	 {
	  $objSmarty->assign('SuccessMessage', 'Customer Updated Successfully');
	 } 

  $objSmarty->assign('IncludeTpl', 'customer_edit.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Customer Edit');
