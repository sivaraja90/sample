<?php
  require('includes/common.php');
	...
	{
	$ObjSalesOrder->ViewEdit($_GET['sales_order_no']);
	}
	if(isset($_POST['hdAction']))
	{
	$ObjSalesOrder->EditSalesOrder($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
	 {
	 	  $objSmarty->assign('SuccessMessage', 'Sales Order Updated Successfully');
	 } 
//	$ObjDashboard->RolesLists();
	// $ObjDashboard->myCurl($objArray);

  $objSmarty->assign('IncludeTpl', 'sales_quote_edit.tpl');
