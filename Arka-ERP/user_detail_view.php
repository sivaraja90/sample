...
if(isset($_GET['s_no']))
{
	...
	$ObjUserMgmt->DateStamp();
	$ObjUserMgmt->TimeStamp();
	$objSmarty->assign('IncludeTpl', 'user_detail_view.tpl');
	$objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- UserDetail');
