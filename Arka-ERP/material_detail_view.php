<?php
  require('includes/common.php');
	...
	$ObjMaterialReg->GetMateralView($_GET['material_code']);
if(isset($_GET['material_code']))
{
	$ObjMaterialReg->ViewEdit($_GET['material_code']);
}
	$ObjMaterialReg->DateStamp();
	$ObjMaterialReg->TimeStamp();
	$objSmarty->assign('IncludeTpl', 'material_detail_view.tpl');
	$objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- MaterialDetail');
