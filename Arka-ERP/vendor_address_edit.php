...
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	{
		$objVendorMgmt->EditAddress($_POST);
	}
	if(isset($_GET['succs_msg_for_insert']))
	{
		$objSmarty->assign('SuccessMessage', 'Vendor Address Updated Successfully');
	}
	if(isset($_GET['sl_no']))
	{	
		$objVendorMgmt->EditAddressDetails($_GET['sl_no']);
	}
  $objSmarty->assign('IncludeTpl', 'vendor_address_edit.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Edit Address');
