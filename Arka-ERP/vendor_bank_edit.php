...
//	include_once $config['SiteClassPath']."class.split_page_results.php";
	...
	{
	$ObjVendorMgmt->BankEdit($_POST);
	}
	if(isset($_GET['sl_no']))
	{
	 $ObjVendorMgmt->EditBankDetails($_GET['sl_no']);

	}
	
	if(isset($_GET['succs_msg_for_update']))
	 {
	  $objSmarty->assign('SuccessMessage', 'Bank Details Updated Successfully');
	 }

  $objSmarty->assign('IncludeTpl', 'vendor_bank_edit.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- Vendor Address');
