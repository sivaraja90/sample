<?php
  require('includes/common.php');
	...
	$ObjSalesOrder->SalesPrint($_GET['enquiry_id']);
	$ObjSalesOrder->Enquiry($_GET['enquiry_id']);
	$ObjSalesOrder->ToAddress($_GET['sales_quote_no']); 
	$ObjSalesOrder->ToAddress3($_GET['sales_quote_no']); 
	$ObjSalesOrder->add_Total($_GET['sales_quote_no']);
	$ObjSalesOrder->sub_Total($_GET['sales_quote_no']);
	$ObjSalesOrder->tax_Total($_GET['sales_quote_no']);
	$ObjSalesOrder->GetAccDetails($_GET['enquiry_id']);
	$ObjSalesOrder->GetNumbers($_GET['sales_quote_no']);

  $objSmarty->assign('IncludeTpl', 'sales_order_print2.tpl');
