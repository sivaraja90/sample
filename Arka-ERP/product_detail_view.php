<?php
  require('includes/common.php');
	...
	{
		$ObjProductReg->ViewProduct($_GET['item_code']);
	}
/*		if(isset($_GET['item_code']))
	{
		$ObjProductReg->ListProduct($_GET['item_code']);
	}
*/ $ObjProductReg->DateStamp();
	$ObjProductReg->TimeStamp();
	$ObjProductReg->ListMaster();
//	$ObjDashboard->RolesLists();
	// $ObjDashboard->myCurl($objArray);

  $objSmarty->assign('IncludeTpl', 'product_detail_view.tpl');
