<?php
  require('includes/common.php');
	...
	$ObjProjectOrder->ListProjectOrder($_GET['project_order_no']);
	if(isset($_GET['project_order_no']))
     {
		$ObjProjectOrder->DeleteProjectEditDetails($_GET['project_order_no']);
			}
	if(isset($_GET['succs_msg_for_del']))
         {
         $objSmarty->assign('SuccessMessage', 'Project Order Deleted Successfully');
       } 

  $objSmarty->assign('IncludeTpl', 'project_order_list.tpl');
  $objSmarty->assign('OverallSiteTitle', $config['SiteTitle'].'- ProjectQuoteReg');
